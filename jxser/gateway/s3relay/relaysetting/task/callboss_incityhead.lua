...
["Sa M¹c s¬n  ®éng 2"] =   {{226, {{1723,3210},{1723,3210},{1723,3210},{1723,3210}}, "Sa M¹c s¬n  ®éng 2"  },},
...
["KiÕm C¸c T©y Nam"] =    {{19, {{3233,4272},{3241,4279},{3233,4272},{3241,4279}}, "KiÕm C¸c T©y Nam"   },},
}
...
for i=1,getn(QY_GOLDBOSS_APOS_INFO) do
		...
		local szMsg = format( "<color=green>Giang hå truyÒn<color> <color=cyan> %s <color> <color=green>®· xuÊt hiÖn t¹i<color> <color=cyan> %s <color><color=green>giang hå sÏ cã mét cuéc chiÕn ®Èm m¸u!<color>",bossname, worldname)
...
function qy_makeboss_lotsof_pos()
	nboss = random(1,getn(QY_GOLDBOSS_DPOS_INFO))
	for i = 1, nboss  do
