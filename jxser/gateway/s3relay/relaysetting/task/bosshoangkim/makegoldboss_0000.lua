...
function TaskShedule()
	TaskName("BOSS HOANG KIM XUAT HIEN VAO: 00:00");
	TaskInterval(1440);
	TaskTime(0, 0);
	TaskCountLimit(0);
--	OutputMsg("======================================================================================================")
--	OutputMsg("            BOSS HOANG KIM XUAT HIEN TAI MAP BAN DO CAP 90 VA THANH THI THOI GIAN:                    ")
--	OutputMsg("=====================> 12h:00 - 14h:00 - 16h:00 - 18h:00 - 19h30 - 20h:00 - 22h00 <===================")
end
