...
--{959, 2, 20, "\\settings\\maps\\great_night\\chienlongdonghhtrung.txt","ChiÕn long ®éng"},
--{959, 3, 10, "\\settings\\maps\\great_night\\chienlongdonghhcao.txt","ChiÕn long ®éng"},
...
TaskInterval(5)
TaskCountLimit(0)
OutputMsg( "=======> Qua Huy Hoang 1900 <=======");
end

function TaskContent()
local START_TIME = 1900;
local END_TIME = 1930;
if righttime_add() ~= 1 then-- nÕu nhu thêi gian sai
gb_SetTask( "Hoa ®¨ng ho¹t ®éng", 1, 0)
gb_SetTask( "Qu¶ Huy Hoµng", 19, 0);	--19 hµo l­îng biÕn ®æi dïng ®Ó tån tr?NPC t?hµo
return
end;
OutputMsg( "=======> Qua Huy Hoang 1900 Xuat Hien<=======");
local nNowTime = tonumber(date( "%H%M "))
if nNowTime >= 1900 and nNowTime < 1905 then	--
gb_SetTask( "Qu¶ Huy Hoµng", 19, 0);	--19 hµo l­îng biÕn ®æi dïng ®Ó tån tr?NPC t?hµo
end
