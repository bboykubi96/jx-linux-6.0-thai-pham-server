...
{959, 1, 20, "\\settings\\maps\\great_night\\chienlongdonghhthap.txt","ChiÕn long ®éng"},
...
gb_SetTask( "Qu¶ Huy Hoµng", 1930, 0);	--1930 hµo l­îng biÕn ®æi dïng ®Ó tån tr?NPC t?hµo
return
end;
OutputMsg( "=======> Qua Huy Hoang 1900 Xuat Hien<=======");
local nNowTime = tonumber(date( "%H%M "))
if nNowTime >= 1930 and nNowTime < 1935 then	--
gb_SetTask( "Qu¶ Huy Hoµng", 1930, 0);	--1930 hµo l­îng biÕn ®æi dïng ®Ó tån tr?NPC t?hµo
end
...
if (nTime >= 1930 and nTime < 1935) then
return 1;
end;
return 0;
end
