	...
	OutputMsg("=====> ThongBao")
	zMsg2SubWorld  = "<color=yellow>Mõng Sinh NhËt 1 n¨m <color=green> VoLamVietPK <color=yellow>tri ©n nh©n sÜ phÇn quµ nhá t¹i lÔ quan. C¸m ¬n quý ®ång ®¹o, chóc quý ®ång ®¹o cã nh÷ng gi©y phót gi¶i trÝ vui vÎ t¹i volamvietpk.net."
