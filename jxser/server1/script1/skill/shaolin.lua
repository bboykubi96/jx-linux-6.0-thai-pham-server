...
SKILLS={
	...
	shaolin_gunfa={ --少林棍法
		addphysicsdamage_p={{{1,25},{20,150}},{{1,-1},{2,-1}},{{1,2},{2,2}}},
	...
	luohan_zhen={ --罗汉阵
		...
		meleedamagereturn_p={{{1,1},{20,25},{25,25},{26,25}},{{1,18},{2,18}}},
		rangedamagereturn_p={{{1,1},{20,25},{25,25},{26,25}},{{1,18},{2,18}}},
	...
	budong_mingwang={ --bat dong minh vuong
		...
		fatallystrikeres_p={{{1,1},{20,5}},{{1,18},{2,18}}},
	...
	wuxiang_zhan={ --无相斩
		physicsenhance_p={{{1,45},{15,150},{20,383}}},
