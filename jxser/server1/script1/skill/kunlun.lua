...
SKILLS={
	...
	mizhong_huanying={ --ÃÔ×Ù»ÃÓ°
		freezetimereduce_p={{{1,-5},{20,-50}},{{1,18*20},{20,18*60}}},
		stuntimereduce_p={{{1,-5},{20,-50}},{{1,18*20},{20,18*60}}},
		skill_cost_v={{{1,30},{20,40}}}
	},
	zuixian_cuogu={ --×íÏÉ´í¹Ç
		fastwalkrun_p={{{1,-12},{20,-52}},{{1,18*45},{20,18*120}}},
		freezetimereduce_p={{{1,-5},{20,-25}},{{1,18*20},{20,18*60}}},
		stuntimereduce_p={{{1,-5},{20,-50}},{{1,18*20},{20,18*60}}},
		lifereplenish_v={{{1,-1},{20,-15}},{{1,18*45},{20,18*120}}},
		manareplenish_v={{{1,-1},{20,-20}},{{1,18*45},{20,18*120}}},
		rangedamagereturn_p={{{1,-5},{20,-35}},{{1,18*45},{20,18*120}}},
	...
	stun_p={{{1,10},{20,30},{25,30},{26,36}},{{1,1},{20,6},{21,6}}},
	},
	...
	aoxue_xiaofeng={ --°ÁÑ©Ð¥·ç
		...
		stun_p={{{1,10},{20,25},{25,25},{26,26}},{{1,1},{20,6},{21,6}}},
		missle_speed_v={{{1,28},{20,32},{21,32}}},
		skill_attackradius={{{1,512},{20,512},{21,512}}},
...
--		},
	...
	kunlun120={ --À¥ÂØ120¼¶¼¼ÄÜ
		...
		skill_desc=
			function(level)
				...
				"Ch©n khÝ chèng l¹i s¸t th­¬ng gÊp <color=orange>"..floor(Link(level,SKILLS.kunlun120mofadun.staticmagicshield_p[1]) / 200)..
	...
	kunlun120mofadun={ --À¥ÂØ120¼¶¼¼ÄÜÄ§·¨¶Ü
		staticmagicshield_p={{{1,1800},{15,9750},{20,20000},{21,20050}},{{1,5*18},{15,9*18},{20,10*18},{21,10*18}}},
	},
