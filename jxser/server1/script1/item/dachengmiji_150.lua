...
tinsert(tb_Desc, 1, "Lùa chän kü n¨ng cÇn th¨ng cÊp:"); 
...
WriteLog(format("[%s]\t%s\tAccount:%s\tName:%s\tUpGrade Skill:%d",  " ®¹i thµnh bİ tŞch 150",  GetLocalDate("%Y-%m-%d %X"),  GetAccount(),  GetName(),  n_skillid )); 
end 
end 
