...
Say("Bang v­ît qu¸ 120 thµnh viªn kh«ng thÓ sö dông thÇn thµnh phï.Xin h·y t«n träng s©n ch¬i kh«ng gian lËn trong viÖc s¸p nhËp bang héi ®Ó tr¸nh phiÒn phøc cho chÝnh bæn bang m×nh.");
return 1
end
end
...
SetTask(3077,0)
	...
	--	"§i Hoa S¬n Ph¸i./dennoidanhcobac"
...
--	if (nTongID == 0) then
	--	Msg2Player("Kh«ng cã trong bang héi, kh«ng thÓ sö tham gia.")
	--	return
--	end
...
--		else
--			Say("Thêi gian vµo ®Êu tr­êng sinh tö lµ 19h ®Õn 20h30 h»ng ngµy. .",0);
--			return
--		end
NewWorld(355,nX,nY)
SetPunish(0)
...
tab_lv80map = {
		...
		{201,1616,3195	,"B¨ng Hµ §éng",},
				{202,1787,2823	,"Phï Dung ®éng",},
		{203,1548,2990	,"V« Danh §éng",},
	}
...
tab_lv70map = {
		...
		{72,1659,3308	,"§¹i tï ®éng",},
		{169,1596,3213	,"Long Nh·n ®éng",},
		{130,1541,3147	,"L­u Tiªn ®éng tÇng 6",},
	}
...
tab_lv60map = {
		...
		{118,1590,3182	,"T­êng V©n §éng tÇng 3",},
		{114,1613,3202	,"108 La H¸n TrËn",},
		{51,1592,3205	,"Thiªn NhÉn Gi¸o Th¸nh §éng",},
		{196,1539,3267	,"D­¬ng Gi¸c §éng",},
		{149,1610,3220	,"TuyÕt B¸o §éng tÇng 3",},
		{94,1598,3151	,"Linh Cèc §éng",},
		{68,1625,3228	,"Thanh Loa §¶o",},
	}
...
tab_lv50map = {
		...
		{38,1601,3193	,"Mª Cung ThiÕt Th¸p",},
		{194,1599,3199	,"Ngäc Hoa §éng",},
		{163,1596,3217	,"¸c B¸ §Þa §¹o",},
		{24,1611,3207	,"H­ëng Thñy §éng",},
		{182,1633,3213	,"NghiÖt Long §éng",},
		{42,1617,3226	,"Thiªn T©m §éng",},
		{116,1607,3203	,"T­êng V©n §éng",},
		{66,1606,3206	,"§¸y §éng §×nh Hå",},
...
function gopos_step2battle()
	...
	--end;
	if ( GetLevel() < 80 ) then
		Talk( 1, "", "Tèng Kim lµ n¬i rÊt nguy hiÓm, ch­a ®¹t cÊp 80 kh«ng thÓ tham gia chiÕn tr­êng." );
	else
...
function ToSong()	-- ½øÈëËÎ·½±¨Ãûµã	
	...
	Pay(7)
	if ( GetLevel() < 80 ) then
		Talk( 1, "", "ChiÕn tr­êng Tèng Kim gian khæ khèc liÖt, ng­¬i ch­a ®¹t ®Õn cÊp 80 h·y vÒ luyÖn thªm råi h·y tÝnh." );
