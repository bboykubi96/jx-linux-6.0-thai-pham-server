...
SKILLS={
	...
	jingxin_jue={ --¾²ÐÄ¾÷
		...
		item_reserve10={{{1,1},{2,1},{20,10},{30,15}},{{1,18},{2,18}}},--Ôö¼ÓÔì³ÉÊÜÉË¸ÅÂÊÊôÐÔ
	...
	tianwang_zhanyi={ --ÌìÍõÕ½Òâ
		...
		fastwalkrun_p={{{1,5},{30,20}},{{1,18*120},{20,18*180}}},--???????
	...
	jinzhong_zhao={ --kim chung tr¸o
		sorbdamage_yan_p={{{1,2},{20,40}},{{1,18},{2,18}}},--Ôö¼ÓµÖÏûÉËº¦£¨Ñô£©£¬1¼¶2µã£¬edited By LLX
		sorbdamage_p={{{1,2},{20,40}},{{1,18},{2,18}}},--Ôö¼ÓµÖÏûÉËº¦£¨Ñô£©£¬1¼¶2µã£¬edited By LLX
		...
		fastwalkrun_p={{{1,9},{20,60}},{{1,18},{2,18}}},
		allres_p={{{1,1},{20,20}},{{1,18*120},{30,18*180}}},
		deadlystrike_p={{{1,1},{20,20}}},
		skill_enhance = {{{1,10},{20,100}},{{1,18*60*3},{2,18*60*3}}},				--c«ng kÝch kü n¨ng
	},
	chenglong_jue={ --³ËÁú¾÷
