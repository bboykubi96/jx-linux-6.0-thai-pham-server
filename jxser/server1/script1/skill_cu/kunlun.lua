...
SKILLS={
	...
	mizhong_huanying={ --ÃÔ×Ù»ÃÓ°
		...
		stuntimereduce_p={{{1,-5},{20,-25}},{{1,18*20},{20,18*60}}},
		skill_cost_v={{{1,30},{20,40}}}
	},
	...
	leidong_jiutian={ --À×¶¯¾ÅÌì
		...
		lightingdamage_v={
			[1]={{1,80},{15,260},{20,900}},
			[3]={{1,80},{15,260},{20,900}}
		},
		skill_cost_v={{{1,40},{15,60},{20,95}}},
		skill_eventskilllevel={{{1,1},{20,10}}},
		skill_collideevent={
			[1]={{1,0},{10,0},{10,1},{20,1}},
			[3]={{1,387},{20,387}}
		},
	...
	stun_p={{{1,10},{20,25},{25,35},{26,40}},{{1,1},{20,6},{21,6}}},
	},
	...
	aoxue_xiaofeng={ --°ÁÑ©Ð¥·ç
		physicsenhance_p={{{1,5},{15,250},{20,500}}},
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		lightingdamage_v={
			[1]={{1,39},{15,200},{20,800}},
			[3]={{1,39},{15,200},{20,800}}
		},
...
--		},
	...
	kunlun120={ --À¥ÂØ120¼¶¼¼ÄÜ
		autorescueskill={{{1,721*256 + 1},{20,721*256 + 20},{21,721*256 + 21}},{{1,-1},{20,-1}},{{1,20*18*256 + 15},{15,20*18*256 + 60},{20,20*18*256 + 85},{21,20*18*256 + 85}}},
		skill_desc=
			function(level)
