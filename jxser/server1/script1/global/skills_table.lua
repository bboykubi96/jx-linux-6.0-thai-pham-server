...
-----------------Update Hoa Son
function update_hs() -- script viet hoa By http://tranhba.com  tr­íc c¨n cø nhiÖm vô cÊp bËc thñ tiªu # lÇn n÷a gia nhËp kü n¨ng , sau ®ã bæ trë vÒ kü n¨ng ®iÓm 
UTask = GetTask(11) 
if (GetTask(131) == 255) then -- script viet hoa By http://tranhba.com  häc ®­îc 90 cÊp kü n¨ng 
the_lvl = 90 
...
del_all_skill() 
add_hs(the_lvl) -- script viet hoa By http://tranhba.com  thªm ®¸p l¹i häc ®­îc kü n¨ng 
SetTask(137,33) 
end 

------------------------------------------------Häc Skill Phai Thien Vuong-----------------------------------------------------------------------------------------------
...
---------------------------------------------Häc Skill Phai Hoa Son---------------------------------------------------------------------------

function add_hs(lvl) -- script viet hoa By http://tranhba.com  c¨n cø nhiÖm vô cÊp bËc thªm t­¬ng øng C«n L«n kü n¨ng 
if (lvl >= 10) then -- script viet hoa By http://tranhba.com  ®· nhËp m«n # gia nhËp cöa kü n¨ng # 
if (HaveMagic(1347) == -1) then -- script viet hoa By http://tranhba.com  nhÊt ®Şnh ph¶i kh«ng cã kü n¨ng ®İch míi cho kü n¨ng 
AddMagic(1347) -- script viet hoa By http://tranhba.com  h« phong ph¸p [169]# nhËp m«n # 
end 
if (HaveMagic(1372) == -1) then -- script viet hoa By http://tranhba.com  nhÊt ®Şnh ph¶i kh«ng cã kü n¨ng ®İch míi cho kü n¨ng 
AddMagic(1372) -- script viet hoa By http://tranhba.com  cuång sĞt ®¸nh ®Şa [179]# nhËp m«n # 
end 
end 
if (lvl >= 20) then -- script viet hoa By http://tranhba.com  10 cÊp nhiÖm vô # thªm 10 cÊp kü n¨ng # 
if (HaveMagic(1349) == -1) then -- script viet hoa By http://tranhba.com  nhÊt ®Şnh ph¶i kh«ng cã kü n¨ng ®İch míi cho kü n¨ng 
AddMagic(1349) -- script viet hoa By http://tranhba.com  C«n L«n ®ao ph¸p [167]#10 cÊp # 
end 
if (HaveMagic(1374) == -1) then -- script viet hoa By http://tranhba.com  nhÊt ®Şnh ph¶i kh«ng cã kü n¨ng ®İch míi cho kü n¨ng 
AddMagic(1374) -- script viet hoa By http://tranhba.com  C«n L«n kiÕm ph¸p [168]#10 cÊp # 
end 
if (HaveMagic(1350) == -1) then -- script viet hoa By http://tranhba.com  nhÊt ®Şnh ph¶i kh«ng cã kü n¨ng ®İch míi cho kü n¨ng 
AddMagic(1350) -- script viet hoa By http://tranhba.com  d©y d­a tù quyÕt [392]#10 cÊp # 
end 
if (HaveMagic(1375) == -1) then -- script viet hoa By http://tranhba.com  nhÊt ®Şnh ph¶i kh«ng cã kü n¨ng ®İch míi cho kü n¨ng 
AddMagic(1375) -- script viet hoa By http://tranhba.com  giã m¸t phï [171]#10 cÊp # 
end 
end 
if (lvl >= 30) then -- script viet hoa By http://tranhba.com  20 cÊp nhiÖm vô # thªm 20 cÊp kü n¨ng # 
if (HaveMagic(1351) == -1) then -- script viet hoa By http://tranhba.com  nhÊt ®Şnh ph¶i kh«ng cã kü n¨ng ®İch míi cho kü n¨ng 
AddMagic(1351) -- script viet hoa By http://tranhba.com  ky b¸n phï [174]#20 cÊp # 
end 
end 
if (lvl >= 40) then -- script viet hoa By http://tranhba.com  30 cÊp nhiÖm vô # thªm 30 cÊp kü n¨ng # 
if (HaveMagic(1376) == -1) then -- script viet hoa By http://tranhba.com  nhÊt ®Şnh ph¶i kh«ng cã kü n¨ng ®İch míi cho kü n¨ng 
AddMagic(1376) -- script viet hoa By http://tranhba.com  mét khİ ba thanh [178]#30 cÊp # 
end 
if (HaveMagic(1354) == -1) then -- script viet hoa By http://tranhba.com  nhÊt ®Şnh ph¶i kh«ng cã kü n¨ng ®İch míi cho kü n¨ng 
AddMagic(1354) -- script viet hoa By http://tranhba.com  tÊn l«i nguyÒn rña [172]#30 cÊp # 
end 
end 
if (lvl >= 50) then -- script viet hoa By http://tranhba.com  40 cÊp nhiÖm vô # thªm 40 cÊp kü n¨ng # 
if (HaveMagic(1355) == -1) then -- script viet hoa By http://tranhba.com  nhÊt ®Şnh ph¶i kh«ng cã kü n¨ng ®İch míi cho kü n¨ng 
AddMagic(1355) -- script viet hoa By http://tranhba.com  lÊn hµn ng¹o tuyÕt [175]#40 cÊp # 
end 
if (HaveMagic(1379) == -1) then -- script viet hoa By http://tranhba.com  nhÊt ®Şnh ph¶i kh«ng cã kü n¨ng ®İch míi cho kü n¨ng 
AddMagic(1379) -- script viet hoa By http://tranhba.com  khİ t©m phï [181]#40 cÊp # 
end 
end 
if (lvl >= 60) then -- script viet hoa By http://tranhba.com  50 cÊp nhiÖm vô # thªm 50 cÊp kü n¨ng # 
if (HaveMagic(1358) == -1) then -- script viet hoa By http://tranhba.com  nhÊt ®Şnh ph¶i kh«ng cã kü n¨ng ®İch míi cho kü n¨ng 
AddMagic(1358) -- script viet hoa By http://tranhba.com  cuång phong chît ®iÖn [176]#50 cÊp # 
end 
end 
if (lvl >= 70) then -- script viet hoa By http://tranhba.com  trë vÒ s­ nhiÖm vô # thªm trÊn ph¸i tuyÖt häc # 
if (HaveMagic(1360) == -1) then -- script viet hoa By http://tranhba.com  nhÊt ®Şnh ph¶i kh«ng cã kü n¨ng ®İch míi cho kü n¨ng 
AddMagic(1360) -- script viet hoa By http://tranhba.com  s­¬ng ng¹o C«n L«n [275]# trÊn ph¸i # 
AddMagic(1378)
end 
if (HaveMagic(1380) == -1) then -- script viet hoa By http://tranhba.com  nhÊt ®Şnh ph¶i kh«ng cã kü n¨ng ®İch míi cho kü n¨ng 
AddMagic(1380) -- script viet hoa By http://tranhba.com  ngò l«i ch¸nh ph¸p [182]#60 cÊp # 
end 
end 
if (lvl >= 90) then -- script viet hoa By http://tranhba.com  90 cÊp nhiÖm vô # thªm 90 cÊp kü n¨ng # 
if (HaveMagic(1364) <= 0) then AddMagic(1364,20) end -- script viet hoa By http://tranhba.com  §o¹t MÖnh Liªn Hoµn Tam Liªn Kİch 
if (HaveMagic(1382) <= 0) then AddMagic(1382,20) end -- script viet hoa By http://tranhba.com  Ph¸ch Th¹ch Ph¸ Ngäc
if (HaveMagic(1365) <= 0) then AddMagic(1365,20) end -- script viet hoa By http://tranhba.com Tö Hµ KiÕm Khİ Kü N¨ng 120 
if (HaveMagic(1369) <= 0) then AddMagic(1369,20) end -- script viet hoa By http://tranhba.com  m«n ph¸i 150 kü n¨ng §éc C« 9 KiÕm
if (HaveMagic(1384) <= 0) then AddMagic(1384,20) end -- script viet hoa By http://tranhba.com  m«n ph¸i 150 kü n¨ng ThÇn Quang Toµn NhiÔu
if (HaveMagic(1501) <= 0) then AddMagic(1501,1) end -- script viet hoa By http://tranhba.com  m«n ph¸i 150 kü n¨ng Lang Ba Vi Bo
AddMagic(210,1)
end 
end 
