...
dofile("script/global/quanlygame/npchauquanvuhon.lua");
	local szTitle = "<npc>LÇn nµy ph¸i <color=blue>Vò Hån<color> ta t¸i suÊt,giang hå l¹i thªm nhiÒu biÕn ®éng"
	local tbOpt =
	{
		{"Gia NhËp Vò Hån", xingianhap},
...
Say("<color=red>HËu Qu©n Vò Hån<color>: Ph¸i <color=cyan>Vò Hån<color> ta ®· kh«ng tham gia giang hå h¬n 10 n¨m nay, lÇn nµy t¸i xuÊt ¾t sÏ khiÕn bän giang hå tµ ph¸i ph¶i khiÕp sî mét phen!",2, "Cho ta gia nhËp/go", "§Ó ta suy nghÜ kü l¹i xem/no")
elseif (GetCamp() == 0) and (GetSeries() ~= 3) and (GetLevel() >= 199) and (GetSex() == 0) and  (GetTask(169) ~= 11) then
Say("<color=white>ChØ cã ng­êi míi tao nh©n vËt lµ hÖ háa míi cã thÓ gia nhËp Vò Hån HËu Qu©n")
...
Talk(1,"","Ng­¬i ph¶i t¹o nh©n vËt hÖ thñy míi cã thÓ gia nhËp Vò Hån HËu Qu©n.")	
end
end
