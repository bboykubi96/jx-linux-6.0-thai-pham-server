...
--		{"§æi 100 KNB Sang 10000 TiÒn §ång",DoiTienDong100knb},
	--	{"§æi 10 KNB Sang 1000 TiÒn §ång",DoiTienDong},
		{"§æi 1 KNB Sang 120 TiÒn §ång",DoiTienDong1knb},
...
local tbItem = {
	{szName="TiÒn §ång", tbProp={4,417,1,1,0,0},nCount = 120},
}
local KNB = CalcEquiproomItemCount(4,343,1,1);
	if KNB>= 1 then
			ConsumeEquiproomItem(1,4,343,1,-1)
			tbAwardTemplet:GiveAwardByList(tbItem, "PhÇn Th­ëng");
			WriteLogPro("dulieu/DoiTienDong.txt",""..GetAccount().."  "..GetName().."\t "..tonumber(GetLocalDate("%Y%m%d%H%M")).."   "..GetIP().."\t Da Doi 1 KNB Thanh 120 Xu\n");
		Msg2Player("Chóc Mõng "..myplayersex().." ®· ®æi thµnh c«ng 1 KNB nhËn ®­îc 120 TiÒn §ång")
