...
adddialognpc = {
	...
	--{227,78,1576,3200,"\\script\\global\\vn\\gamebank_proc.lua","TiÒn Trang Rót TiÒn"},
	...
	{377,387,1570,3132,"\\script\\task\\tollgate\\messenger\\messenger_flyrukou.lua","DŞch quan "},--DŞch quan cho phĞp ®i vµo b¶n ®å lµm nv tİn s?
	...
	--{1783,  174, 1644,3308, "\\script\\global\\°ï»á½ÓÒıÈË.lua", "Bang héi tiÕp dÉn nh©n "},
	--{1783,  121, 2036,4507, "\\script\\global\\°ï»á½ÓÒıÈË.lua", "Bang héi tiÕp dÉn nh©n "},
	--{1783,  153, 1609,3257, "\\script\\global\\°ï»á½ÓÒıÈË.lua", "Bang héi tiÕp dÉn nh©n "},
	--{1783,  101, 1694,3118, "\\script\\global\\°ï»á½ÓÒıÈË.lua", "Bang héi tiÕp dÉn nh©n "},
	--{1783,  99,  1578,3209, "\\script\\global\\°ï»á½ÓÒıÈË.lua", "Bang héi tiÕp dÉn nh©n "},
	--{1783,  100, 1614,3167, "\\script\\global\\°ï»á½ÓÒıÈË.lua", "Bang héi tiÕp dÉn nh©n "},
	--{1783,  20,  3534, 6197, "\\script\\global\\°ï»á½ÓÒıÈË.lua", "Bang héi tiÕp dÉn nh©n "},
	{1783,  78,  1558, 3207, "\\script\\global\\°ï»á½ÓÒıÈË.lua", "Bang héi tiÕp dÉn nh©n "},
}
...
nw_npclist = {
	...
	--NPC Nhiem Vu 150
	--{1847, 80,  1734, 2963, "\\script\\activitysys\\npcdailog.lua", "NguyÖt Ca V?V?},
	--{1849, 968,  1504, 2877, "\\script\\activitysys\\npcdailog.lua", "NguyÖt Ca §¶o Ch?},
	--NPC doi ngua
	--{698, 53,  1632, 3183, "\\script\\activitysys\\npcdailog.lua", "BËt M?¤n"},
	--NPC dai su lao lao doi ngu hanh ky thach
	--{218, 78,1580,3207, "\\script\\activitysys\\npcdailog.lua","§¹i S?L·o L·o"},
	--{354, 78,  1551, 3245, "\\script\\activitysys\\npcdailog.lua", "Ch?TiÖm"},
	--{1847, 78,  1593, 3225, "\\script\\activitysys\\npcdailog.lua", "Vi Minh §¹i HiÖp"},
	--{1907, 78,  1582, 3214, "\\script\\activitysys\\npcdailog.lua", "Thu V©n"},
	--{1891, 78,  1588, 3221, "\\script\\activitysys\\npcdailog.lua", "Th?May"},
	--{218,53,1622,3193,		  "\\script\\global\\g7vn\\testg7vn.lua","H?tr?th?nghiÖm"},


	--Event 20 thang 10
--	{230,37,1768,3075,	"\\script\\global\\g7vn\\xaphubienkinh.lua","Xa Phu Hoµng Kim"},	
--	{87,78,1579,3225,	"\\script\\eventpnvn\\eventpnvn.lua","Tæng Qu¶n s?kiÖn"},
--	{87,1,1584,3187,	"\\script\\eventpnvn\\eventpnvn.lua","Tæng Qu¶n s?kiÖn"},
--	{87,11,3144,5059,	"\\script\\eventpnvn\\eventpnvn.lua","Tæng Qu¶n s?kiÖn"},
...
--{700,25,5,80,1796,3393,0,"Chİnh ph¸i v? s?",0,"\\script\\task\\newtask\\branch\\xiepai\\enemy_shenfeng.lua"},
...
--{670,30,5,80,1395,3443,0,"V? l©m nh©n vËt tèng v©n phi ",0,"\\script\\task\\newtask\\branch\\zhongli\\enemy_wulinrenwulouqianxue.lua"},
--{670,30,5,80,1383,3447,0,"V? l©m nh©n vËt tÇn thêi phong ",0,"\\script\\task\\newtask\\branch\\zhongli\\enemy_wulinrenwuqinshifeng.lua"},
--{670,30,5,80,1377,3435,0,"V? l©m nh©n vËt Lam chiÕn ",0,"\\script\\task\\newtask\\branch\\zhongli\\enemy_wulinrenwulanzhan.lua"},
--{670,30,5,80,1381,3418,0,"V? l©m nh©n vËt do·n song  ®ång ",0,"\\script\\task\\newtask\\branch\\zhongli\\enemy_wulinrenwuyinshuangtong.lua"},
--{670,30,5,80,1390,3405,0,"V? l©m nh©n vËt ph? l·nh ",0,"\\script\\task\\newtask\\branch\\zhongli\\enemy_wulinrenwufeileng.lua"},
--{669,25,5,80,2004,2876,0,"Triªu thiªn bang bang ch? l? tr­êng thiªn ",0,"\\script\\task\\newtask\\branch\\zhongli\\enemy_luchangtian.lua"},
...
--{667,60,5,79,1683,3144,0,"ThÇn b? nh©n ",0,"\\script\\task\\newtask\\master\\zhengpai\\Õ½¶·_ÄÏ¹¬·ÉÔÆ.lua"},
...
--{694,80,2,94,1551,3149,0,"LiÖu  ®Şnh ",0,"\\script\\task\\newtask\\master\\xiepai\\Õ½¶·_ÁÎ¶¨.lua"},
...
--{447,1,4,100,1683,3362,0,"TiÕp nhËn tiªu bang",0,"\\script\\global\\quanlygame\\sukien\\vantieubanghoi\\npcdichden.lua",},
--{233,3,5,78,1582,3202,0,"B¸o Danh §ua Ngùa",0,"\\script\\global\\quanlygame\\item\\duangua\\baodanhduangua.lua",},
--{233,3,5,53,1593,3170,0,"B¸o Danh §ua Ngùa",0,"\\script\\global\\quanlygame\\item\\duangua\\baodanhduangua.lua",},
}
...
local tbActNpcList =
{
	--{311,176,1593,2943,"\\script\\missions\\dungeon\\dungeons\\shiliantang\\jieyinren.lua","Th? luyÖn  ®­êng tiÕp dÉn nh©n "},
	--{311,11,3108,5060,"\\script\\missions\\dungeon\\dungeons\\shiliantang\\jieyinren.lua","Th? luyÖn  ®­êng tiÕp dÉn nh©n "},
	--{311,1,1585,3230,"\\script\\missions\\dungeon\\dungeons\\shiliantang\\jieyinren.lua","Th? luyÖn  ®­êng tiÕp dÉn nh©n "},
	--{311,37,1740,3065,"\\script\\missions\\dungeon\\dungeons\\shiliantang\\jieyinren.lua","Th? luyÖn  ®­êng tiÕp dÉn nh©n "},
	--{311,162,1613,3190,"\\script\\missions\\dungeon\\dungeons\\shiliantang\\jieyinren.lua","Th? luyÖn  ®­êng tiÕp dÉn nh©n "},
	--{311,78,1608,3238,"\\script\\missions\\dungeon\\dungeons\\shiliantang\\jieyinren.lua","Th? luyÖn  ®­êng tiÕp dÉn nh©n "},
	--{311,80,1704,3058,"\\script\\missions\\dungeon\\dungeons\\shiliantang\\jieyinren.lua","Th? luyÖn  ®­êng tiÕp dÉn nh©n "},
	
	--{1327, 20,3554,6188, "\\script\\global\\tieungao\\duatopnhanthuong.lua","Nghi L©m S?Muéi"},
	--{1327, 174,1628,3218, "\\script\\global\\tieungao\\duatopnhanthuong.lua","Nghi L©m S?Muéi"},
	--{1327, 121,1963,4511, "\\script\\global\\tieungao\\duatopnhanthuong.lua","Nghi L©m S?Muéi"},
	--{1327, 153,1612,3226, "\\script\\global\\tieungao\\duatopnhanthuong.lua","Nghi L©m S?Muéi"},
	--{1327, 99,1615,3166, "\\script\\global\\tieungao\\duatopnhanthuongd3.lua","Nghi L©m S?Muéi"},--vinh lac tran
	--{1327, 100,1626,3181, "\\script\\global\\tieungao\\duatopnhanthuongd2.lua","Nghi L©m S?Muéi"},--chu tien tran
	--{1327, 53,1632,3199, "\\script\\global\\tieungao\\duatopnhanthuong.lua","Nghi L©m S?Muéi"},--ba lang huyen
