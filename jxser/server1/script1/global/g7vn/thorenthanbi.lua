...
--tbDailog:AddOptEntry("§æi Cµn Kh«n Song TuyÖt Béi 7,15 Ngµy --> 800 R­¬ng M¶nh", doicankhonsangmanh)
...
function doicankhonsangmanh()

GiveItemUI("§æi VËt PhÈm", "", "doicankhonsangmanh_ok", "no", 1)

end
function doicankhonsangmanh_ok(nCount)
if nCount~=1 then
Say("ChØ bá Cµn Kh«n Song TuyÖt Béi 7 Ngµy vµo")
return 0
end
...
if (nG==6 and nP==4377) or  (nG==6 and nP==4446)	then
	if nP==4377 then
	ConsumeEquiproomItem(1,6,1,4377,-1)
	else
	ConsumeEquiproomItem(1,6,1,4446,-1)
	end
	tbAwardTemplet:GiveAwardByList({{szName = "R­¬ng M¶nh Thiªn Th¹ch",tbProp={6,1,4455,1,1},nCount=800},}, "test", 1);
	Msg2Player("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> ®· ®æi <color=green>Cµn Kh«n Song TuyÖt Béi --> <color=red>800 R­¬ng M¶nh Thiªn Th¹ch")
else
	Say("Thø nµy kh«ng ph¶i lµ Cµn Kh«n Song TuyÖt Béi 7 Ngµy hoÆc 15 Ngµy")
	return
end
...
local nItemIndex = GetGiveItemUnit(1)
		...
		if nItemLevel==0 then 
			...
			UpgradePlatinaItem(GetGiveItemUnit(1)) 
			UpgradePlatinaItem(GetGiveItemUnit(1)) 
			UpgradePlatinaItem(GetGiveItemUnit(1)) SetItemBindState(nItemIndex, -2)
...
Msg2Player("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> N©ng CÊp Thµnh C«ng <color=green>Trang BÞ <color=red>Lªn B¹ch Kim")
end
...
nItemLevel = GetPlatinaLevel(GetGiveItemUnit(1));
		...
		--	nItemLeveltc=nItemLevel+1
			...
			for i=1317,1325 do
			tbAwardTemplet:GiveAwardByList({{szName = "M¶nh Thiªn Th¹ch",tbProp={4,i,1,1,0},nCount=30},}, "test", 1);
			end
		--	AddStackItem(2,4,343,1,1,0,0)
			Msg2SubWorld("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> R· Thµnh C«ng <color=green>Trang BÞ "..szItemName.." <color=red>Thµnh 30 M¶nh Thiªn Th¹ch. ")
			else Say("Trang BÞ Hoµng Kim Kh«ng Ph¶i +1 ")
		end
		end
end
function ratrangbi2()
...
nItemLevel = GetPlatinaLevel(GetGiveItemUnit(1));
		...
		--	nItemLeveltc=nItemLevel+1
			...
			ConsumeEquiproomItem(20,4,417,1,1)
			for i=1317,1325 do
			tbAwardTemplet:GiveAwardByList({{szName = "M¶nh Thiªn Th¹ch",tbProp={4,i,1,1,0},nCount=60},}, "test", 1);
			end
		--	AddStackItem(2,4,343,1,1,0,0)
			Msg2SubWorld("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> R· Thµnh C«ng <color=green>Trang BÞ "..szItemName.." <color=red>Thµnh 60 M¶nh Thiªn Th¹ch. ")
			else Say("Trang BÞ Hoµng Kim Kh«ng Ph¶i +2")
		end
		end
end
function ratrangbi3()
...
nItemLevel = GetPlatinaLevel(GetGiveItemUnit(1));
		...
		--	nItemLeveltc=nItemLevel+1
			...
			ConsumeEquiproomItem(20,4,417,1,1)
			for i=1317,1325 do
			tbAwardTemplet:GiveAwardByList({{szName = "M¶nh Thiªn Th¹ch",tbProp={4,i,1,1,0},nCount=90},}, "test", 1);
			end
		--	AddStackItem(2,4,343,1,1,0,0)
			Msg2SubWorld("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> R· Thµnh C«ng <color=green>Trang BÞ "..szItemName.." <color=red>Thµnh 90 M¶nh Thiªn Th¹ch. ")
			else Say("Trang BÞ Hoµng Kim Kh«ng Ph¶i +3 ")
		end
		end
end
function ratrangbi4()
...
nItemLevel = GetPlatinaLevel(GetGiveItemUnit(1));
		...
		--	nItemLeveltc=nItemLevel+1
			...
			ConsumeEquiproomItem(20,4,417,1,1)
			for i=1317,1325 do
			tbAwardTemplet:GiveAwardByList({{szName = "M¶nh Thiªn Th¹ch",tbProp={4,i,1,1,0},nCount=120},}, "test", 1);
			end
		--	AddStackItem(2,4,343,1,1,0,0)
			Msg2SubWorld("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> R· Thµnh C«ng <color=green>Trang BÞ "..szItemName.." <color=red>Thµnh 120 M¶nh Thiªn Th¹ch. ")
			else Say("Trang BÞ Hoµng Kim Kh«ng Ph¶i +4")
		end
		end
end
function ratrangbi5()
...
nItemLevel = GetPlatinaLevel(GetGiveItemUnit(1));
		...
		--	nItemLeveltc=nItemLevel+1
			...
			ConsumeEquiproomItem(20,4,417,1,1)
			for i=1317,1325 do
			tbAwardTemplet:GiveAwardByList({{szName = "M¶nh Thiªn Th¹ch",tbProp={4,i,1,1,0},nCount=150},}, "test", 1);
			end
		--	AddStackItem(2,4,343,1,1,0,0)
			Msg2SubWorld("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> R· Thµnh C«ng <color=green>Trang BÞ "..szItemName.." <color=red>Thµnh 150 M¶nh Thiªn Th¹ch. ")
			else Say("Trang BÞ Hoµng Kim Kh«ng Ph¶i +5 ")
		end
		end
end
...
nItemLevel = GetPlatinaLevel(GetGiveItemUnit(1));
		...
		--	nItemLeveltc=nItemLevel+1
			...
			ConsumeEquiproomItem(20,4,417,1,1)
			for i=1317,1325 do
			tbAwardTemplet:GiveAwardByList({{szName = "M¶nh Thiªn Th¹ch",tbProp={4,i,1,1,0},nCount=250},}, "test", 1);
		--	tbAwardTemplet:GiveAwardByList({{szName = "M¶nh Thiªn Th¹ch",tbProp={4,i,1,1,0},nCount=100},}, "test", 1);
			end
		--	AddStackItem(2,4,343,1,1,0,0)
			Msg2SubWorld("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> R· Thµnh C«ng <color=green>Trang BÞ "..szItemName.." <color=red>Thµnh 250 M¶nh Thiªn Th¹ch. ")
			else Say("Trang BÞ Hoµng Kim Kh«ng Ph¶i +6")
		end
		end
end
function ratrangbi7()
...
nItemLevel = GetPlatinaLevel(GetGiveItemUnit(1));
		...
		--	AddStackItem(2,4,343,1,1,0,0)
			Msg2SubWorld("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> R· Thµnh C«ng <color=green>Trang BÞ "..szItemName.." <color=red>Thµnh 250 M¶nh Thiªn Th¹ch. ")
			else Say("Trang BÞ Hoµng Kim Kh«ng Ph¶i +7")
		end
		end
end
...
nItemLevel = GetPlatinaLevel(GetGiveItemUnit(1));
		...
		--	AddStackItem(2,4,343,1,1,0,0)
			Msg2SubWorld("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> R· Thµnh C«ng <color=green>Trang BÞ "..szItemName.." <color=red>Thµnh 50 Xu ")
			else Say("Trang BÞ Hoµng Kim Kh«ng Ph¶i +6 ")
		end
		end
end
...
nItemLevel = GetPlatinaLevel(GetGiveItemUnit(1));
		...
		--	AddStackItem(10,4,343,1,1,0,0)
			...
			Msg2SubWorld("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> R· Thµnh C«ng <color=green>Trang BÞ "..szItemName.." <color=red>Thµnh 150 Xu + 100  M¶nh TT mçi lo¹i")
			else Say("Trang BÞ Hoµng Kim Kh«ng Ph¶i +7 ")
		end
		end
end
...
nItemLevel = GetPlatinaLevel(GetGiveItemUnit(1));
		...
		--	nItemLeveltc=nItemLevel+1
			...
			ConsumeEquiproomItem(100,4,417,1,1)
			for i=1317,1325 do
			tbAwardTemplet:GiveAwardByList({{szName = "M¶nh Thiªn Th¹ch",tbProp={4,i,1,1,0},nCount=500},}, "test", 1);
			--tbAwardTemplet:GiveAwardByList({{szName = "M¶nh Thiªn Th¹ch",tbProp={4,i,1,1,0},nCount=200},}, "test", 1);
			end
			Msg2SubWorld("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> R· Thµnh C«ng <color=green>Trang BÞ "..szItemName.." <color=red>Thµnh 500 M¶nh Thiªn Th¹ch. ")
			else Say("Trang BÞ Hoµng Kim Kh«ng Ph¶i +8 ")
		end
		end
end
...
nItemLevel = GetPlatinaLevel(GetGiveItemUnit(1));
		...
		--	nItemLeveltc=nItemLevel+1
			...
			AddStackItem(200,4,1325,1,1,0,0)
			Msg2SubWorld("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> R· Thµnh C«ng <color=green>Trang BÞ "..szItemName.." <color=red>Thµnh 450 Xu + 400  M¶nh TT mçi lo¹i")
			else Say("Trang BÞ Hoµng Kim Kh«ng Ph¶i +9 ")
		end
		end
end
...
nItemLevel = GetPlatinaLevel(GetGiveItemUnit(1));
		...
		--	nItemLeveltc=nItemLevel+1
			...
			AddStackItem(200,4,1325,1,1,0,0)
			Msg2SubWorld("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> R· Thµnh C«ng <color=green>Trang BÞ "..szItemName.." <color=red>Thµnh 650 Xu + 600  M¶nh TT mçi lo¹i")
			else Say("Trang BÞ Hoµng Kim Kh«ng Ph¶i +10 ")
		end
		end
end
------------------------------------------------------------------------------------ra bach kim
...
if int==6 then
GiveItemUI("N©ng CÊp Trang BÞ B¹ch Kim", "Xin h·y bá vµo trang bÞ vµo \nKh«ng bá nguyªn liÖu vµo \nNguyªn LiÖu: \n+9 lo¹i m¶nh thiªn th¹ch ,mçi lo¹i 100 m¶nh\n+20 Xu", "nangbachkim6", "no", 1)
end

if int==61 then
GiveItemUI("N©ng CÊp Trang BÞ B¹ch Kim", "Xin h·y bá vµo trang bÞ vµo\n Chi PhÝ: 50 xu + 2 KNB(Khãa)", "nangbachkim61", "no", 1)
end

if int==7 then
GiveItemUI("N©ng CÊp Trang BÞ B¹ch Kim","Xin h·y bá vµo trang bÞ vµo \nKh«ng bá nguyªn liÖu vµo \nNguyªn LiÖu: \n+9 lo¹i m¶nh thiªn th¹ch ,mçi lo¹i 250 m¶nh\n+1 Hoµng Kim Ngäc Bµi", "nangbachkim7", "no", 1)
end

if int==8 then
GiveItemUI("N©ng CÊp Trang BÞ B¹ch Kim", "Xin h·y bá vµo trang bÞ vµo \nKh«ng bá nguyªn liÖu vµo \nNguyªn LiÖu: \n+9 lo¹i m¶nh thiªn th¹ch ,mçi lo¹i 250 m¶nh\n+10 Hoµng Kim Ngäc Bµi", "nangbachkim8", "no", 1)
end

if int==9 then
GiveItemUI("N©ng CÊp Trang BÞ B¹ch Kim", "Xin h·y bá vµo trang bÞ vµo\n Chi PhÝ: 150 xu + 20 KNB + 200 M¶nh TT Mçi Lo¹i", "nangbachkim9", "no", 1)
end

if int==10 then
GiveItemUI("N©ng CÊp Trang BÞ B¹ch Kim", "Xin h·y bá vµo trang bÞ vµo\n Chi PhÝ: 200 xu + 20 KNB + 200 M¶nh TT Mçi Lo¹i", "nangbachkim10", "no", 1)
end
...
if ttcap1 <200 or ttcap2 <200 or  ttcap3 <200 or  ttcap4 <200 or  ttcap5 <200 or ttcap6 <200 or ttcap7 <200 or ttcap8 <200 or ttcap9 < 200 then
...
nItemLevel = GetPlatinaLevel(GetGiveItemUnit(1));
		if nItemLevel==9 then
			...
			UpgradePlatinaItem(GetGiveItemUnit(1))
			Msg2SubWorld("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> N©ng CÊp Thµnh C«ng <color=green>Trang BÞ "..szItemName.." <color=red>Lªn B¹ch Kim CÊp <color=yellow>"..nItemLeveltc.."")
			else Say("Trang BÞ Hoµng Kim Kh«ng Ph¶i +9 ")
		end
...
if ttcap1 <250 or ttcap2 <250 or  ttcap3 <250 or  ttcap4 <250 or  ttcap5 <250 or ttcap6 <250 or ttcap7 <250 or ttcap8 <250 or ttcap9 < 250 or hoangkimngocbai<10 then
Say("Kh«ng §ñ Nguyªn LiÖu ");
return 0;
end
...
if ttcap1 <250 or ttcap2 <250 or  ttcap3 <250 or  ttcap4 <250 or  ttcap5 <250 or ttcap6 <250 or ttcap7 <250 or ttcap8 <250 or ttcap9 < 250 or hoangkimngocbai<1 then
...
local ttcap8 = CalcEquiproomItemCount(4,1324,1,-1)
local ttcap9 = CalcEquiproomItemCount(4,1325,1,-1)
if ttcap1 <100 or ttcap2 <100 or  ttcap3 <100 or  ttcap4 <100 or  ttcap5 <100 or ttcap6 <100 or ttcap7 <100 or ttcap8 <100 or ttcap9 < 100 or xu<20 then
...
if nGoldEquipIdx==5 or nGoldEquipIdx==7 or nGoldEquipIdx==12 or nGoldEquipIdx==29 or nGoldEquipIdx==32 or nGoldEquipIdx==37 or nGoldEquipIdx==47 or nGoldEquipIdx==52 or nGoldEquipIdx==65 or nGoldEquipIdx==70 or nGoldEquipIdx==79 or nGoldEquipIdx==90 or nGoldEquipIdx==91 or nGoldEquipIdx==104 or nGoldEquipIdx==112 or nGoldEquipIdx==110 or nGoldEquipIdx==117 or nGoldEquipIdx==124 or nGoldEquipIdx==127 or nGoldEquipIdx==134 or nGoldEquipIdx==17 or nGoldEquipIdx==25 or nGoldEquipIdx==41 or nGoldEquipIdx==42 or nGoldEquipIdx==44 or nGoldEquipIdx==45 or nGoldEquipIdx==66 or nGoldEquipIdx==67 or nGoldEquipIdx==69 or nGoldEquipIdx==70 or nGoldEquipIdx==82 or (nGoldEquipIdx>=86 and nGoldEquipIdx<=90) or nGoldEquipIdx==106 or nGoldEquipIdx==107 or nGoldEquipIdx==108 or nGoldEquipIdx==110 or (nGoldEquipIdx>=136 and nGoldEquipIdx<=140)   then
	Say("VËt PhÈm Nµy Kh«ng ThÓ N©ng CÊp")
	return 0;
end
...
UpgradePlatinaFromGoldItem(GetGiveItemUnit(1)) 
Msg2SubWorld("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> N©ng CÊp Thµnh C«ng <color=green>Trang BÞ "..szItemName.." <color=red>Lªn B¹ch Kim")
end
end
------------------------------------------------------------------------------------------------------------------------
...
if nGoldEquipIdx==5 or nGoldEquipIdx==7 or nGoldEquipIdx==12 or nGoldEquipIdx==29 or nGoldEquipIdx==32 or nGoldEquipIdx==37 or nGoldEquipIdx==47 or nGoldEquipIdx==52 or nGoldEquipIdx==65 or nGoldEquipIdx==70 or nGoldEquipIdx==79 or nGoldEquipIdx==90 or nGoldEquipIdx==91 or nGoldEquipIdx==104 or nGoldEquipIdx==112 or nGoldEquipIdx==110 or nGoldEquipIdx==117 or nGoldEquipIdx==124 or nGoldEquipIdx==127 or nGoldEquipIdx==134 then
	Say("VËt PhÈm Nµy Kh«ng ThÓ N©ng CÊp")
	return 0;
end
...
local nItemLevel = GetPlatinaLevel(GetGiveItemUnit(1));
	if nItemLevel<6 then
		...
		UpgradePlatinaItem(GetGiveItemUnit(1))
		Msg2SubWorld("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> N©ng CÊp Thµnh C«ng <color=green>Trang BÞ "..szItemName.." <color=red>Lªn B¹ch Kim CÊp <color=yellow> "..nItemLevelok.."")
	else Say("VËt PhÈm §· +6 vµ kh«ng ThÓ N©ng CÊp") return
	end
end
...
--Msg2Player("-"..nItemIndex.."-")
	if xu>=200 then
		if GetSex() == 1 then
			...
			ConsumeEquiproomItem(200, 4,417, 1,-1) 
			Msg2SubWorld("<color=cyan>Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color=yellow> N©ng CÊp Thµnh C«ng <color=red>Ngo¹i Trang §Ñp Trai")
	else
		Say("Kh«ng §ñ 200 Xu")
	end
end
