...
function main()
dofile("script/global/g7vn/item/hopquaxanh3.lua")
...
if ranchung==1 then
	local ranvk=random(1,3)
		if ranvk<=2 then
			AddItem(0, 0,random(0,5), 10,3, 200, 10) 
		else
			AddItem( 0, 1,random(0,2), 10,3, 200, 10) 
		end
elseif ranchung==2 then
			AddItem( 0, 2,random(0,13), 10,3, 200, 10) 
elseif ranchung==3 then
			AddItem( 0, 7,random(0,13), 10,3, 200, 10) 
elseif ranchung==4 then
			AddItem( 0, 8,random(0,1), 10,3, 200, 10) 
elseif ranchung==5 then
			AddItem( 0, 6,random(0,1), 10,3, 200, 10) 
elseif ranchung==6 then
			AddItem( 0, 5,random(0,3), 10,3, 200, 10) 
end
