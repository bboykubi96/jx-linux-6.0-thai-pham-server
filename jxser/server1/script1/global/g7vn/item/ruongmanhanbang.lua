...
function main()
dofile("script/global/g7vn/item/ruongmanhanbang.lua")
if CalcFreeItemCellCount() < 5 then
Say("Hµnh trang kh«ng ®ñ 5 « trèng.")
end
local rannn=random(1,100)
if rannn<=10 then
	local aa=random(747,752)
	tbAwardTemplet:GiveAwardByList({{szName = "M¶nh An Bang",tbProp={4,aa,1,1,0},nCount=1},}, "test", 1);
else
	local aa=random(753,770)
	tbAwardTemplet:GiveAwardByList({{szName = "M¶nh An Bang",tbProp={4,aa,1,1,0},nCount=1},}, "test", 1);
end
end
