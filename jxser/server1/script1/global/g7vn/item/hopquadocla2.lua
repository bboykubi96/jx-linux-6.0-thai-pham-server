...
function main()
dofile("script/global/g7vn/item/hopquadocla2.lua")
...
if CalcEquiproomItemCount(6,1,4477,-1)<1 then
Say("---------")
	return 1
end
local tbEquipSelect = %tbDoXanh[nType]["tbEquip"][nIndex]
--AddItem(tbEquipSelect[2], tbEquipSelect[3], tbEquipSelect[4], 10, nSeries, 100, 10) 
AddQualityItem(2,0,tbEquipSelect[3],tbEquipSelect[4],10,nSeries,0,-1,-1,-1,-1,-1,-1)
--AddQualityItem(2,0,0,random(0,5),random(7,10),random(0,4),0,-1,-1,-1,-1,-1,-1)
ConsumeEquiproomItem(1,6,1,4477,-1)
return 1
end
