...
function oldentencehs() 
-- script viet hoa By http://tranhba.com  if (check_skill() == 0) then 
-- script viet hoa By http://tranhba.com  return 
-- script viet hoa By http://tranhba.com  end 
local UTask_tm = GetTask(11); 
local nFactID = GetLastFactionNumber(); 



local tbDes = {"Ta muèn chuyÓn ®æi vÒ m«n ph¸i Hoa S¬n/#daiyitoushi_main(10)","Muèn mêi d¹y nh÷ng chuyÖn kh¸c /common_talk"}; 
