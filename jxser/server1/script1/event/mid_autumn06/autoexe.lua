--by ÁÎÖ¾É½ [2006-09-12]
--2006ÖÐÇï»î¶¯Ö®Ôö¼Óº¢Í¯NPC
--Illustration: µÆÁý -- lightcage au06- -- midautumn2006

if (not __H_MIDAUTUMN_AUTO_06__) then
	__H_MIDAUTUMN_AUTO_06__ = 1;
	
-- Include("\\script\\event\\mid_autumn06\\head.lua");	by ×Ó·Çô~ 2009-06-01 ¹ýÆÚÉ¾³ý
-- AU06_KIDNPCSCRIPT = "\\script\\event\\funv_jieri\\200803\\meirenxianhua.lua";	by ×Ó·Çô~ 2009-06-01 ¹ýÆÚÉ¾³ý
...
au06_tab_kidnpc = {
	...
	--{665,	53,		1622,	3193,	AU06_KIDNPCSCRIPT,	"NPC Hç Trî Test"}, --Ba lang huyen
