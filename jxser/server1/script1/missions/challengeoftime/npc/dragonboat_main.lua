...
function want_playboat()
	...
	--do Say("Theo lé tr×nh TOP 10 thÕ giíi ®¹t LV 100 míi më tÝnh n¨ng nµy") return end
	...
	if (startboat == 1) then
		if (freeboat == 0) then
			...
			Say("Khu vùc  "..strlevel.." giai ®o¹n b¸o danh ®ua thuyÒn rång, vÉn cßn <color=red> "..freeboat.." <color> b¶n ®å nhiÖm vô miÔn phÝ, tham gia khiªu chiÕn cÇn ph¶i giao <color=red>10 v¹n<color> ng©n l­îng, ng­¬i muèn tham gia kh«ng?",2, "Ph¶i! Ta muèn dÉn d¾t ®éi cña ta tham gia./dragon_join", "Kh«ng cÇn/onCancel")
			return
		end
	else
...
local nocount=0
	...
	if (GetCash() < 100000) then
		Say("Tham gia nhiÖm vô “Th¸ch thøc thêi gian” cÇn <color=red>10 v¹n l­îng<color>. ChuÈn bÞ ®ñ tiÒn råi h·y quay l¹i!", 0)
		return
	end
