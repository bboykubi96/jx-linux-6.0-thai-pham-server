-- script viet hoa By http://tranhba.com  kiÕm c¸c thôc ®¹o chiÕn ®Êu NPC rÊt ng­êi 2 ThiÕu L©m 20 cÊp nhiÖm vô 
...
function OnDeath() 
UTask_sl = GetTask(7); 
	if (UTask_sl >= 20*256+64) and (UTask_sl < 20*256+128) and (GetBit(UTask_sl,2) == 0) then			-- script viet hoa By http://tranhba.com  ÈÎÎñÖĞÇÒÕâÒ»Ö»Î´´ò¹ı
