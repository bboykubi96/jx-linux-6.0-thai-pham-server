-- script viet hoa By http://tranhba.com description: biÖn kinh phñ thiÕt th¸p mét tÇng b¶o r­¬ng ngµy nhÉn d¹y 50 cÊp nhiÖm vô 
...
AddNote("Më ra thø nhÊt c¬ quan ") 
Msg2Player("Më ra tÇng thø nhÊt dÆm b¶o r­¬ng , më ra thø nhÊt c¬ quan ") 
