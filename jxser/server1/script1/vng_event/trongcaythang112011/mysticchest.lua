...
function main(nIdx)
	local tbAward = {
		...
		--{szName = "§iÓm Kinh NghiÖm", nExp_tl=1, nCount = 50000000, nRate = 70},
		--{szName ="MÆt n¹ V­¬ng Gi¶",tbProp={0,11, 561,1,0,0},nCount=1, nExpiredTime = 20160, nRate = 30, CallBack = %_Message},
	}
	local tbBitTask = {
		nTaskID = 2912,
		nStartBit = 15,
