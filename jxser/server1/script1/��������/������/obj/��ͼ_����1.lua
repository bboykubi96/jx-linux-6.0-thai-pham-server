-- script viet hoa By http://tranhba.com  long m«n trÊn - cæ d­¬ng ®éng - c¬ quan 1( thÕ giíi nhiÖm vô “ cøu tiÓu ®Ñp ”) 
...
if (GetBit(Uworld41,9) == 0) then -- script viet hoa By http://tranhba.com  c¬ quan tr­íc mÆt v× t¾t 
...
AddNote("Ng­¬i ®· gi¶i trõ c¬ quan , cøu ra tiÓu ®Ñp . ") 
else 
