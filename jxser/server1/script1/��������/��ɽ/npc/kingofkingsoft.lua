...
elseif (oper == 0) and (GetCamp() == 4) and (GetLevel() >= 60) and (GetRepute() >= 200) and (GetLeadLevel() >= 20) and (HaveItem(195) == 1) then 
...
function create_pay() 
Say("Kim s¬n ch­ëng m«n nh©n # nh­ vËy , ng­¬i chØ cÇn cã ®Çy ®ñ tiÒn b¹c ®Ó cho bang ph¸i cã thÓ vËn chuyÓn lªn lµ ®­îc råi , nãi thİ dô nh­ cã c¸ 2000 v¹n l­îng b¹c ®i . ",2,"Kh«ng thµnh vÊn ®Ò , ta ®· cã 2000 v¹n l­îng b¹c /create_pay_yes","Qu¸ phİ tiÒn , İt mét chót cã ®­îc hay kh«ng /create_pay_no") 
end 

function create_pay_yes() 
if (GetCash() >= 20000000) then 
Pay(20000000) -- script viet hoa By http://tranhba.com  thu lÖ phİ 
