...
function main()
	...
	if ( messenger_middletime() == 10 ) then 
            ...
            if ( Uworld1206 == 0 ) then 
                Describe(DescLink_BaiYi..":"..name..", Ng­¬i kh«ng ph¶i lµ ®· xuyªn qua phong kş khiªu chiÕn sao ? NghÜ ra quan a ?",3,"§èi víi. Ta muèn rêi ®i/messenger_comeback","Ta kh«ng hoµn thµnh kh¶o nghiÖm, nh­ng lµ kh«ng muèn tiÕp tôc lµm/messenger_icantdo","Kh«ng ph¶i, ta cßn muèn tiÕp tôc /no") 
            elseif ( Uworld1206 == 1 ) then 
                Describe(DescLink_BaiYi..": Tİn sø lÖnh - méc "..name..", ng­¬i kh«ng ph¶i lµ ®· xuyªn qua phong kş khiªu chiÕn sao ? NghÜ ra quan a ?",3,"§èi víi. Ta muèn rêi ®i /messenger_comeback","Ta kh«ng hoµn thµnh kh¶o nghiÖm, nh­ng lµ kh«ng muèn tiÕp tôc lµm /messenger_icantdo","Kh«ng ph¶i lµ, ta cßn muèn tiÕp tôc/no") 
