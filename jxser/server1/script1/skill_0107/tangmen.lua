...
SKILLS={
	...
	shehun_yueying={ --摄魂月影
		physicsenhance_p={{{1,25},{15,150},{20,580}}},
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		poisondamage_v={{{1,5},{20,100}},{{1,60},{20,60}},{{1,10},{20,10}}},
	...
	baoyu_lihua={ --暴雨梨花
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		physicsenhance_p={{{1,15},{15,300},{20,920}}},          --650
	...
	zhuixing_zhudian={ --追星逐电
		seriesdamage_p={{{1,1},{20,1},{21,1}}},
		poisondamage_v={{{1,0},{20,0}},{{1,0},{20,0}},{{1,0},{20,0}}},
	},
	nutang150={ --弩唐门150
		seriesdamage_p={{{1,40},{15,40},{20,80},{21,82}}},
	...
	jiugong_feixing={ --九宫飞星
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		physicsenhance_p={{{1,10},{15,100},{20,315}}}, --275
		deadlystrike_p={{{1,10},{20,42}}},
