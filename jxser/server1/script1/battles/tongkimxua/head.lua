...
--	--Ä£Ê½×ÜÅÅÐÐ°ñ
	...
	TB_QIANQIU_YINGLIE0904:sorter_award(game_level)--phan thuong tong kim top 1 2 3
...
if (result == 0) then
	--local phitongkimxua = 200000
	--if (GetCash() >= phitongkimxua) then
	--	Pay(phitongkimxua)
...
--	else
--		Say("Muèn tham gia chiÕn tr­êng Tèng Kim h·y ñng hé "..phitongkimxua.." l­îng", 0)
--		return 
--	end
end
