-- script viet hoa By http://tranhba.com  t©y b¾c b¾c khu l­u tiªn ®éng tÇng ba 5to l­u tiªn ®éng bèn tÇng 3 
-- script viet hoa By http://tranhba.com TrapID# t©y b¾c b¾c khu 35 
...
function main(sel) 
Talk(1,"L60_q3","Ng­¬i thÊy mét c¬ quan , phÝa trªn cã kh¾c ") 
-- script viet hoa By http://tranhba.com  AddTermini(47) -- script viet hoa By http://tranhba.com  ®©y lµ vËt g× ? 
end; 

function L60_q3() 
Say("ThiÓu h¹o phô th©n cña lµ Th¸i b¹ch kim tinh , h¾n ë mét nghÌo khã ®Ých th«n trang cuéc sèng , v× vËy l¹i x­ng nghÌo tang thÞ . thiÓu h¹o tõng ë ®«ng ph­¬ng thµnh lËp ®iÓu v­¬ng quèc , quèc néi ®Ých v¨n vâ b¸ quan ®Òu lµ ®iÓu . trong ®ã yÕn tö lµ bèn lÔ quan trung ®Ých mét con , ng­¬i biÕt nã tr­ëng quan lµ c¸i g× lÔ quan sao ",4,"Xu©n /L60_S3_correct","H¹ /L60_S3_wrong","Thu /L60_S3_wrong","§«ng /L60_S3_wrong") 
end 
