-- script viet hoa By http://tranhba.com  long m«n trÊn - cæ d­¬ng ®éng - c¬ quan 3( thÕ giíi nhiÖm vô “ cøu tiÓu ®Ñp ”) 
...
if (GetBit(Uworld41,11) == 0) then -- script viet hoa By http://tranhba.com  c¬ quan tr­íc mÆt v× t¾t 
