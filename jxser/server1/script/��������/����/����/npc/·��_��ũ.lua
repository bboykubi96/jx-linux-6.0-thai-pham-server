-- script viet hoa By http://tranhba.com  §¹i Lý # ng­êi ®i ®­êng # hoa n«ng 
...
Talk(1,"","R¬i s­ huynh l¹i tíi kh¶o nghiÖm ng­¬i ? thËt tèt qu¸ , §¹i Lý bèn mïa mïi hoa , cßn thiÕu d­îc v­¬ng cèc ®Ých cùc phÈm tö môc tóc , ng­¬i ®i gióp ta h¸i 3 ®ãa trë l¹i ") 
else 
...
Talk(1,"","ThËt lµ h¶o , thËt lµ nhÊt phÈm , ta sÏ ph¸i ng­êi ®i th«ng b¸o r¬i s­ huynh , nãi ta ®ång ý .") 
else 
...
i = random(0,99) 
if (i < 25) then 
Talk(1,"","V©n Nam trµ hoa ®Ö nhÊt thiªn h¹ , §¹i Lý trµ hoa V©n Nam thø nhÊt , chóng ta §¹i Lý m¾t ng­êi trung ®Ých trµ hoa ®Ö nhÊt thiªn h¹ , mÉu ®¬n còng kh«ng cã thÓ so .") 
elseif (i < 50) then 
Talk(1,"","§¹i Lý gia gia hé hé còng lo¹i trµ hoa , hµng n¨m còng tæ chøc hoa hñy triÓn l·m .") 
elseif (i < 75) then 
Talk(1,"","Toµn §¹i Lý ®Ñp nhÊt ®Ých hoa trµ tõ hä §oµn ®Ých l·o «ng trång trät , h¾n cuéc sèng ë nhÞ bê biÓn ®Ých mét tßa bªn trong c¸i phßng nhá . hoa cña h¾n hµng n¨m còng tham gia triÓn sÏ , còng bÞ chän v× ®Ñp nhÊt ®Ých hoa .") 
else 
