...
DelItem(198) 
			SetTask(6,40*256+30)
AddNote("§¸nh b¹i ¸c ph¸ch ®Ých trî thñ , cÇm 3 c¸i ch×a khãa më ra 3 c¸ h¾c c¨n phßng , cøu ra bÞ v©y ®Ých thiÕu n÷ . ") 
Msg2Player("§¸nh b¹i ¸c ph¸ch ®Ých trî thñ , cÇm 3 c¸i ch×a khãa më ra 3 c¸ h¾c c¨n phßng , cøu ra bÞ v©y ®Ých thiÕu n÷ . ") 
else 
...
Msg2Player("N¬i nµy cã mét c¬ quan , nh­ng lµ kh«ng hiÓu dïng ®Ó lµm c¸i g× ®Ých ") 
end 
end; 
