...
FEATURE_PERIOD = {1, 60, 100}; -- script viet hoa By http://tranhba.com  1 cÊp #1 kú diÖn m¹o , 60 cÊp #2 kú diÖn m¹o , 100 cÊp #3 kú diÖn m¹o 

function main(nPartnerIdx, nPartnerLevel) 
local nPartnerSeries = PARTNER_GetSeries(nPartnerIdx) -- script viet hoa By http://tranhba.com  ®¹t ®­îc ®ång b¹n ®Ých ngò hµnh 
