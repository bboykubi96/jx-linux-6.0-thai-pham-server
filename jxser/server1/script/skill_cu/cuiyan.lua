...
--		skill_cost_v={{{1,24},{20,100}}}
	...
	binggu_xuexin={ --±ù¹ÇÑ©ÐÄ
		addcoldmagic_v={{{1,60},{30,400}},{{1,-1},{2,-1}}},
		addcolddamage_v={{{1,30},{30,350}},{{1,-1},{2,-1}}},
		addphysicsmagic_v={{{1,30},{30,320}},{{1,-1},{2,-1}}},
		deadlystrikeenhance_p={{{1,5},{30,50,Conic}},{{1,-1},{2,-1}}},
		coldenhance_p={{{1,8},{30,98}},{{1,-1},{2,-1}}}
	},
