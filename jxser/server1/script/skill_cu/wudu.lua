...
SKILLS={
	...
	tiangang_disha={ --天罡地杀
		...
		poisondamage_v={{{1,25},{20,100}},{{1,60},{20,60}},{{1,10},{20,10}}},
		addskilldamage1={
			[1]={{1,354},{2,354}},
			[3]={{1,2},{20,181}}
		},
	...
	wudu_qijing={ --五毒奇经
		addpoisonmagic_v={{{1,2},{30,50}},{{1,-1},{20,-1}},{{1,11},{2,11}}},
		addpoisondamage_v={{{1,2},{30,25}},{{1,-1},{20,-1}},{{1,11},{2,11}}},
		--addpoisondamage_v={{{1,5},{30,100}},{{1,-1},{20,-1}},{{1,11},{2,11}}},
		poisonenhance_p={{{1,1},{30,17},{33,17},{35,17},{38,17}},{{1,-1},{2,-1}}},
		deadlystrikeenhance_p={{{1,2},{30,24}},{{1,-1},{2,-1}}},
		lifemax_yan_p={{{1,21},{35,20},{36,20}},{{1,-1},{30,-1}}},
		castspeed_v={{{1,0},{15,0},{30,0}},{{1,-1},{2,-1}}},
		attackspeed_v={{{1,0},{15,0},{30,0}},{{1,-1},{2,-1}}},
		fastwalkrun_p={{{1,0},{30,0}},{{1,18*120},{20,18*180}}},
	...
	yinfeng_shigu={ --阴风蚀骨
		seriesdamage_p={{{1,20},{15,20},{20,55},{21,56}}},
		poisondamage_v={{{1,20},{15,40},{20,120}},{{1,60},{20,60}},{{1,10},{20,10}}},
		--poisondamage_v={{{1,20},{15,80},{20,181}},{{1,60},{20,60}},{{1,10},{20,10}}},
		skill_attackradius={{{1,440},{20,480},{40,480}}},
