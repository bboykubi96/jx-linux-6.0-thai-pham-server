...
CommonMaterial_CheTaoAnhHao = {
	{szName="Anh Hµo LÖnh",tbProp={6,1,5443,1,0,0},nCount=1},
	{szName="Ng©n L­îng", nJxb=1, nCount = 400000000},
}
---------------------------------------------------------------------------------------------
AdditiveMaterial_CheTaoAnhHao = {
	{szName="Anh Hµo Th¹ch",tbProp={6,1,5448,1,0,0},nSuccessRate=5,nMaxSuccessRate=20},
}
---------------------------------------------------------------------------------------------------
tbFormulaList_CheTaoAnhHao = {
	[1] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Anh Hµo H¹ng Liªn", tbProp = {6,1,5580}, nSuccessRate = 20, nMaxSuccessRate = 20},
		},				
		nWidth = 2,
		nHeight = 1,
	...
	{				
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Anh Hµo Kh«i", tbProp = {6,1,5581}, nSuccessRate = 20, nMaxSuccessRate = 20},		
		},
		nWidth = 2,
		nHeight = 2,
		nFreeItemCellLimit = 1,		
	...
	[3] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Anh Hµo Th­îng Giíi", tbProp = {6,1,5582}, nSuccessRate = 20, nMaxSuccessRate = 20},			
		},		
		nWidth = 1,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[4] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Anh Hµo Hé UyÓn", tbProp = {6,1,5583}, nSuccessRate = 20, nMaxSuccessRate = 20},			
		},		
	...
	[5] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Anh Hµo Yªu §¸i", tbProp = {6,1,5584}, nSuccessRate = 20, nMaxSuccessRate = 20},			
		},
		nWidth = 2,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[6] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Anh Hµo Y", tbProp = {6,1,5585}, nSuccessRate = 20, nMaxSuccessRate = 20},			
		},		
		nWidth = 2,
		nHeight = 3,
		nFreeItemCellLimit = 1,
	...
	[7] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Anh Hµo Vò KhÝ", tbProp = {6,1,5586}, nSuccessRate = 20, nMaxSuccessRate = 20},		
		},		
	...
	[8] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Anh Hµo Hµi", tbProp = {6,1,5587}, nSuccessRate = 20, nMaxSuccessRate = 20},		
		},			
	...
	[9] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Anh Hµo Béi", tbProp = {6,1,5588}, nSuccessRate = 20, nMaxSuccessRate = 20},		
		},				
	...
	[10] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Anh Hµo H¹ Giíi", tbProp = {6,1,5589}, nSuccessRate = 20, nMaxSuccessRate = 20},		
		},		
...
function CheTaoAnhHao:Compose(nProductId)
	...
	self:ConsumeMaterial(%CommonMaterial_CheTaoAnhHao, 1, self.szLogTitle)			--LÊy Nguyªn LiÖu
	self:ConsumeAdditive(self.tbFormula.tbSpecialMaterial, self.szLogTitle)			--LÊy §å Phæ
	self:ConsumeAdditive(%AdditiveMaterial_CheTaoAnhHao, self.szLogTitle)				--LÊy VËt PhÈm T¨ng TØ LÖ %
...
function CheTaoAnhHao:ComposeGiveUI()
	...
	szContent = format("%s<enter>%-17s %s", szContent, "Trang BÞ DiÖu D­¬ng","1")
	szContent = format("%s<enter>%-17s %s", szContent, "§å Phæ Anh Hµo","1/10%")
	szContent = format("%s<enter>%-17s %s", szContent, "Anh Hµo Th¹ch","1 > 4")
	
	g_GiveItemUI(szTitle, szContent, {self.GiveUIOk, {self}}, nil, self.bAccessBindItem)
end
------------------------------------------------ChÕ T¹o Trang BÞ Anh Hµo-----------------------------------------------------------
function CheTaoAnhHao:SelectParts()
local szTitle = "<color=green>Hîp Thµnh Trang BÞ Anh Hµo Yªu CÇu:<color>\n"
...
for i=1, getn(tbFormulaList_CheTaoAnhHao) do
	tbFormulaList_CheTaoAnhHao[i].tbProduct = tbEquip_AnhHao[i]			--Trang BÞ Goi Ra
	tbFormulaList_CheTaoAnhHao[i].tbGoldEquip = tbEquip_DieuDuong[i]		--Trang BÞ Thu Ve
	tbFormulaList_CheTaoAnhHao[i].tbGoldEquipEx = tbEquip_DieuDuongMax[i]		--Trang BÞ Max Thu Ve
	
	local p = CheTaoAnhHao:new(tbFormulaList_CheTaoAnhHao[i], "CheTaoAnhHao", INVENTORY_ROOM.room_giveitem)
	local szOpt = format("ChÕ T¹o: %s", tbFormulaList_CheTaoAnhHao[i].szName)
	tinsert(tbDialogOpt, {szOpt, p.ComposeGiveUI, {p}})
end
tinsert(tbDialogOpt, {"Hñy Bá "})
--==================================================================================================================--
--pEventType:Reg("Thî rÌn","ChÕ T¹o Trang BÞ Anh Hµo", CheTaoAnhHao.SelectParts, {CheTaoAnhHao})
--==================================================================================================================--