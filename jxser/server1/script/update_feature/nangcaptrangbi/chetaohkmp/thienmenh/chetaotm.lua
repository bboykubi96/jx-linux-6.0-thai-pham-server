...
CommonMaterial_CheTaoThienMenh = {
	{szName="Thiªn MÖnh LÖnh",tbProp={6,1,5444,1,0,0},nCount=1},
	{szName="Ng©n L­îng", nJxb=1, nCount = 500000000},
}
---------------------------------------------------------------------------------------------
AdditiveMaterial_CheTaoThienMenh = {
	{szName="Thiªn MÖnh Th¹ch",tbProp={6,1,5449,1,0,0},nSuccessRate=5,nMaxSuccessRate=20},
}
---------------------------------------------------------------------------------------------------
tbFormulaList_CheTaoThienMenh = {
	[1] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Thiªn MÖnh H¹ng Liªn", tbProp = {6,1,5590}, nSuccessRate = 20, nMaxSuccessRate = 20},
		},				
		nWidth = 2,
		nHeight = 1,
	...
	{				
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Thiªn MÖnh Kh«i", tbProp = {6,1,5591}, nSuccessRate = 20, nMaxSuccessRate = 20},		
		},
		nWidth = 2,
		nHeight = 2,
		nFreeItemCellLimit = 1,		
	...
	[3] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Thiªn MÖnh Th­îng Giíi", tbProp = {6,1,5592}, nSuccessRate = 20, nMaxSuccessRate = 20},			
		},		
		nWidth = 1,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[4] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Thiªn MÖnh Hé UyÓn", tbProp = {6,1,5593}, nSuccessRate = 20, nMaxSuccessRate = 20},			
		},		
	...
	[5] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Thiªn MÖnh Yªu §¸i", tbProp = {6,1,5594}, nSuccessRate = 20, nMaxSuccessRate = 20},			
		},
		nWidth = 2,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[6] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Thiªn MÖnh Y", tbProp = {6,1,5595}, nSuccessRate = 20, nMaxSuccessRate = 20},			
		},		
		nWidth = 2,
		nHeight = 3,
		nFreeItemCellLimit = 1,
	...
	[7] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Thiªn MÖnh Vò KhÝ", tbProp = {6,1,5596}, nSuccessRate = 20, nMaxSuccessRate = 20},		
		},		
	...
	[8] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Thiªn MÖnh Hµi", tbProp = {6,1,5597}, nSuccessRate = 20, nMaxSuccessRate = 20},		
		},			
	...
	[9] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Thiªn MÖnh Béi", tbProp = {6,1,5598}, nSuccessRate = 20, nMaxSuccessRate = 20},		
		},				
	...
	[10] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Thiªn MÖnh H¹ Giíi", tbProp = {6,1,5599}, nSuccessRate = 20, nMaxSuccessRate = 20},		
		},		
...
function CheTaoThienMenh:Compose(nProductId)
	...
	self:ConsumeMaterial(%CommonMaterial_CheTaoThienMenh, 1, self.szLogTitle)			--LÊy Nguyªn LiÖu
	self:ConsumeAdditive(self.tbFormula.tbSpecialMaterial, self.szLogTitle)			--LÊy §å Phæ
	self:ConsumeAdditive(%AdditiveMaterial_CheTaoThienMenh, self.szLogTitle)				--LÊy VËt PhÈm T¨ng TØ LÖ %
...
function CheTaoThienMenh:ComposeGiveUI()
	...
	szContent = format("%s<enter>%-17s %s", szContent, "Trang BÞ Anh Hµo","1")
	szContent = format("%s<enter>%-17s %s", szContent, "§å Phæ Thiªn MÖnh","1/10%")
	szContent = format("%s<enter>%-17s %s", szContent, "Thiªn MÖnh Th¹ch","1 > 4")
	
	g_GiveItemUI(szTitle, szContent, {self.GiveUIOk, {self}}, nil, self.bAccessBindItem)
end
------------------------------------------------ChÕ T¹o Trang BÞ Thiªn MÖnh-----------------------------------------------------------
function CheTaoThienMenh:SelectParts()
local szTitle = "<color=green>Hîp Thµnh Trang BÞ Thiªn MÖnh Yªu CÇu:<color>\n"
...
szTitle = szTitle..format("<color=red>%-22s %s<color>\n", "§å Phæ Thiªn MÖnh", "1/10%")
szTitle = szTitle..format("<color=red>%-22s %s<color>\n", "Trang BÞ Anh Hµo", "1")
szTitle = szTitle..format("<color=red>%-22s %-22s %s<color>\n", "Thiªn MÖnh Th¹ch", "1/5%", "4/20%")
szTitle = szTitle..format("<color=red>%-22s %s<color>\n", "Ng©n L­îng", "50000 V¹n")
...
for i=1, getn(tbFormulaList_CheTaoThienMenh) do
	tbFormulaList_CheTaoThienMenh[i].tbProduct = tbEquip_ThienMenh[i]			--Trang BÞ Goi Ra
	tbFormulaList_CheTaoThienMenh[i].tbGoldEquip = tbEquip_AnhHao[i]			--Trang BÞ Thu Ve
	tbFormulaList_CheTaoThienMenh[i].tbGoldEquipEx = tbEquip_AnhHaoMax[i]		--Trang BÞ Max Thu Ve
	
	local p = CheTaoThienMenh:new(tbFormulaList_CheTaoThienMenh[i], "CheTaoThienMenh", INVENTORY_ROOM.room_giveitem)
	local szOpt = format("ChÕ T¹o: %s", tbFormulaList_CheTaoThienMenh[i].szName)
	tinsert(tbDialogOpt, {szOpt, p.ComposeGiveUI, {p}})
end
tinsert(tbDialogOpt, {"Hñy Bá "})
--==================================================================================================================--
--pEventType:Reg("Thî rÌn","ChÕ T¹o Trang BÞ Thiªn MÖnh", CheTaoThienMenh.SelectParts, {CheTaoThienMenh})
--==================================================================================================================--