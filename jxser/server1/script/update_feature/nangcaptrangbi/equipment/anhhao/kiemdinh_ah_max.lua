...
tbFormulaList_KiemDinhAnhHaoMax = {
	[1] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Anh Hµo H¹ng Liªn", tbProp = {6,1,5880}, nCount = 1},
		},				
		nWidth = 2,
		nHeight = 1,
	...
	{				
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Anh Hµo Kh«i", tbProp = {6,1,5881}, nCount = 1},		
		},
		nWidth = 2,
		nHeight = 2,
		nFreeItemCellLimit = 1,		
	...
	[3] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Anh Hµo Th­îng Giíi", tbProp = {6,1,5882}, nCount = 1},			
		},		
		nWidth = 1,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[4] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Anh Hµo Hé UyÓn", tbProp = {6,1,5883}, nCount = 1},			
		},		
	...
	[5] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Anh Hµo Yªu §¸i", tbProp = {6,1,5884}, nCount = 1},			
		},
		nWidth = 2,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[6] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Anh Hµo Y", tbProp = {6,1,5885}, nCount = 1},			
		},		
		nWidth = 2,
		nHeight = 3,
		nFreeItemCellLimit = 1,
	...
	[7] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Anh Hµo Vò KhÝ", tbProp = {6,1,5886}, nCount = 1},		
		},		
	...
	[8] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Anh Hµo Hµi", tbProp = {6,1,5887}, nCount = 1},		
		},			
	...
	[9] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Anh Hµo Béi", tbProp = {6,1,5888}, nCount = 1},		
		},				
	...
	[10] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "Anh Hµo B¶o R­¬ng H¹ Giíi", tbProp = {6,1,5889}, nCount = 1},		
		},		
...
function KiemDinhAnhHaoMax:Compose(nProductId)
	...
	self:ConsumeMaterial(%CommonMaterial_KiemDinhAnhHaoMax, 1, self.szLogTitle)	--LÊy Nguyªn LiÖu
...
for i=1, getn(tbFormulaList_KiemDinhAnhHaoMax) do
	...
	local szOpt = format("§æi %s", tbFormulaList_KiemDinhAnhHaoMax[i].szName)
	tinsert(tbDialogOpt, {szOpt, p.ComposeGiveUI, {p}})
end
tinsert(tbDialogOpt, {"Hñy Bá "})
--=======================================================================================================--
--pEventType:Reg("Thî rÌn", "KiÓm §Þnh B¶o R­¬ng Anh Hµo", KiemDinhAnhHaoMax.SelectParts, {KiemDinhAnhHaoMax})
--=======================================================================================================--