...
---------------------------------------------------------------------------------------------------------------
local tbDialogOpt = {}
KiemDinhBachHoMax = tbActivityCompose:new()
KiemDinhBachHoMax.bAccessBindItem = 0
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
CommonMaterial_KiemDinhBachHoMax = {
	{szName="KiÓm §Þnh Phï",tbProp={6,1,3007,1,0,0},nCount=1},
}
-------------------------------------------------------------------------------------------------
tbFormulaList_KiemDinhBachHoMax = {
	[1] = 
	{
		szName = "B¹ch Hæ H¹ng Liªn",
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng B¹ch Hæ H¹ng Liªn", tbProp = {6,1,5810}, nCount = 1},
		},				
		nWidth = 2,
		nHeight = 1,
	...
	{				
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng B¹ch Hæ Kh«i", tbProp = {6,1,5811}, nCount = 1},		
		},
		nWidth = 2,
		nHeight = 2,
		nFreeItemCellLimit = 1,		
	...
	[3] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng B¹ch Hæ Th­îng Giíi", tbProp = {6,1,5812}, nCount = 1},			
		},		
		nWidth = 1,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[4] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng B¹ch Hæ Hé UyÓn", tbProp = {6,1,5813}, nCount = 1},			
		},		
	...
	[5] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng B¹ch Hæ Yªu §¸i", tbProp = {6,1,5814}, nCount = 1},			
		},
		nWidth = 2,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[6] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng B¹ch Hæ Y", tbProp = {6,1,5815}, nCount = 1},			
		},		
		nWidth = 2,
		nHeight = 3,
		nFreeItemCellLimit = 1,
	...
	[7] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng B¹ch Hæ Vò KhÝ", tbProp = {6,1,5816}, nCount = 1},		
		},		
	...
	[8] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng B¹ch Hæ Hµi", tbProp = {6,1,5817}, nCount = 1},		
		},			
	...
	[9] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng B¹ch Hæ Béi", tbProp = {6,1,5818}, nCount = 1},		
		},				
	...
	[10] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¹ch Hæ B¶o R­¬ng H¹ Giíi", tbProp = {6,1,5819}, nCount = 1},		
		},		
...
-----------------------------------------------------------------------------------------------------------------
function KiemDinhBachHoMax:CheckItem(tbItem ,nItemIndex)
...
function KiemDinhBachHoMax:ConsumeAdditive(tbAdditive, szLogTitle)
...
function KiemDinhBachHoMax:Compose(nProductId)
	...
	if self:CheckMaterial(%CommonMaterial_KiemDinhBachHoMax, 1) ~=1 then
		Talk(1, "", szFailMsg)
		return 0;
	end

	self:ConsumeMaterial(%CommonMaterial_KiemDinhBachHoMax, 1, self.szLogTitle)	--LÊy Nguyªn LiÖu
...
-------------------------------------------------Lùa Chän Trang BÞ--------------------------------------------------------------------------------------------------
function KiemDinhBachHoMax:SelectEquip(nId, nCount)
...
function KiemDinhBachHoMax:GiveUIOk(nCount)
...
-----------------------------------------------KiÓm Tra B¶o R­¬ng-----------------------------------------------------------------------------------------
function KiemDinhBachHoMax:ComposeGiveUI()
	local szTitle = format("§æi %s", self.tbFormula.szName)
	local szContent = self:GetMaterialList(%CommonMaterial_KiemDinhBachHoMax)
...
----------------------------------§æi Trang BÞ B¹ch Hæ------------------------------------------------------
function KiemDinhBachHoMax:SelectParts()
...
for i=1, getn(tbFormulaList_KiemDinhBachHoMax) do
	tbFormulaList_KiemDinhBachHoMax[i].tbProduct = tbEquip_BachHoMax[i]
	local p = KiemDinhBachHoMax:new(tbFormulaList_KiemDinhBachHoMax[i], "KiemDinhBachHoMax", INVENTORY_ROOM.room_giveitem)
	local szOpt = format("§æi %s", tbFormulaList_KiemDinhBachHoMax[i].szName)
	tinsert(tbDialogOpt, {szOpt, p.ComposeGiveUI, {p}})
end
tinsert(tbDialogOpt, {"Hñy Bá "})
--=======================================================================================================--
--pEventType:Reg("Thî rÌn", "KiÓm §Þnh B¶o R­¬ng B¹ch Hæ", KiemDinhBachHoMax.SelectParts, {KiemDinhBachHoMax})
--=======================================================================================================--