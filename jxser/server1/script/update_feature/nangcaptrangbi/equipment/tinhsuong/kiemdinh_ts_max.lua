...
---------------------------------------------------------------------------------------------------------------
local tbDialogOpt = {}
KiemDinhTinhSuongMax = tbActivityCompose:new()
KiemDinhTinhSuongMax.bAccessBindItem = 0
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
CommonMaterial_KiemDinhTinhSuongMax = {
	{szName="KNB ",tbProp={4,1496,1,1,0,0},nCount=5},
}
-------------------------------------------------------------------------------------------------
tbFormulaList_KiemDinhTinhSuongMax = {
	[1] = 
	{
		szName = "Tinh S­¬ng H¹ng Liªn",
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Tinh S­¬ng H¹ng Liªn", tbProp = {6,1,5850}, nCount = 1},
		},				
		nWidth = 2,
		nHeight = 1,
	...
	{				
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Tinh S­¬ng Kh«i", tbProp = {6,1,5851}, nCount = 1},		
		},
		nWidth = 2,
		nHeight = 2,
		nFreeItemCellLimit = 1,		
	...
	[3] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Tinh S­¬ng Th­îng Giíi", tbProp = {6,1,5852}, nCount = 1},			
		},		
		nWidth = 1,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[4] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Tinh S­¬ng Hé UyÓn", tbProp = {6,1,5853}, nCount = 1},			
		},		
	...
	[5] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Tinh S­¬ng Yªu §¸i", tbProp = {6,1,5854}, nCount = 1},			
		},
		nWidth = 2,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[6] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Tinh S­¬ng Y", tbProp = {6,1,5855}, nCount = 1},			
		},		
		nWidth = 2,
		nHeight = 3,
		nFreeItemCellLimit = 1,
	...
	[7] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Tinh S­¬ng Vò KhÝ", tbProp = {6,1,5856}, nCount = 1},		
		},		
	...
	[8] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Tinh S­¬ng Hµi", tbProp = {6,1,5857}, nCount = 1},		
		},			
	...
	[9] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Tinh S­¬ng Béi", tbProp = {6,1,5858}, nCount = 1},		
		},				
	...
	[10] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "Tinh S­¬ng B¶o R­¬ng H¹ Giíi", tbProp = {6,1,5859}, nCount = 1},		
		},		
...
-----------------------------------------------------------------------------------------------------------------
function KiemDinhTinhSuongMax:CheckItem(tbItem ,nItemIndex)
...
function KiemDinhTinhSuongMax:ConsumeAdditive(tbAdditive, szLogTitle)
...
function KiemDinhTinhSuongMax:Compose(nProductId)
	...
	if self:CheckMaterial(%CommonMaterial_KiemDinhTinhSuongMax, 1) ~=1 then
		Talk(1, "", szFailMsg)
		return 0;
	end

	self:ConsumeMaterial(%CommonMaterial_KiemDinhTinhSuongMax, 1, self.szLogTitle)	--LÊy Nguyªn LiÖu
...
-------------------------------------------------Lùa Chän Trang BÞ--------------------------------------------------------------------------------------------------
function KiemDinhTinhSuongMax:SelectEquip(nId, nCount)
...
function KiemDinhTinhSuongMax:GiveUIOk(nCount)
...
-----------------------------------------------KiÓm Tra B¶o R­¬ng-----------------------------------------------------------------------------------------
function KiemDinhTinhSuongMax:ComposeGiveUI()
	local szTitle = format("§æi %s", self.tbFormula.szName)
	local szContent = self:GetMaterialList(%CommonMaterial_KiemDinhTinhSuongMax)
...
function KiemDinhTinhSuongMax:SelectParts()
...
for i=1, getn(tbFormulaList_KiemDinhTinhSuongMax) do
	tbFormulaList_KiemDinhTinhSuongMax[i].tbProduct = tbEquip_TinhSuongMax[i]
	local p = KiemDinhTinhSuongMax:new(tbFormulaList_KiemDinhTinhSuongMax[i], "KiemDinhTinhSuongMax", INVENTORY_ROOM.room_giveitem)
	local szOpt = format("§æi %s", tbFormulaList_KiemDinhTinhSuongMax[i].szName)
	tinsert(tbDialogOpt, {szOpt, p.ComposeGiveUI, {p}})
end
tinsert(tbDialogOpt, {"Hñy Bá "})
--=======================================================================================================--
--pEventType:Reg("Thî rÌn", "KiÓm §Þnh B¶o R­¬ng Tinh S­¬ng", KiemDinhTinhSuongMax.SelectParts, {KiemDinhTinhSuongMax})
--=======================================================================================================--