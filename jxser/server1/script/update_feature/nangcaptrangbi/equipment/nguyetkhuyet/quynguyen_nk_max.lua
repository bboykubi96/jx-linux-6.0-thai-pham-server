...
tbQuyNguyenNguyetKhuyetMaxList = {
	...
	[2]= {szName="NguyÖt KhuyÕt Kh«i",   nStone = 1, nWidth = 2, nHeight = 2, nFreeItemCellLimit = 1},
	[3]= {szName="NguyÖt KhuyÕt Th­îng Giíi ChØ", nStone = 1, nWidth = 1, nHeight = 1, nFreeItemCellLimit = 1},
	[4]= {szName="NguyÖt KhuyÕt Hé UyÓn", nStone = 1, nWidth = 1, nHeight = 2, nFreeItemCellLimit = 1},
	[5]= {szName="NguyÖt KhuyÕt Yªu §¸i", nStone = 1, nWidth = 2, nHeight = 1, nFreeItemCellLimit = 1},
	[6]= {szName="NguyÖt KhuyÕt Y Phôc",   nStone = 1, nWidth = 2, nHeight = 3, nFreeItemCellLimit = 1},
	[7]= {szName="NguyÖt KhuyÕt Vò KhÝ", nStone = 1, nWidth = 2, nHeight = 4, nFreeItemCellLimit = 1},
	[8]= {szName="NguyÖt KhuyÕt Hµi",   nStone = 1, nWidth = 2, nHeight = 2, nFreeItemCellLimit = 1},
	[9]= {szName="NguyÖt KhuyÕt Béi",   nStone = 1, nWidth = 1, nHeight = 2, nFreeItemCellLimit = 1},
	[10]={szName="NguyÖt KhuyÕt H¹ Giíi ChØ", nStone = 1, nWidth = 1, nHeight = 1, nFreeItemCellLimit = 1},
}

function tbQuyNguyenNguyetKhuyetMax:ComposeGiveUI()
	local szTitle = format("%s","Quy Nguyªn NguyÖt KhuyÕt")
...
function tbQuyNguyenNguyetKhuyetMax:Compose(nComposeCount)
	...
	if tbGoldEquip == nil then
		Say("Ng­¬i ch­a ®Æt trang bÞ NguyÖt KhuyÕt nµo vµo ®©y c¶.")
		return 0	
	end
	...
	if tbQuyNguyenNguyetKhuyetMaxList[nEquType].nWidth ~= 0 and tbQuyNguyenNguyetKhuyetMaxList[nEquType].nHeight ~= 0 and CountFreeRoomByWH(tbQuyNguyenNguyetKhuyetMaxList[nEquType].nWidth, tbQuyNguyenNguyetKhuyetMaxList[nEquType].nHeight, nFreeItemCellLimit) < nFreeItemCellLimit then
		Say(format("§Ó b¶o ®¶m tµi s¶n cña ®¹i hiÖp, xin h·y ®Ó trèng %d %dx%d hµnh trang", nFreeItemCellLimit, tbQuyNguyenNguyetKhuyetMaxList[nEquType].nWidth, tbQuyNguyenNguyetKhuyetMaxList[nEquType].nHeight))
		return 0
	end	

	local tbItem = {szName = "Ngò Linh Quy Nguyªn Phï", tbProp = {6,1,IDX_QuyNguyenPhu,1,0,0}, nCount = tbQuyNguyenNguyetKhuyetMaxList[nEquType].nStone}
...
function QuyNguyenNguyetKhuyetMax()
	local strDesc = "<color=green>Muèn Quy Nguyªn Trang BÞ NguyÖt KhuyÕt Yªu CÇu:<color>\n"
	...
	local tbMate = {
		tbMaterial = {
			{szName = "Trang bÞ NguyÖt KhuyÕt", tbProp = {0, {IDX_NguyetKhuyetMax_nStart, IDX_NguyetKhuyetMax_nEnd}}, nQuality = 1},
			{szName = "Ngò Linh Quy Nguyªn Phï", tbProp = {6,1,IDX_QuyNguyenPhu,1,0,0},nCount = 1},
		},
		tbProduct = {szName="B¶o R­¬ng NguyÖt KhuyÕt", tbProp={0, {IDX_BaoRuongNguyetKhuyetMax_Start, IDX_BaoRuongNguyetKhuyetMax_nEnd}}},
	}
