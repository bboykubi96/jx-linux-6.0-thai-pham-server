...
---------------------------------------------------------------------------------------------------------------
local tbDialogOpt = {}
KiemDinhDangLongMax = tbActivityCompose:new()
KiemDinhDangLongMax.bAccessBindItem = 0
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
CommonMaterial_KiemDinhDangLongMax = {
	{szName="KiÓm §Þnh Phï",tbProp={6,1,3007,1,0,0},nCount=1},
}
-------------------------------------------------------------------------------------------------
tbFormulaList_KiemDinhDangLongMax = {
	[1] = 
	{
		szName = "§»ng Long H¹ng Liªn",
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long H¹ng Liªn", tbProp = {6,1,5840}, nCount = 1},
		},				
		nWidth = 2,
		nHeight = 1,
	...
	{				
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long Kh«i", tbProp = {6,1,5841}, nCount = 1},		
		},
		nWidth = 2,
		nHeight = 2,
		nFreeItemCellLimit = 1,		
	...
	[3] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long Th­îng Giíi", tbProp = {6,1,5842}, nCount = 1},			
		},		
		nWidth = 1,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[4] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long Hé UyÓn", tbProp = {6,1,5843}, nCount = 1},			
		},		
	...
	[5] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long Yªu §¸i", tbProp = {6,1,5844}, nCount = 1},			
		},
		nWidth = 2,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[6] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long Y", tbProp = {6,1,5845}, nCount = 1},			
		},		
		nWidth = 2,
		nHeight = 3,
		nFreeItemCellLimit = 1,
	...
	[7] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long Vò KhÝ", tbProp = {6,1,5846}, nCount = 1},		
		},		
	...
	[8] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long Hµi", tbProp = {6,1,5847}, nCount = 1},		
		},			
	...
	[9] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long Béi", tbProp = {6,1,5848}, nCount = 1},		
		},				
	...
	[10] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§»ng Long B¶o R­¬ng H¹ Giíi", tbProp = {6,1,5849}, nCount = 1},		
		},		
...
-----------------------------------------------------------------------------------------------------------------
function KiemDinhDangLongMax:CheckItem(tbItem ,nItemIndex)
...
function KiemDinhDangLongMax:ConsumeAdditive(tbAdditive, szLogTitle)
...
function KiemDinhDangLongMax:Compose(nProductId)
	...
	if self:CheckMaterial(%CommonMaterial_KiemDinhDangLongMax, 1) ~=1 then
		Talk(1, "", szFailMsg)
		return 0;
	end

	self:ConsumeMaterial(%CommonMaterial_KiemDinhDangLongMax, 1, self.szLogTitle)	--LÊy Nguyªn LiÖu
...
-------------------------------------------------Lùa Chän Trang BÞ--------------------------------------------------------------------------------------------------
function KiemDinhDangLongMax:SelectEquip(nId, nCount)
...
function KiemDinhDangLongMax:GiveUIOk(nCount)
	...
	local szMsg = format("KiÓm §Þnh B¶o R­¬ng §»ng Long")
	local tbOpt = {
...
-----------------------------------------------KiÓm Tra B¶o R­¬ng-----------------------------------------------------------------------------------------
function KiemDinhDangLongMax:ComposeGiveUI()
	local szTitle = format("§æi %s", self.tbFormula.szName)
	local szContent = self:GetMaterialList(%CommonMaterial_KiemDinhDangLongMax)
	szContent = gsub(szContent, "<color=%w*>", "")
	szContent = gsub(szContent, "%((%d+)/(%d+)%)", "%2")
	
	szContent = format("%s<enter>%-17s %s", szContent, "B¶o R­¬ng §»ng Long","1")
	
	g_GiveItemUI(szTitle, szContent, {self.GiveUIOk, {self}}, nil, self.bAccessBindItem)
end

----------------------------------§æi Trang BÞ §»ng Long------------------------------------------------------
function KiemDinhDangLongMax:SelectParts()
local szTitle = "<color=green>Muèn KiÓm §Þnh Trang BÞ §»ng Long Yªu CÇu:<color>\n"
...
for i=1, getn(tbFormulaList_KiemDinhDangLongMax) do
	tbFormulaList_KiemDinhDangLongMax[i].tbProduct = tbEquip_DangLongMax[i]
	local p = KiemDinhDangLongMax:new(tbFormulaList_KiemDinhDangLongMax[i], "KiemDinhDangLongMax", INVENTORY_ROOM.room_giveitem)
	local szOpt = format("§æi %s", tbFormulaList_KiemDinhDangLongMax[i].szName)
	tinsert(tbDialogOpt, {szOpt, p.ComposeGiveUI, {p}})
end
tinsert(tbDialogOpt, {"Hñy Bá "})
--=======================================================================================================--
--pEventType:Reg("Thî rÌn", "KiÓm §Þnh B¶o R­¬ng §»ng Long", KiemDinhDangLongMax.SelectParts, {KiemDinhDangLongMax})
--=======================================================================================================--