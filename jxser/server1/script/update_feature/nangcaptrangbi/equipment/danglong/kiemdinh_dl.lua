...
---------------------------------------------------------------------------------------------------------------
local tbDialogOpt = {}
KiemDinhDangLong = tbActivityCompose:new()
KiemDinhDangLong.bAccessBindItem = 0
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
CommonMaterial_KiemDinhDangLong = {
	{szName="KiÓm §Þnh Phï",tbProp={6,1,3007,1,0,0},nCount=1},
}
-------------------------------------------------------------------------------------------------
tbFormulaList_KiemDinhDangLong = {
	[1] = 
	{
		szName = "§»ng Long H¹ng Liªn",
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long H¹ng Liªn", tbProp = {6,1,5690}, nCount = 1},
		},				
		nWidth = 2,
		nHeight = 1,
	...
	{				
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long Kh«i", tbProp = {6,1,5691}, nCount = 1},		
		},
		nWidth = 2,
		nHeight = 2,
		nFreeItemCellLimit = 1,		
	...
	[3] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long Th­îng Giíi", tbProp = {6,1,5692}, nCount = 1},			
		},		
		nWidth = 1,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[4] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long Hé UyÓn", tbProp = {6,1,5693}, nCount = 1},			
		},		
	...
	[5] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long Yªu §¸i", tbProp = {6,1,5694}, nCount = 1},			
		},
		nWidth = 2,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[6] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long Y", tbProp = {6,1,5695}, nCount = 1},			
		},		
		nWidth = 2,
		nHeight = 3,
		nFreeItemCellLimit = 1,
	...
	[7] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long Vò KhÝ", tbProp = {6,1,5696}, nCount = 1},		
		},		
	...
	[8] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long Hµi", tbProp = {6,1,5697}, nCount = 1},		
		},			
	...
	[9] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng §»ng Long Béi", tbProp = {6,1,5698}, nCount = 1},		
		},				
	...
	[10] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§»ng Long B¶o R­¬ng H¹ Giíi", tbProp = {6,1,5699}, nCount = 1},		
		},		
...
-----------------------------------------------------------------------------------------------------------------
function KiemDinhDangLong:CheckItem(tbItem ,nItemIndex)
...
function KiemDinhDangLong:ConsumeAdditive(tbAdditive, szLogTitle)
...
function KiemDinhDangLong:Compose(nProductId)
	...
	if self:CheckMaterial(%CommonMaterial_KiemDinhDangLong, 1) ~=1 then
		Talk(1, "", szFailMsg)
		return 0;
	end

	self:ConsumeMaterial(%CommonMaterial_KiemDinhDangLong, 1, self.szLogTitle)	--LÊy Nguyªn LiÖu
...
-------------------------------------------------Lùa Chän Trang BÞ--------------------------------------------------------------------------------------------------
function KiemDinhDangLong:SelectEquip(nId, nCount)
...
function KiemDinhDangLong:GiveUIOk(nCount)
...
-----------------------------------------------KiÓm Tra B¶o R­¬ng-----------------------------------------------------------------------------------------
function KiemDinhDangLong:ComposeGiveUI()
	local szTitle = format("§æi %s", self.tbFormula.szName)
	local szContent = self:GetMaterialList(%CommonMaterial_KiemDinhDangLong)
...
----------------------------------§æi Trang BÞ §»ng Long------------------------------------------------------
function KiemDinhDangLong:SelectParts()
...
for i=1, getn(tbFormulaList_KiemDinhDangLong) do
	tbFormulaList_KiemDinhDangLong[i].tbProduct = tbEquip_DangLong[i]
	local p = KiemDinhDangLong:new(tbFormulaList_KiemDinhDangLong[i], "KiemDinhDangLong", INVENTORY_ROOM.room_giveitem)
	local szOpt = format("§æi %s", tbFormulaList_KiemDinhDangLong[i].szName)
	tinsert(tbDialogOpt, {szOpt, p.ComposeGiveUI, {p}})
end
tinsert(tbDialogOpt, {"Hñy Bá "})
--=====================================================================================================--
--pEventType:Reg("Thî rÌn", "KiÓm §Þnh B¶o R­¬ng §»ng Long", KiemDinhDangLong.SelectParts, {KiemDinhDangLong})
--=====================================================================================================--