...
---------------------------------------------------------------------------------------------------------------
local tbDialogOpt = {}
KiemDinhXichLan = tbActivityCompose:new()
KiemDinhXichLan.bAccessBindItem = 1
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
CommonMaterial_KiemDinhXichLan = {
	{szName="KiÓm §Þnh Phï",tbProp={6,1,3007,1,0,0},nCount=1},
}
-------------------------------------------------------------------------------------------------
tbFormulaList_KiemDinhXichLan = {
	[1] = 
	{
		szName = "XÝch L©n H¹ng Liªn",
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng XÝch L©n H¹ng Liªn", tbProp = {6,1,5670}, nCount = 1},
		},				
		nWidth = 2,
		nHeight = 1,
	...
	{				
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng XÝch L©n Kh«i", tbProp = {6,1,5671}, nCount = 1},		
		},
		nWidth = 2,
		nHeight = 2,
		nFreeItemCellLimit = 1,		
	...
	[3] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng XÝch L©n Th­îng Giíi", tbProp = {6,1,5672}, nCount = 1},			
		},		
		nWidth = 1,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[4] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng XÝch L©n Hé UyÓn", tbProp = {6,1,5673}, nCount = 1},			
		},		
	...
	[5] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng XÝch L©n Yªu §¸i", tbProp = {6,1,5674}, nCount = 1},			
		},
		nWidth = 2,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[6] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng XÝch L©n Y", tbProp = {6,1,5675}, nCount = 1},			
		},		
		nWidth = 2,
		nHeight = 3,
		nFreeItemCellLimit = 1,
	...
	[7] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng XÝch L©n Vò KhÝ", tbProp = {6,1,5676}, nCount = 1},		
		},		
	...
	[8] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng XÝch L©n Hµi", tbProp = {6,1,5677}, nCount = 1},		
		},			
	...
	[9] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng XÝch L©n Béi", tbProp = {6,1,5678}, nCount = 1},		
		},				
	...
	[10] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "XÝch L©n B¶o R­¬ng H¹ Giíi", tbProp = {6,1,5679}, nCount = 1},		
		},		
...
-----------------------------------------------------------------------------------------------------------------
function KiemDinhXichLan:CheckItem(tbItem ,nItemIndex)
...
function KiemDinhXichLan:ConsumeAdditive(tbAdditive, szLogTitle)
...
function KiemDinhXichLan:Compose(nProductId)
	...
	if self:CheckMaterial(%CommonMaterial_KiemDinhXichLan, 1) ~=1 then
		Talk(1, "", szFailMsg)
		return 0;
	end

	self:ConsumeMaterial(%CommonMaterial_KiemDinhXichLan, 1, self.szLogTitle)	--LÊy Nguyªn LiÖu
...
-------------------------------------------------Lùa Chän Trang BÞ--------------------------------------------------------------------------------------------------
function KiemDinhXichLan:SelectEquip(nId, nCount)
...
function KiemDinhXichLan:GiveUIOk(nCount)
...
-----------------------------------------------KiÓm Tra B¶o R­¬ng-----------------------------------------------------------------------------------------
function KiemDinhXichLan:ComposeGiveUI()
	local szTitle = format("§æi %s", self.tbFormula.szName)
	local szContent = self:GetMaterialList(%CommonMaterial_KiemDinhXichLan)
...
function KiemDinhXichLan:SelectParts()
...
for i=1, getn(tbFormulaList_KiemDinhXichLan) do
	tbFormulaList_KiemDinhXichLan[i].tbProduct = tbEquip_XichLan[i]
	local p = KiemDinhXichLan:new(tbFormulaList_KiemDinhXichLan[i], "KiemDinhXichLan", INVENTORY_ROOM.room_giveitem)
	local szOpt = format("§æi %s", tbFormulaList_KiemDinhXichLan[i].szName)
	tinsert(tbDialogOpt, {szOpt, p.ComposeGiveUI, {p}})
end
tinsert(tbDialogOpt, {"Hñy Bá "})
--=====================================================================================================--
--pEventType:Reg("Thî rÌn", "KiÓm §Þnh B¶o R­¬ng XÝch L©n", KiemDinhXichLan.SelectParts, {KiemDinhXichLan})
--=====================================================================================================--