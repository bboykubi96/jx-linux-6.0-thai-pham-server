...
tbFormulaList_KiemDinhThienMenh = {
	[1] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Thiªn MÖnh H¹ng Liªn", tbProp = {6,1,5740}, nCount = 1},
		},				
		nWidth = 2,
		nHeight = 1,
	...
	{				
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Thiªn MÖnh Kh«i", tbProp = {6,1,5741}, nCount = 1},		
		},
		nWidth = 2,
		nHeight = 2,
		nFreeItemCellLimit = 1,		
	...
	[3] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Thiªn MÖnh Th­îng Giíi", tbProp = {6,1,5742}, nCount = 1},			
		},		
		nWidth = 1,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[4] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Thiªn MÖnh Hé UyÓn", tbProp = {6,1,5743}, nCount = 1},			
		},		
	...
	[5] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Thiªn MÖnh Yªu §¸i", tbProp = {6,1,5744}, nCount = 1},			
		},
		nWidth = 2,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[6] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Thiªn MÖnh Y", tbProp = {6,1,5745}, nCount = 1},			
		},		
		nWidth = 2,
		nHeight = 3,
		nFreeItemCellLimit = 1,
	...
	[7] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Thiªn MÖnh Vò KhÝ", tbProp = {6,1,5746}, nCount = 1},		
		},		
	...
	[8] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Thiªn MÖnh Hµi", tbProp = {6,1,5747}, nCount = 1},		
		},			
	...
	[9] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Thiªn MÖnh Béi", tbProp = {6,1,5748}, nCount = 1},		
		},				
	...
	[10] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "Thiªn MÖnh B¶o R­¬ng H¹ Giíi", tbProp = {6,1,5749}, nCount = 1},		
		},		
...
function KiemDinhThienMenh:Compose(nProductId)
	...
	self:ConsumeMaterial(%CommonMaterial_KiemDinhThienMenh, 1, self.szLogTitle)	--LÊy Nguyªn LiÖu
...
for i=1, getn(tbFormulaList_KiemDinhThienMenh) do
	...
	local szOpt = format("§æi %s", tbFormulaList_KiemDinhThienMenh[i].szName)
	tinsert(tbDialogOpt, {szOpt, p.ComposeGiveUI, {p}})
end
tinsert(tbDialogOpt, {"Hñy Bá "})
--=====================================================================================================--
--pEventType:Reg("Thî rÌn", "KiÓm §Þnh B¶o R­¬ng Thiªn MÖnh", KiemDinhThienMenh.SelectParts, {KiemDinhThienMenh})
--=====================================================================================================--