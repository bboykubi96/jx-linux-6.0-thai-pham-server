...
tbFormulaList_KiemDinhMinhPhuongMax = {
	[1] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng H¹ng Liªn", tbProp = {6,1,5830}, nCount = 1},
		},				
		nWidth = 2,
		nHeight = 1,
	...
	{				
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng Kh«i", tbProp = {6,1,5831}, nCount = 1},		
		},
		nWidth = 2,
		nHeight = 2,
		nFreeItemCellLimit = 1,		
	...
	[3] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng Th­îng Giíi", tbProp = {6,1,5832}, nCount = 1},			
		},		
		nWidth = 1,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[4] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng Hé UyÓn", tbProp = {6,1,5833}, nCount = 1},			
		},		
	...
	[5] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng Yªu §¸i", tbProp = {6,1,5834}, nCount = 1},			
		},
		nWidth = 2,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[6] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng Y", tbProp = {6,1,5835}, nCount = 1},			
		},		
		nWidth = 2,
		nHeight = 3,
		nFreeItemCellLimit = 1,
	...
	[7] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng Vò KhÝ", tbProp = {6,1,5836}, nCount = 1},		
		},		
	...
	[8] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng Hµi", tbProp = {6,1,5837}, nCount = 1},		
		},			
	...
	[9] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng Béi", tbProp = {6,1,5838}, nCount = 1},		
		},				
	...
	[10] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "Minh Ph­îng B¶o R­¬ng H¹ Giíi", tbProp = {6,1,5839}, nCount = 1},		
		},		
...
function KiemDinhMinhPhuongMax:Compose(nProductId)
	...
	self:ConsumeMaterial(%CommonMaterial_KiemDinhMinhPhuongMax, 1, self.szLogTitle)	--LÊy Nguyªn LiÖu
...
for i=1, getn(tbFormulaList_KiemDinhMinhPhuongMax) do
	...
	local szOpt = format("§æi %s", tbFormulaList_KiemDinhMinhPhuongMax[i].szName)
	tinsert(tbDialogOpt, {szOpt, p.ComposeGiveUI, {p}})
end
tinsert(tbDialogOpt, {"Hñy Bá "})
--=======================================================================================================--
--pEventType:Reg("Thî rÌn", "KiÓm §Þnh B¶o R­¬ng Minh Ph­îng", KiemDinhMinhPhuongMax.SelectParts, {KiemDinhMinhPhuongMax})
--=======================================================================================================--