...
---------------------------------------------------------------------------------------------------------------
local tbDialogOpt = {}
KiemDinhMinhPhuong = tbActivityCompose:new()
KiemDinhMinhPhuong.bAccessBindItem = 0
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
CommonMaterial_KiemDinhMinhPhuong = {
	{szName="KiÓm §Þnh Phï",tbProp={6,1,3007,1,0,0},nCount=1},
}
-------------------------------------------------------------------------------------------------
tbFormulaList_KiemDinhMinhPhuong = {
	[1] = 
	{
		szName = "Minh Ph­îng H¹ng Liªn",
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng H¹ng Liªn", tbProp = {6,1,5680}, nCount = 1},
		},				
		nWidth = 2,
		nHeight = 1,
	...
	{				
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng Kh«i", tbProp = {6,1,5681}, nCount = 1},		
		},
		nWidth = 2,
		nHeight = 2,
		nFreeItemCellLimit = 1,		
	...
	[3] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng Th­îng Giíi", tbProp = {6,1,5682}, nCount = 1},			
		},		
		nWidth = 1,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[4] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng Hé UyÓn", tbProp = {6,1,5683}, nCount = 1},			
		},		
	...
	[5] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng Yªu §¸i", tbProp = {6,1,5684}, nCount = 1},			
		},
		nWidth = 2,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[6] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng Y", tbProp = {6,1,5685}, nCount = 1},			
		},		
		nWidth = 2,
		nHeight = 3,
		nFreeItemCellLimit = 1,
	...
	[7] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng Vò KhÝ", tbProp = {6,1,5686}, nCount = 1},		
		},		
	...
	[8] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng Hµi", tbProp = {6,1,5687}, nCount = 1},		
		},			
	...
	[9] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "B¶o R­¬ng Minh Ph­îng Béi", tbProp = {6,1,5688}, nCount = 1},		
		},				
	...
	[10] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "Minh Ph­îng B¶o R­¬ng H¹ Giíi", tbProp = {6,1,5689}, nCount = 1},		
		},		
...
-----------------------------------------------------------------------------------------------------------------
function KiemDinhMinhPhuong:CheckItem(tbItem ,nItemIndex)
...
function KiemDinhMinhPhuong:ConsumeAdditive(tbAdditive, szLogTitle)
...
function KiemDinhMinhPhuong:Compose(nProductId)
	...
	if self:CheckMaterial(%CommonMaterial_KiemDinhMinhPhuong, 1) ~=1 then
		Talk(1, "", szFailMsg)
		return 0;
	end

	self:ConsumeMaterial(%CommonMaterial_KiemDinhMinhPhuong, 1, self.szLogTitle)	--LÊy Nguyªn LiÖu
...
-------------------------------------------------Lùa Chän Trang BÞ--------------------------------------------------------------------------------------------------
function KiemDinhMinhPhuong:SelectEquip(nId, nCount)
...
function KiemDinhMinhPhuong:GiveUIOk(nCount)
	...
	local szMsg = format("KiÓm §Þnh B¶o R­¬ng Minh Ph­îng")
	local tbOpt = {
...
-----------------------------------------------KiÓm Tra B¶o R­¬ng-----------------------------------------------------------------------------------------
function KiemDinhMinhPhuong:ComposeGiveUI()
	local szTitle = format("§æi %s", self.tbFormula.szName)
	local szContent = self:GetMaterialList(%CommonMaterial_KiemDinhMinhPhuong)
	szContent = gsub(szContent, "<color=%w*>", "")
	szContent = gsub(szContent, "%((%d+)/(%d+)%)", "%2")
	
	szContent = format("%s<enter>%-17s %s", szContent, "B¶o R­¬ng Minh Ph­îng","1")
	
	g_GiveItemUI(szTitle, szContent, {self.GiveUIOk, {self}}, nil, self.bAccessBindItem)
end

----------------------------------§æi Trang BÞ Minh Ph­îng------------------------------------------------------
function KiemDinhMinhPhuong:SelectParts()
local szTitle = "<color=green>Muèn KiÓm §Þnh Trang BÞ Minh Ph­îng Yªu CÇu:<color>\n"
szTitle = szTitle..format("<color=yellow>%-30s %s<color>\n", "VËt PhÈm", "Sè L­îng")
szTitle = szTitle..format("<color=red>%-30s %s<color>\n", "B¶o R­¬ng Minh Ph­îng", "1")
...
for i=1, getn(tbFormulaList_KiemDinhMinhPhuong) do
	tbFormulaList_KiemDinhMinhPhuong[i].tbProduct = tbEquip_MinhPhuong[i]
	local p = KiemDinhMinhPhuong:new(tbFormulaList_KiemDinhMinhPhuong[i], "KiemDinhMinhPhuong", INVENTORY_ROOM.room_giveitem)
	local szOpt = format("§æi %s", tbFormulaList_KiemDinhMinhPhuong[i].szName)
	tinsert(tbDialogOpt, {szOpt, p.ComposeGiveUI, {p}})
end
tinsert(tbDialogOpt, {"Hñy Bá "})
--=====================================================================================================--
--pEventType:Reg("Thî rÌn", "KiÓm §Þnh B¶o R­¬ng Minh Ph­îng", KiemDinhMinhPhuong.SelectParts, {KiemDinhMinhPhuong})
--=====================================================================================================--