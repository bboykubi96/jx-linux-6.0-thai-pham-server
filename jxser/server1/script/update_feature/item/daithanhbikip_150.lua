...
function ThieuLamQuyen_21()
	if (GetTask(TSK_DaiLucKimCangChuong) < nSkill21) then
		if (HaveMagic(DaiLucKimCangChuong) < nSkill21) then
			AddMagic(DaiLucKimCangChuong,nSkill21) SetTask(TSK_DaiLucKimCangChuong,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
			...
			Msg2Player("Kü N¨ng 150 <color=yellow>"..GetSkillName(DaiLucKimCangChuong).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill20.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThieuLamCon_21()
	if (GetTask(TSK_ViDaHienXu) < nSkill21) then
		if (HaveMagic(ViDaHienXu) < nSkill21) then
			AddMagic(ViDaHienXu,nSkill21) SetTask(TSK_ViDaHienXu,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function ThieuLamDao_21()
	if (GetTask(TSK_TamGioiQuyThien) < nSkill21) then
		if (HaveMagic(TamGioiQuyThien) < nSkill21) then
			AddMagic(TamGioiQuyThien,nSkill21) SetTask(TSK_TamGioiQuyThien,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function ThienVuongDao_21()
	if (GetTask(TSK_HaoHungTram) < nSkill21) then
		if (HaveMagic(HaoHungTram) < nSkill21) then
			AddMagic(HaoHungTram,nSkill21) SetTask(TSK_HaoHungTram,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function ThienVuongChuy_21()
	if (GetTask(TSK_TungHoanhBatPhuong) < nSkill21) then
		if (HaveMagic(TungHoanhBatPhuong) < nSkill21) then
			AddMagic(TungHoanhBatPhuong,nSkill21) SetTask(TSK_TungHoanhBatPhuong,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function ThienVuongThuong_21()
	if (GetTask(TSK_BaVuongTamKim) < nSkill21) then
		if (HaveMagic(BaVuongTamKim) < nSkill21) then
			AddMagic(BaVuongTamKim,nSkill21) SetTask(TSK_BaVuongTamKim,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function DMPhiDao_21()
	if (GetTask(TSK_VoAnhXuyen) < nSkill21) then
		if (HaveMagic(VoAnhXuyen) < nSkill21) then
			AddMagic(VoAnhXuyen,nSkill21) SetTask(TSK_VoAnhXuyen,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function DMTuTien_21()
	if (GetTask(TSK_ThietLienTuSat) < nSkill21) then
		if (HaveMagic(ThietLienTuSat) < nSkill21) then
			AddMagic(ThietLienTuSat,nSkill21) SetTask(TSK_ThietLienTuSat,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function DMTieu_21()
	if (GetTask(TSK_CanKhonNhatTrich) < nSkill21) then
		if (HaveMagic(CanKhonNhatTrich) < nSkill21) then
			AddMagic(CanKhonNhatTrich,nSkill21) SetTask(TSK_CanKhonNhatTrich,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function NguDocChuong_21()
	if (GetTask(TSK_HinhTieuCotLap) < nSkill21) then
		if (HaveMagic(HinhTieuCotLap) < nSkill21) then
			AddMagic(HinhTieuCotLap,nSkill21) SetTask(TSK_HinhTieuCotLap,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function NguDocDao_21()
	if (GetTask(TSK_UHonPheAnh) < nSkill21) then
		if (HaveMagic(UHonPheAnh) < nSkill21) then
			AddMagic(UHonPheAnh,nSkill21) SetTask(TSK_UHonPheAnh,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function NgaMyKiem_21()
	if (GetTask(TSK_KiemHoaVanTinh) < nSkill21) then
		if (HaveMagic(KiemHoaVanTinh) < nSkill21) then
			AddMagic(KiemHoaVanTinh,nSkill21) SetTask(TSK_KiemHoaVanTinh,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function NgaMyChuong_21()
	if (GetTask(TSK_BangVuLacTinh) < nSkill21) then
		if (HaveMagic(BangVuLacTinh) < nSkill21) then
			AddMagic(BangVuLacTinh,nSkill21) SetTask(TSK_BangVuLacTinh,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function ThuyYenDao_21()
	if (GetTask(TSK_BangTuocHoatKy) < nSkill21) then
		if (HaveMagic(BangTuocHoatKy) < nSkill21) then
			AddMagic(BangTuocHoatKy,nSkill21) SetTask(TSK_BangTuocHoatKy,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function ThuyYenNoi_21()
	if (GetTask(TSK_ThuyAnhManTu) < nSkill21) then
		if (HaveMagic(ThuyAnhManTu) < nSkill21) then
			AddMagic(ThuyAnhManTu,nSkill21) SetTask(TSK_ThuyAnhManTu,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function CaiBangQuyen_21()
	if (GetTask(TSK_ThoiThangLucLong) < nSkill21) then
		if (HaveMagic(ThoiThangLucLong) < nSkill21) then
			AddMagic(ThoiThangLucLong,nSkill21) SetTask(TSK_ThoiThangLucLong,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function CaiBangCon_21()
	if (GetTask(TSK_BongHuynhLuocDia) < nSkill21) then
		if (HaveMagic(BongHuynhLuocDia) < nSkill21) then
			AddMagic(BongHuynhLuocDia,nSkill21) SetTask(TSK_BongHuynhLuocDia,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function ThienNhanKich_21()
	if (GetTask(TSK_GiangHaiNoLan) < nSkill21) then
		if (HaveMagic(GiangHaiNoLan) < nSkill21) then
			AddMagic(GiangHaiNoLan,nSkill21) SetTask(TSK_GiangHaiNoLan,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function ThienNhanDao_21()
	if (GetTask(TSK_TatHoaLieuNguyen) < nSkill21) then
		if (HaveMagic(TatHoaLieuNguyen) < nSkill21) then
			AddMagic(TatHoaLieuNguyen,nSkill21) SetTask(TSK_TatHoaLieuNguyen,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function VoDangQuyen_21()
	if (GetTask(TSK_TaoHoaThaiThanh) < nSkill21) then
		if (HaveMagic(TaoHoaThaiThanh) < nSkill21) then
			AddMagic(TaoHoaThaiThanh,nSkill21) SetTask(TSK_TaoHoaThaiThanh,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function VoDangKiem_21()
	if (GetTask(TSK_KiemThuyTinhHa) < nSkill21) then
		if (HaveMagic(KiemThuyTinhHa) < nSkill21) then
			AddMagic(KiemThuyTinhHa,nSkill21) SetTask(TSK_KiemThuyTinhHa,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function ConLonDao_21()
	if (GetTask(TSK_CuuThienCuongPhong) < nSkill21) then
		if (HaveMagic(CuuThienCuongPhong) < nSkill21) then
			AddMagic(CuuThienCuongPhong,nSkill21) SetTask(TSK_CuuThienCuongPhong,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function ConLonKiem_21()
	if (GetTask(TSK_ThienLoiChanNhac) < nSkill21) then
		if (HaveMagic(ThienLoiChanNhac) < nSkill21) then
			AddMagic(ThienLoiChanNhac,nSkill21) SetTask(TSK_ThienLoiChanNhac,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function HoaSonKiem_21()
	if (GetTask(TSK_DocCoCuuKiem) < nSkill21) then
		if (HaveMagic(DocCoCuuKiem) < nSkill21) then
			AddMagic(DocCoCuuKiem,nSkill21) SetTask(TSK_DocCoCuuKiem,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function HoaSonKhi_21()
	if (GetTask(TSK_ThanQuangToanNhieu) < nSkill21) then
		if (HaveMagic(ThanQuangToanNhieu) < nSkill21) then
			AddMagic(ThanQuangToanNhieu,nSkill21) SetTask(TSK_ThanQuangToanNhieu,nSkill21) ConsumeEquiproomItem(1,6,1,4369,-1)
...
function ThieuLamQuyen_22()
	if (GetTask(TSK_DaiLucKimCangChuong) < nSkill22) then
		if (HaveMagic(DaiLucKimCangChuong) < nSkill22) then
			AddMagic(DaiLucKimCangChuong,nSkill22) SetTask(TSK_DaiLucKimCangChuong,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
...
function ThieuLamCon_22()
	if (GetTask(TSK_ViDaHienXu) < nSkill22) then
		if (HaveMagic(ViDaHienXu) < nSkill22) then
			AddMagic(ViDaHienXu,nSkill22) SetTask(TSK_ViDaHienXu,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ViDaHienXu).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThieuLamDao_22()
	if (GetTask(TSK_TamGioiQuyThien) < nSkill22) then
		if (HaveMagic(TamGioiQuyThien) < nSkill22) then
			AddMagic(TamGioiQuyThien,nSkill22) SetTask(TSK_TamGioiQuyThien,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(TamGioiQuyThien).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThienVuongDao_22()
	if (GetTask(TSK_HaoHungTram) < nSkill22) then
		if (HaveMagic(HaoHungTram) < nSkill22) then
			AddMagic(HaoHungTram,nSkill22) SetTask(TSK_HaoHungTram,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(HaoHungTram).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThienVuongChuy_22()
	if (GetTask(TSK_TungHoanhBatPhuong) < nSkill22) then
		if (HaveMagic(TungHoanhBatPhuong) < nSkill22) then
			AddMagic(TungHoanhBatPhuong,nSkill22) SetTask(TSK_TungHoanhBatPhuong,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(TungHoanhBatPhuong).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThienVuongThuong_22()
	if (GetTask(TSK_BaVuongTamKim) < nSkill22) then
		if (HaveMagic(BaVuongTamKim) < nSkill22) then
			AddMagic(BaVuongTamKim,nSkill22) SetTask(TSK_BaVuongTamKim,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(BaVuongTamKim).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function DMPhiDao_22()
	if (GetTask(TSK_VoAnhXuyen) < nSkill22) then
		if (HaveMagic(VoAnhXuyen) < nSkill22) then
			AddMagic(VoAnhXuyen,nSkill22) SetTask(TSK_VoAnhXuyen,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(VoAnhXuyen).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function DMTuTien_22()
	if (GetTask(TSK_ThietLienTuSat) < nSkill22) then
		if (HaveMagic(ThietLienTuSat) < nSkill22) then
			AddMagic(ThietLienTuSat,nSkill22) SetTask(TSK_ThietLienTuSat,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ThietLienTuSat).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function DMTieu_22()
	if (GetTask(TSK_CanKhonNhatTrich) < nSkill22) then
		if (HaveMagic(CanKhonNhatTrich) < nSkill22) then
			AddMagic(CanKhonNhatTrich,nSkill22) SetTask(TSK_CanKhonNhatTrich,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(CanKhonNhatTrich).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function NguDocChuong_22()
	if (GetTask(TSK_HinhTieuCotLap) < nSkill22) then
		if (HaveMagic(HinhTieuCotLap) < nSkill22) then
			AddMagic(HinhTieuCotLap,nSkill22) SetTask(TSK_HinhTieuCotLap,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(HinhTieuCotLap).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function NguDocDao_22()
	if (GetTask(TSK_UHonPheAnh) < nSkill22) then
		if (HaveMagic(UHonPheAnh) < nSkill22) then
			AddMagic(UHonPheAnh,nSkill22) SetTask(TSK_UHonPheAnh,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(UHonPheAnh).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function NgaMyKiem_22()
	if (GetTask(TSK_KiemHoaVanTinh) < nSkill22) then
		if (HaveMagic(KiemHoaVanTinh) < nSkill22) then
			AddMagic(KiemHoaVanTinh,nSkill22) SetTask(TSK_KiemHoaVanTinh,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(KiemHoaVanTinh).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function NgaMyChuong_22()
	if (GetTask(TSK_BangVuLacTinh) < nSkill22) then
		if (HaveMagic(BangVuLacTinh) < nSkill22) then
			AddMagic(BangVuLacTinh,nSkill22) SetTask(TSK_BangVuLacTinh,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(BangVuLacTinh).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThuyYenDao_22()
	if (GetTask(TSK_BangTuocHoatKy) < nSkill22) then
		if (HaveMagic(BangTuocHoatKy) < nSkill22) then
			AddMagic(BangTuocHoatKy,nSkill22) SetTask(TSK_BangTuocHoatKy,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(BangTuocHoatKy).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThuyYenNoi_22()
	if (GetTask(TSK_ThuyAnhManTu) < nSkill22) then
		if (HaveMagic(ThuyAnhManTu) < nSkill22) then
			AddMagic(ThuyAnhManTu,nSkill22) SetTask(TSK_ThuyAnhManTu,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ThuyAnhManTu).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function CaiBangQuyen_22()
	if (GetTask(TSK_ThoiThangLucLong) < nSkill22) then
		if (HaveMagic(ThoiThangLucLong) < nSkill22) then
			AddMagic(ThoiThangLucLong,nSkill22) SetTask(TSK_ThoiThangLucLong,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ThoiThangLucLong).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function CaiBangCon_22()
	if (GetTask(TSK_BongHuynhLuocDia) < nSkill22) then
		if (HaveMagic(BongHuynhLuocDia) < nSkill22) then
			AddMagic(BongHuynhLuocDia,nSkill22) SetTask(TSK_BongHuynhLuocDia,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(BongHuynhLuocDia).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThienNhanKich_22()
	if (GetTask(TSK_GiangHaiNoLan) < nSkill22) then
		if (HaveMagic(GiangHaiNoLan) < nSkill22) then
			AddMagic(GiangHaiNoLan,nSkill22) SetTask(TSK_GiangHaiNoLan,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(GiangHaiNoLan).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThienNhanDao_22()
	if (GetTask(TSK_TatHoaLieuNguyen) < nSkill22) then
		if (HaveMagic(TatHoaLieuNguyen) < nSkill22) then
			AddMagic(TatHoaLieuNguyen,nSkill22) SetTask(TSK_TatHoaLieuNguyen,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(TatHoaLieuNguyen).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function VoDangQuyen_22()
	if (GetTask(TSK_TaoHoaThaiThanh) < nSkill22) then
		if (HaveMagic(TaoHoaThaiThanh) < nSkill22) then
			AddMagic(TaoHoaThaiThanh,nSkill22) SetTask(TSK_TaoHoaThaiThanh,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(TaoHoaThaiThanh).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function VoDangKiem_22()
	if (GetTask(TSK_KiemThuyTinhHa) < nSkill22) then
		if (HaveMagic(KiemThuyTinhHa) < nSkill22) then
			AddMagic(KiemThuyTinhHa,nSkill22) SetTask(TSK_KiemThuyTinhHa,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(KiemThuyTinhHa).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ConLonDao_22()
	if (GetTask(TSK_CuuThienCuongPhong) < nSkill22) then
		if (HaveMagic(CuuThienCuongPhong) < nSkill22) then
			AddMagic(CuuThienCuongPhong,nSkill22) SetTask(TSK_CuuThienCuongPhong,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(CuuThienCuongPhong).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ConLonKiem_22()
	if (GetTask(TSK_ThienLoiChanNhac) < nSkill22) then
		if (HaveMagic(ThienLoiChanNhac) < nSkill22) then
			AddMagic(ThienLoiChanNhac,nSkill22) SetTask(TSK_ThienLoiChanNhac,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ThienLoiChanNhac).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function HoaSonKiem_22()
	if (GetTask(TSK_DocCoCuuKiem) < nSkill22) then
		if (HaveMagic(DocCoCuuKiem) < nSkill22) then
			AddMagic(DocCoCuuKiem,nSkill22) SetTask(TSK_DocCoCuuKiem,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(DocCoCuuKiem).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function HoaSonKhi_22()
	if (GetTask(TSK_ThanQuangToanNhieu) < nSkill22) then
		if (HaveMagic(ThanQuangToanNhieu) < nSkill22) then
			AddMagic(ThanQuangToanNhieu,nSkill22) SetTask(TSK_ThanQuangToanNhieu,nSkill22) ConsumeEquiproomItem(1,6,1,4370,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ThanQuangToanNhieu).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill21.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThieuLamQuyen_23()
	if (GetTask(TSK_DaiLucKimCangChuong) < nSkill23) then
		if (HaveMagic(DaiLucKimCangChuong) < nSkill23) then
			AddMagic(DaiLucKimCangChuong,nSkill23) SetTask(TSK_DaiLucKimCangChuong,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function ThieuLamCon_23()
	if (GetTask(TSK_ViDaHienXu) < nSkill23) then
		if (HaveMagic(ViDaHienXu) < nSkill23) then
			AddMagic(ViDaHienXu,nSkill23) SetTask(TSK_ViDaHienXu,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function ThieuLamDao_23()
	if (GetTask(TSK_TamGioiQuyThien) < nSkill23) then
		if (HaveMagic(TamGioiQuyThien) < nSkill23) then
			AddMagic(TamGioiQuyThien,nSkill23) SetTask(TSK_TamGioiQuyThien,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function ThienVuongDao_23()
	if (GetTask(TSK_HaoHungTram) < nSkill23) then
		if (HaveMagic(HaoHungTram) < nSkill23) then
			AddMagic(HaoHungTram,nSkill23) SetTask(TSK_HaoHungTram,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function ThienVuongChuy_23()
	if (GetTask(TSK_TungHoanhBatPhuong) < nSkill23) then
		if (HaveMagic(TungHoanhBatPhuong) < nSkill23) then
			AddMagic(TungHoanhBatPhuong,nSkill23) SetTask(TSK_TungHoanhBatPhuong,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function ThienVuongThuong_23()
	if (GetTask(TSK_BaVuongTamKim) < nSkill23) then
		if (HaveMagic(BaVuongTamKim) < nSkill23) then
			AddMagic(BaVuongTamKim,nSkill23) SetTask(TSK_BaVuongTamKim,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function DMPhiDao_23()
	if (GetTask(TSK_VoAnhXuyen) < nSkill23) then
		if (HaveMagic(VoAnhXuyen) < nSkill23) then
			AddMagic(VoAnhXuyen,nSkill23) SetTask(TSK_VoAnhXuyen,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function DMTuTien_23()
	if (GetTask(TSK_ThietLienTuSat) < nSkill23) then
		if (HaveMagic(ThietLienTuSat) < nSkill23) then
			AddMagic(ThietLienTuSat,nSkill23) SetTask(TSK_ThietLienTuSat,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function DMTieu_23()
	if (GetTask(TSK_CanKhonNhatTrich) < nSkill23) then
		if (HaveMagic(CanKhonNhatTrich) < nSkill23) then
			AddMagic(CanKhonNhatTrich,nSkill23) SetTask(TSK_CanKhonNhatTrich,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function NguDocChuong_23()
	if (GetTask(TSK_HinhTieuCotLap) < nSkill23) then
		if (HaveMagic(HinhTieuCotLap) < nSkill23) then
			AddMagic(HinhTieuCotLap,nSkill23) SetTask(TSK_HinhTieuCotLap,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function NguDocDao_23()
	if (GetTask(TSK_UHonPheAnh) < nSkill23) then
		if (HaveMagic(UHonPheAnh) < nSkill23) then
			AddMagic(UHonPheAnh,nSkill23) SetTask(TSK_UHonPheAnh,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function NgaMyKiem_23()
	if (GetTask(TSK_KiemHoaVanTinh) < nSkill23) then
		if (HaveMagic(KiemHoaVanTinh) < nSkill23) then
			AddMagic(KiemHoaVanTinh,nSkill23) SetTask(TSK_KiemHoaVanTinh,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function NgaMyChuong_23()
	if (GetTask(TSK_BangVuLacTinh) < nSkill23) then
		if (HaveMagic(BangVuLacTinh) < nSkill23) then
			AddMagic(BangVuLacTinh,nSkill23) SetTask(TSK_BangVuLacTinh,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function ThuyYenDao_23()
	if (GetTask(TSK_BangTuocHoatKy) < nSkill23) then
		if (HaveMagic(BangTuocHoatKy) < nSkill23) then
			AddMagic(BangTuocHoatKy,nSkill23) SetTask(TSK_BangTuocHoatKy,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function ThuyYenNoi_23()
	if (GetTask(TSK_ThuyAnhManTu) < nSkill23) then
		if (HaveMagic(ThuyAnhManTu) < nSkill23) then
			AddMagic(ThuyAnhManTu,nSkill23) SetTask(TSK_ThuyAnhManTu,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function CaiBangQuyen_23()
	if (GetTask(TSK_ThoiThangLucLong) < nSkill23) then
		if (HaveMagic(ThoiThangLucLong) < nSkill23) then
			AddMagic(ThoiThangLucLong,nSkill23) SetTask(TSK_ThoiThangLucLong,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function CaiBangCon_23()
	if (GetTask(TSK_BongHuynhLuocDia) < nSkill23) then
		if (HaveMagic(BongHuynhLuocDia) < nSkill23) then
			AddMagic(BongHuynhLuocDia,nSkill23) SetTask(TSK_BongHuynhLuocDia,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function ThienNhanKich_23()
	if (GetTask(TSK_GiangHaiNoLan) < nSkill23) then
		if (HaveMagic(GiangHaiNoLan) < nSkill23) then
			AddMagic(GiangHaiNoLan,nSkill23) SetTask(TSK_GiangHaiNoLan,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function ThienNhanDao_23()
	if (GetTask(TSK_TatHoaLieuNguyen) < nSkill23) then
		if (HaveMagic(TatHoaLieuNguyen) < nSkill23) then
			AddMagic(TatHoaLieuNguyen,nSkill23) SetTask(TSK_TatHoaLieuNguyen,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function VoDangQuyen_23()
	if (GetTask(TSK_TaoHoaThaiThanh) < nSkill23) then
		if (HaveMagic(TaoHoaThaiThanh) < nSkill23) then
			AddMagic(TaoHoaThaiThanh,nSkill23) SetTask(TSK_TaoHoaThaiThanh,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function VoDangKiem_23()
	if (GetTask(TSK_KiemThuyTinhHa) < nSkill23) then
		if (HaveMagic(KiemThuyTinhHa) < nSkill23) then
			AddMagic(KiemThuyTinhHa,nSkill23) SetTask(TSK_KiemThuyTinhHa,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function ConLonDao_23()
	if (GetTask(TSK_CuuThienCuongPhong) < nSkill23) then
		if (HaveMagic(CuuThienCuongPhong) < nSkill23) then
			AddMagic(CuuThienCuongPhong,nSkill23) SetTask(TSK_CuuThienCuongPhong,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function ConLonKiem_23()
	if (GetTask(TSK_ThienLoiChanNhac) < nSkill23) then
		if (HaveMagic(ThienLoiChanNhac) < nSkill23) then
			AddMagic(ThienLoiChanNhac,nSkill23) SetTask(TSK_ThienLoiChanNhac,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function HoaSonKiem_23()
	if (GetTask(TSK_DocCoCuuKiem) < nSkill23) then
		if (HaveMagic(DocCoCuuKiem) < nSkill23) then
			AddMagic(DocCoCuuKiem,nSkill23) SetTask(TSK_DocCoCuuKiem,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function HoaSonKhi_23()
	if (GetTask(TSK_ThanQuangToanNhieu) < nSkill23) then
		if (HaveMagic(ThanQuangToanNhieu) < nSkill23) then
			AddMagic(ThanQuangToanNhieu,nSkill23) SetTask(TSK_ThanQuangToanNhieu,nSkill23) ConsumeEquiproomItem(1,6,1,4371,-1)
...
function ThieuLamQuyen_24()
	if (GetTask(TSK_DaiLucKimCangChuong) < nSkill24) then
		if (HaveMagic(DaiLucKimCangChuong) < nSkill24) then
			AddMagic(DaiLucKimCangChuong,nSkill24) SetTask(TSK_DaiLucKimCangChuong,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function ThieuLamCon_24()
	if (GetTask(TSK_ViDaHienXu) < nSkill24) then
		if (HaveMagic(ViDaHienXu) < nSkill24) then
			AddMagic(ViDaHienXu,nSkill24) SetTask(TSK_ViDaHienXu,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function ThieuLamDao_24()
	if (GetTask(TSK_TamGioiQuyThien) < nSkill24) then
		if (HaveMagic(TamGioiQuyThien) < nSkill24) then
			AddMagic(TamGioiQuyThien,nSkill24) SetTask(TSK_TamGioiQuyThien,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function ThienVuongDao_24()
	if (GetTask(TSK_HaoHungTram) < nSkill24) then
		if (HaveMagic(HaoHungTram) < nSkill24) then
			AddMagic(HaoHungTram,nSkill24) SetTask(TSK_HaoHungTram,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function ThienVuongChuy_24()
	if (GetTask(TSK_TungHoanhBatPhuong) < nSkill24) then
		if (HaveMagic(TungHoanhBatPhuong) < nSkill24) then
			AddMagic(TungHoanhBatPhuong,nSkill24) SetTask(TSK_TungHoanhBatPhuong,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function ThienVuongThuong_24()
	if (GetTask(TSK_BaVuongTamKim) < nSkill24) then
		if (HaveMagic(BaVuongTamKim) < nSkill24) then
			AddMagic(BaVuongTamKim,nSkill24) SetTask(TSK_BaVuongTamKim,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function DMPhiDao_24()
	if (GetTask(TSK_VoAnhXuyen) < nSkill24) then
		if (HaveMagic(VoAnhXuyen) < nSkill24) then
			AddMagic(VoAnhXuyen,nSkill24) SetTask(TSK_VoAnhXuyen,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function DMTuTien_24()
	if (GetTask(TSK_ThietLienTuSat) < nSkill24) then
		if (HaveMagic(ThietLienTuSat) < nSkill24) then
			AddMagic(ThietLienTuSat,nSkill24) SetTask(TSK_ThietLienTuSat,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function DMTieu_24()
	if (GetTask(TSK_CanKhonNhatTrich) < nSkill24) then
		if (HaveMagic(CanKhonNhatTrich) < nSkill24) then
			AddMagic(CanKhonNhatTrich,nSkill24) SetTask(TSK_CanKhonNhatTrich,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function NguDocChuong_24()
	if (GetTask(TSK_HinhTieuCotLap) < nSkill24) then
		if (HaveMagic(HinhTieuCotLap) < nSkill24) then
			AddMagic(HinhTieuCotLap,nSkill24) SetTask(TSK_HinhTieuCotLap,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function NguDocDao_24()
	if (GetTask(TSK_UHonPheAnh) < nSkill24) then
		if (HaveMagic(UHonPheAnh) < nSkill24) then
			AddMagic(UHonPheAnh,nSkill24) SetTask(TSK_UHonPheAnh,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function NgaMyKiem_24()
	if (GetTask(TSK_KiemHoaVanTinh) < nSkill24) then
		if (HaveMagic(KiemHoaVanTinh) < nSkill24) then
			AddMagic(KiemHoaVanTinh,nSkill24) SetTask(TSK_KiemHoaVanTinh,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function NgaMyChuong_24()
	if (GetTask(TSK_BangVuLacTinh) < nSkill24) then
		if (HaveMagic(BangVuLacTinh) < nSkill24) then
			AddMagic(BangVuLacTinh,nSkill24) SetTask(TSK_BangVuLacTinh,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function ThuyYenDao_24()
	if (GetTask(TSK_BangTuocHoatKy) < nSkill24) then
		if (HaveMagic(BangTuocHoatKy) < nSkill24) then
			AddMagic(BangTuocHoatKy,nSkill24) SetTask(TSK_BangTuocHoatKy,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function ThuyYenNoi_24()
	if (GetTask(TSK_ThuyAnhManTu) < nSkill24) then
		if (HaveMagic(ThuyAnhManTu) < nSkill24) then
			AddMagic(ThuyAnhManTu,nSkill24) SetTask(TSK_ThuyAnhManTu,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function CaiBangQuyen_24()
	if (GetTask(TSK_ThoiThangLucLong) < nSkill24) then
		if (HaveMagic(ThoiThangLucLong) < nSkill24) then
			AddMagic(ThoiThangLucLong,nSkill24) SetTask(TSK_ThoiThangLucLong,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function CaiBangCon_24()
	if (GetTask(TSK_BongHuynhLuocDia) < nSkill24) then
		if (HaveMagic(BongHuynhLuocDia) < nSkill24) then
			AddMagic(BongHuynhLuocDia,nSkill24) SetTask(TSK_BongHuynhLuocDia,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function ThienNhanKich_24()
	if (GetTask(TSK_GiangHaiNoLan) < nSkill24) then
		if (HaveMagic(GiangHaiNoLan) < nSkill24) then
			AddMagic(GiangHaiNoLan,nSkill24) SetTask(TSK_GiangHaiNoLan,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function ThienNhanDao_24()
	if (GetTask(TSK_TatHoaLieuNguyen) < nSkill24) then
		if (HaveMagic(TatHoaLieuNguyen) < nSkill24) then
			AddMagic(TatHoaLieuNguyen,nSkill24) SetTask(TSK_TatHoaLieuNguyen,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function VoDangQuyen_24()
	if (GetTask(TSK_TaoHoaThaiThanh) < nSkill24) then
		if (HaveMagic(TaoHoaThaiThanh) < nSkill24) then
			AddMagic(TaoHoaThaiThanh,nSkill24) SetTask(TSK_TaoHoaThaiThanh,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function VoDangKiem_24()
	if (GetTask(TSK_KiemThuyTinhHa) < nSkill24) then
		if (HaveMagic(KiemThuyTinhHa) < nSkill24) then
			AddMagic(KiemThuyTinhHa,nSkill24) SetTask(TSK_KiemThuyTinhHa,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function ConLonDao_24()
	if (GetTask(TSK_CuuThienCuongPhong) < nSkill24) then
		if (HaveMagic(CuuThienCuongPhong) < nSkill24) then
			AddMagic(CuuThienCuongPhong,nSkill24) SetTask(TSK_CuuThienCuongPhong,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function ConLonKiem_24()
	if (GetTask(TSK_ThienLoiChanNhac) < nSkill24) then
		if (HaveMagic(ThienLoiChanNhac) < nSkill24) then
			AddMagic(ThienLoiChanNhac,nSkill24) SetTask(TSK_ThienLoiChanNhac,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function HoaSonKiem_24()
	if (GetTask(TSK_DocCoCuuKiem) < nSkill24) then
		if (HaveMagic(DocCoCuuKiem) < nSkill24) then
			AddMagic(DocCoCuuKiem,nSkill24) SetTask(TSK_DocCoCuuKiem,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function HoaSonKhi_24()
	if (GetTask(TSK_ThanQuangToanNhieu) < nSkill24) then
		if (HaveMagic(ThanQuangToanNhieu) < nSkill24) then
			AddMagic(ThanQuangToanNhieu,nSkill24) SetTask(TSK_ThanQuangToanNhieu,nSkill24) ConsumeEquiproomItem(1,6,1,4372,-1)
...
function ThieuLamQuyen_25()
	if (GetTask(TSK_DaiLucKimCangChuong) < nSkill25) then
		if (HaveMagic(DaiLucKimCangChuong) < nSkill25) then
			AddMagic(DaiLucKimCangChuong,nSkill25) SetTask(TSK_DaiLucKimCangChuong,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function ThieuLamCon_25()
	if (GetTask(TSK_ViDaHienXu) < nSkill25) then
		if (HaveMagic(ViDaHienXu) < nSkill25) then
			AddMagic(ViDaHienXu,nSkill25) SetTask(TSK_ViDaHienXu,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function ThieuLamDao_25()
	if (GetTask(TSK_TamGioiQuyThien) < nSkill25) then
		if (HaveMagic(TamGioiQuyThien) < nSkill25) then
			AddMagic(TamGioiQuyThien,nSkill25) SetTask(TSK_TamGioiQuyThien,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function ThienVuongDao_25()
	if (GetTask(TSK_HaoHungTram) < nSkill25) then
		if (HaveMagic(HaoHungTram) < nSkill25) then
			AddMagic(HaoHungTram,nSkill25) SetTask(TSK_HaoHungTram,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function ThienVuongChuy_25()
	if (GetTask(TSK_TungHoanhBatPhuong) < nSkill25) then
		if (HaveMagic(TungHoanhBatPhuong) < nSkill25) then
			AddMagic(TungHoanhBatPhuong,nSkill25) SetTask(TSK_TungHoanhBatPhuong,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function ThienVuongThuong_25()
	if (GetTask(TSK_BaVuongTamKim) < nSkill25) then
		if (HaveMagic(BaVuongTamKim) < nSkill25) then
			AddMagic(BaVuongTamKim,nSkill25) SetTask(TSK_BaVuongTamKim,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function DMPhiDao_25()
	if (GetTask(TSK_VoAnhXuyen) < nSkill25) then
		if (HaveMagic(VoAnhXuyen) < nSkill25) then
			AddMagic(VoAnhXuyen,nSkill25) SetTask(TSK_VoAnhXuyen,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function DMTuTien_25()
	if (GetTask(TSK_ThietLienTuSat) < nSkill25) then
		if (HaveMagic(ThietLienTuSat) < nSkill25) then
			AddMagic(ThietLienTuSat,nSkill25) SetTask(TSK_ThietLienTuSat,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function DMTieu_25()
	if (GetTask(TSK_CanKhonNhatTrich) < nSkill25) then
		if (HaveMagic(CanKhonNhatTrich) < nSkill25) then
			AddMagic(CanKhonNhatTrich,nSkill25) SetTask(TSK_CanKhonNhatTrich,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function NguDocChuong_25()
	if (GetTask(TSK_HinhTieuCotLap) < nSkill25) then
		if (HaveMagic(HinhTieuCotLap) < nSkill25) then
			AddMagic(HinhTieuCotLap,nSkill25) SetTask(TSK_HinhTieuCotLap,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function NguDocDao_25()
	if (GetTask(TSK_UHonPheAnh) < nSkill25) then
		if (HaveMagic(UHonPheAnh) < nSkill25) then
			AddMagic(UHonPheAnh,nSkill25) SetTask(TSK_UHonPheAnh,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function NgaMyKiem_25()
	if (GetTask(TSK_KiemHoaVanTinh) < nSkill25) then
		if (HaveMagic(KiemHoaVanTinh) < nSkill25) then
			AddMagic(KiemHoaVanTinh,nSkill25) SetTask(TSK_KiemHoaVanTinh,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function NgaMyChuong_25()
	if (GetTask(TSK_BangVuLacTinh) < nSkill25) then
		if (HaveMagic(BangVuLacTinh) < nSkill25) then
			AddMagic(BangVuLacTinh,nSkill25) SetTask(TSK_BangVuLacTinh,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function ThuyYenDao_25()
	if (GetTask(TSK_BangTuocHoatKy) < nSkill25) then
		if (HaveMagic(BangTuocHoatKy) < nSkill25) then
			AddMagic(BangTuocHoatKy,nSkill25) SetTask(TSK_BangTuocHoatKy,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function ThuyYenNoi_25()
	if (GetTask(TSK_ThuyAnhManTu) < nSkill25) then
		if (HaveMagic(ThuyAnhManTu) < nSkill25) then
			AddMagic(ThuyAnhManTu,nSkill25) SetTask(TSK_ThuyAnhManTu,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function CaiBangQuyen_25()
	if (GetTask(TSK_ThoiThangLucLong) < nSkill25) then
		if (HaveMagic(ThoiThangLucLong) < nSkill25) then
			AddMagic(ThoiThangLucLong,nSkill25) SetTask(TSK_ThoiThangLucLong,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function CaiBangCon_25()
	if (GetTask(TSK_BongHuynhLuocDia) < nSkill25) then
		if (HaveMagic(BongHuynhLuocDia) < nSkill25) then
			AddMagic(BongHuynhLuocDia,nSkill25) SetTask(TSK_BongHuynhLuocDia,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function ThienNhanKich_25()
	if (GetTask(TSK_GiangHaiNoLan) < nSkill25) then
		if (HaveMagic(GiangHaiNoLan) < nSkill25) then
			AddMagic(GiangHaiNoLan,nSkill25) SetTask(TSK_GiangHaiNoLan,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function ThienNhanDao_25()
	if (GetTask(TSK_TatHoaLieuNguyen) < nSkill25) then
		if (HaveMagic(TatHoaLieuNguyen) < nSkill25) then
			AddMagic(TatHoaLieuNguyen,nSkill25) SetTask(TSK_TatHoaLieuNguyen,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function VoDangQuyen_25()
	if (GetTask(TSK_TaoHoaThaiThanh) < nSkill25) then
		if (HaveMagic(TaoHoaThaiThanh) < nSkill25) then
			AddMagic(TaoHoaThaiThanh,nSkill25) SetTask(TSK_TaoHoaThaiThanh,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function VoDangKiem_25()
	if (GetTask(TSK_KiemThuyTinhHa) < nSkill25) then
		if (HaveMagic(KiemThuyTinhHa) < nSkill25) then
			AddMagic(KiemThuyTinhHa,nSkill25) SetTask(TSK_KiemThuyTinhHa,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function ConLonDao_25()
	if (GetTask(TSK_CuuThienCuongPhong) < nSkill25) then
		if (HaveMagic(CuuThienCuongPhong) < nSkill25) then
			AddMagic(CuuThienCuongPhong,nSkill25) SetTask(TSK_CuuThienCuongPhong,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function ConLonKiem_25()
	if (GetTask(TSK_ThienLoiChanNhac) < nSkill25) then
		if (HaveMagic(ThienLoiChanNhac) < nSkill25) then
			AddMagic(ThienLoiChanNhac,nSkill25) SetTask(TSK_ThienLoiChanNhac,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function HoaSonKiem_25()
	if (GetTask(TSK_DocCoCuuKiem) < nSkill25) then
		if (HaveMagic(DocCoCuuKiem) < nSkill25) then
			AddMagic(DocCoCuuKiem,nSkill25) SetTask(TSK_DocCoCuuKiem,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function HoaSonKhi_25()
	if (GetTask(TSK_ThanQuangToanNhieu) < nSkill25) then
		if (HaveMagic(ThanQuangToanNhieu) < nSkill25) then
			AddMagic(ThanQuangToanNhieu,nSkill25) SetTask(TSK_ThanQuangToanNhieu,nSkill25) ConsumeEquiproomItem(1,6,1,4373,-1)
...
function ThieuLamQuyen_26()
	if (GetTask(TSK_DaiLucKimCangChuong) < nSkill26) then
		if (HaveMagic(DaiLucKimCangChuong) < nSkill26) then
			AddMagic(DaiLucKimCangChuong,nSkill26) SetTask(TSK_DaiLucKimCangChuong,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
...
function ThieuLamCon_26()
	if (GetTask(TSK_ViDaHienXu) < nSkill26) then
		if (HaveMagic(ViDaHienXu) < nSkill26) then
			AddMagic(ViDaHienXu,nSkill26) SetTask(TSK_ViDaHienXu,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ViDaHienXu).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThieuLamDao_26()
	if (GetTask(TSK_TamGioiQuyThien) < nSkill26) then
		if (HaveMagic(TamGioiQuyThien) < nSkill26) then
			AddMagic(TamGioiQuyThien,nSkill26) SetTask(TSK_TamGioiQuyThien,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(TamGioiQuyThien).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThienVuongDao_26()
	if (GetTask(TSK_HaoHungTram) < nSkill26) then
		if (HaveMagic(HaoHungTram) < nSkill26) then
			AddMagic(HaoHungTram,nSkill26) SetTask(TSK_HaoHungTram,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(HaoHungTram).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThienVuongChuy_26()
	if (GetTask(TSK_TungHoanhBatPhuong) < nSkill26) then
		if (HaveMagic(TungHoanhBatPhuong) < nSkill26) then
			AddMagic(TungHoanhBatPhuong,nSkill26) SetTask(TSK_TungHoanhBatPhuong,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(TungHoanhBatPhuong).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThienVuongThuong_26()
	if (GetTask(TSK_BaVuongTamKim) < nSkill26) then
		if (HaveMagic(BaVuongTamKim) < nSkill26) then
			AddMagic(BaVuongTamKim,nSkill26) SetTask(TSK_BaVuongTamKim,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(BaVuongTamKim).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function DMPhiDao_26()
	if (GetTask(TSK_VoAnhXuyen) < nSkill26) then
		if (HaveMagic(VoAnhXuyen) < nSkill26) then
			AddMagic(VoAnhXuyen,nSkill26) SetTask(TSK_VoAnhXuyen,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(VoAnhXuyen).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function DMTuTien_26()
	if (GetTask(TSK_ThietLienTuSat) < nSkill26) then
		if (HaveMagic(ThietLienTuSat) < nSkill26) then
			AddMagic(ThietLienTuSat,nSkill26) SetTask(TSK_ThietLienTuSat,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ThietLienTuSat).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function DMTieu_26()
	if (GetTask(TSK_CanKhonNhatTrich) < nSkill26) then
		if (HaveMagic(CanKhonNhatTrich) < nSkill26) then
			AddMagic(CanKhonNhatTrich,nSkill26) SetTask(TSK_CanKhonNhatTrich,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(CanKhonNhatTrich).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function NguDocChuong_26()
	if (GetTask(TSK_HinhTieuCotLap) < nSkill26) then
		if (HaveMagic(HinhTieuCotLap) < nSkill26) then
			AddMagic(HinhTieuCotLap,nSkill26) SetTask(TSK_HinhTieuCotLap,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(HinhTieuCotLap).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function NguDocDao_26()
	if (GetTask(TSK_UHonPheAnh) < nSkill26) then
		if (HaveMagic(UHonPheAnh) < nSkill26) then
			AddMagic(UHonPheAnh,nSkill26) SetTask(TSK_UHonPheAnh,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(UHonPheAnh).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function NgaMyKiem_26()
	if (GetTask(TSK_KiemHoaVanTinh) < nSkill26) then
		if (HaveMagic(KiemHoaVanTinh) < nSkill26) then
			AddMagic(KiemHoaVanTinh,nSkill26) SetTask(TSK_KiemHoaVanTinh,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(KiemHoaVanTinh).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function NgaMyChuong_26()
	if (GetTask(TSK_BangVuLacTinh) < nSkill26) then
		if (HaveMagic(BangVuLacTinh) < nSkill26) then
			AddMagic(BangVuLacTinh,nSkill26) SetTask(TSK_BangVuLacTinh,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(BangVuLacTinh).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThuyYenDao_26()
	if (GetTask(TSK_BangTuocHoatKy) < nSkill26) then
		if (HaveMagic(BangTuocHoatKy) < nSkill26) then
			AddMagic(BangTuocHoatKy,nSkill26) SetTask(TSK_BangTuocHoatKy,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(BangTuocHoatKy).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThuyYenNoi_26()
	if (GetTask(TSK_ThuyAnhManTu) < nSkill26) then
		if (HaveMagic(ThuyAnhManTu) < nSkill26) then
			AddMagic(ThuyAnhManTu,nSkill26) SetTask(TSK_ThuyAnhManTu,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ThuyAnhManTu).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function CaiBangQuyen_26()
	if (GetTask(TSK_ThoiThangLucLong) < nSkill26) then
		if (HaveMagic(ThoiThangLucLong) < nSkill26) then
			AddMagic(ThoiThangLucLong,nSkill26) SetTask(TSK_ThoiThangLucLong,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ThoiThangLucLong).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function CaiBangCon_26()
	if (GetTask(TSK_BongHuynhLuocDia) < nSkill26) then
		if (HaveMagic(BongHuynhLuocDia) < nSkill26) then
			AddMagic(BongHuynhLuocDia,nSkill26) SetTask(TSK_BongHuynhLuocDia,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(BongHuynhLuocDia).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThienNhanKich_26()
	if (GetTask(TSK_GiangHaiNoLan) < nSkill26) then
		if (HaveMagic(GiangHaiNoLan) < nSkill26) then
			AddMagic(GiangHaiNoLan,nSkill26) SetTask(TSK_GiangHaiNoLan,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(GiangHaiNoLan).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThienNhanDao_26()
	if (GetTask(TSK_TatHoaLieuNguyen) < nSkill26) then
		if (HaveMagic(TatHoaLieuNguyen) < nSkill26) then
			AddMagic(TatHoaLieuNguyen,nSkill26) SetTask(TSK_TatHoaLieuNguyen,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(TatHoaLieuNguyen).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function VoDangQuyen_26()
	if (GetTask(TSK_TaoHoaThaiThanh) < nSkill26) then
		if (HaveMagic(TaoHoaThaiThanh) < nSkill26) then
			AddMagic(TaoHoaThaiThanh,nSkill26) SetTask(TSK_TaoHoaThaiThanh,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(TaoHoaThaiThanh).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function VoDangKiem_26()
	if (GetTask(TSK_KiemThuyTinhHa) < nSkill26) then
		if (HaveMagic(KiemThuyTinhHa) < nSkill26) then
			AddMagic(KiemThuyTinhHa,nSkill26) SetTask(TSK_KiemThuyTinhHa,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(KiemThuyTinhHa).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ConLonDao_26()
	if (GetTask(TSK_CuuThienCuongPhong) < nSkill26) then
		if (HaveMagic(CuuThienCuongPhong) < nSkill26) then
			AddMagic(CuuThienCuongPhong,nSkill26) SetTask(TSK_CuuThienCuongPhong,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(CuuThienCuongPhong).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ConLonKiem_26()
	if (GetTask(TSK_ThienLoiChanNhac) < nSkill26) then
		if (HaveMagic(ThienLoiChanNhac) < nSkill26) then
			AddMagic(ThienLoiChanNhac,nSkill26) SetTask(TSK_ThienLoiChanNhac,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ThienLoiChanNhac).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function HoaSonKiem_26()
	if (GetTask(TSK_DocCoCuuKiem) < nSkill26) then
		if (HaveMagic(DocCoCuuKiem) < nSkill26) then
			AddMagic(DocCoCuuKiem,nSkill26) SetTask(TSK_DocCoCuuKiem,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(DocCoCuuKiem).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function HoaSonKhi_26()
	if (GetTask(TSK_ThanQuangToanNhieu) < nSkill26) then
		if (HaveMagic(ThanQuangToanNhieu) < nSkill26) then
			AddMagic(ThanQuangToanNhieu,nSkill26) SetTask(TSK_ThanQuangToanNhieu,nSkill26) ConsumeEquiproomItem(1,6,1,4374,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ThanQuangToanNhieu).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill25.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThieuLamQuyen_27()
	if (GetTask(TSK_DaiLucKimCangChuong) < nSkill27) then
		if (HaveMagic(DaiLucKimCangChuong) < nSkill27) then
			AddMagic(DaiLucKimCangChuong,nSkill27) SetTask(TSK_DaiLucKimCangChuong,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function ThieuLamCon_27()
	if (GetTask(TSK_ViDaHienXu) < nSkill27) then
		if (HaveMagic(ViDaHienXu) < nSkill27) then
			AddMagic(ViDaHienXu,nSkill27) SetTask(TSK_ViDaHienXu,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function ThieuLamDao_27()
	if (GetTask(TSK_TamGioiQuyThien) < nSkill27) then
		if (HaveMagic(TamGioiQuyThien) < nSkill27) then
			AddMagic(TamGioiQuyThien,nSkill27) SetTask(TSK_TamGioiQuyThien,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function ThienVuongDao_27()
	if (GetTask(TSK_HaoHungTram) < nSkill27) then
		if (HaveMagic(HaoHungTram) < nSkill27) then
			AddMagic(HaoHungTram,nSkill27) SetTask(TSK_HaoHungTram,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function ThienVuongChuy_27()
	if (GetTask(TSK_TungHoanhBatPhuong) < nSkill27) then
		if (HaveMagic(TungHoanhBatPhuong) < nSkill27) then
			AddMagic(TungHoanhBatPhuong,nSkill27) SetTask(TSK_TungHoanhBatPhuong,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function ThienVuongThuong_27()
	if (GetTask(TSK_BaVuongTamKim) < nSkill27) then
		if (HaveMagic(BaVuongTamKim) < nSkill27) then
			AddMagic(BaVuongTamKim,nSkill27) SetTask(TSK_BaVuongTamKim,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function DMPhiDao_27()
	if (GetTask(TSK_VoAnhXuyen) < nSkill27) then
		if (HaveMagic(VoAnhXuyen) < nSkill27) then
			AddMagic(VoAnhXuyen,nSkill27) SetTask(TSK_VoAnhXuyen,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function DMTuTien_27()
	if (GetTask(TSK_ThietLienTuSat) < nSkill27) then
		if (HaveMagic(ThietLienTuSat) < nSkill27) then
			AddMagic(ThietLienTuSat,nSkill27) SetTask(TSK_ThietLienTuSat,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function DMTieu_27()
	if (GetTask(TSK_CanKhonNhatTrich) < nSkill27) then
		if (HaveMagic(CanKhonNhatTrich) < nSkill27) then
			AddMagic(CanKhonNhatTrich,nSkill27) SetTask(TSK_CanKhonNhatTrich,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function NguDocChuong_27()
	if (GetTask(TSK_HinhTieuCotLap) < nSkill27) then
		if (HaveMagic(HinhTieuCotLap) < nSkill27) then
			AddMagic(HinhTieuCotLap,nSkill27) SetTask(TSK_HinhTieuCotLap,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function NguDocDao_27()
	if (GetTask(TSK_UHonPheAnh) < nSkill27) then
		if (HaveMagic(UHonPheAnh) < nSkill27) then
			AddMagic(UHonPheAnh,nSkill27) SetTask(TSK_UHonPheAnh,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function NgaMyKiem_27()
	if (GetTask(TSK_KiemHoaVanTinh) < nSkill27) then
		if (HaveMagic(KiemHoaVanTinh) < nSkill27) then
			AddMagic(KiemHoaVanTinh,nSkill27) SetTask(TSK_KiemHoaVanTinh,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function NgaMyChuong_27()
	if (GetTask(TSK_BangVuLacTinh) < nSkill27) then
		if (HaveMagic(BangVuLacTinh) < nSkill27) then
			AddMagic(BangVuLacTinh,nSkill27) SetTask(TSK_BangVuLacTinh,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function ThuyYenDao_27()
	if (GetTask(TSK_BangTuocHoatKy) < nSkill27) then
		if (HaveMagic(BangTuocHoatKy) < nSkill27) then
			AddMagic(BangTuocHoatKy,nSkill27) SetTask(TSK_BangTuocHoatKy,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function ThuyYenNoi_27()
	if (GetTask(TSK_ThuyAnhManTu) < nSkill27) then
		if (HaveMagic(ThuyAnhManTu) < nSkill27) then
			AddMagic(ThuyAnhManTu,nSkill27) SetTask(TSK_ThuyAnhManTu,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function CaiBangQuyen_27()
	if (GetTask(TSK_ThoiThangLucLong) < nSkill27) then
		if (HaveMagic(ThoiThangLucLong) < nSkill27) then
			AddMagic(ThoiThangLucLong,nSkill27) SetTask(TSK_ThoiThangLucLong,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function CaiBangCon_27()
	if (GetTask(TSK_BongHuynhLuocDia) < nSkill27) then
		if (HaveMagic(BongHuynhLuocDia) < nSkill27) then
			AddMagic(BongHuynhLuocDia,nSkill27) SetTask(TSK_BongHuynhLuocDia,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function ThienNhanKich_27()
	if (GetTask(TSK_GiangHaiNoLan) < nSkill27) then
		if (HaveMagic(GiangHaiNoLan) < nSkill27) then
			AddMagic(GiangHaiNoLan,nSkill27) SetTask(TSK_GiangHaiNoLan,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function ThienNhanDao_27()
	if (GetTask(TSK_TatHoaLieuNguyen) < nSkill27) then
		if (HaveMagic(TatHoaLieuNguyen) < nSkill27) then
			AddMagic(TatHoaLieuNguyen,nSkill27) SetTask(TSK_TatHoaLieuNguyen,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function VoDangQuyen_27()
	if (GetTask(TSK_TaoHoaThaiThanh) < nSkill27) then
		if (HaveMagic(TaoHoaThaiThanh) < nSkill27) then
			AddMagic(TaoHoaThaiThanh,nSkill27) SetTask(TSK_TaoHoaThaiThanh,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function VoDangKiem_27()
	if (GetTask(TSK_KiemThuyTinhHa) < nSkill27) then
		if (HaveMagic(KiemThuyTinhHa) < nSkill27) then
			AddMagic(KiemThuyTinhHa,nSkill27) SetTask(TSK_KiemThuyTinhHa,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function ConLonDao_27()
	if (GetTask(TSK_CuuThienCuongPhong) < nSkill27) then
		if (HaveMagic(CuuThienCuongPhong) < nSkill27) then
			AddMagic(CuuThienCuongPhong,nSkill27) SetTask(TSK_CuuThienCuongPhong,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function ConLonKiem_27()
	if (GetTask(TSK_ThienLoiChanNhac) < nSkill27) then
		if (HaveMagic(ThienLoiChanNhac) < nSkill27) then
			AddMagic(ThienLoiChanNhac,nSkill27) SetTask(TSK_ThienLoiChanNhac,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function HoaSonKiem_27()
	if (GetTask(TSK_DocCoCuuKiem) < nSkill27) then
		if (HaveMagic(DocCoCuuKiem) < nSkill27) then
			AddMagic(DocCoCuuKiem,nSkill27) SetTask(TSK_DocCoCuuKiem,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function HoaSonKhi_27()
	if (GetTask(TSK_ThanQuangToanNhieu) < nSkill27) then
		if (HaveMagic(ThanQuangToanNhieu) < nSkill27) then
			AddMagic(ThanQuangToanNhieu,nSkill27) SetTask(TSK_ThanQuangToanNhieu,nSkill27) ConsumeEquiproomItem(1,6,1,4375,-1)
...
function ThieuLamQuyen_28()
	if (GetTask(TSK_DaiLucKimCangChuong) < nSkill28) then
		if (HaveMagic(DaiLucKimCangChuong) < nSkill28) then
			AddMagic(DaiLucKimCangChuong,nSkill28) SetTask(TSK_DaiLucKimCangChuong,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function ThieuLamCon_28()
	if (GetTask(TSK_ViDaHienXu) < nSkill28) then
		if (HaveMagic(ViDaHienXu) < nSkill28) then
			AddMagic(ViDaHienXu,nSkill28) SetTask(TSK_ViDaHienXu,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function ThieuLamDao_28()
	if (GetTask(TSK_TamGioiQuyThien) < nSkill28) then
		if (HaveMagic(TamGioiQuyThien) < nSkill28) then
			AddMagic(TamGioiQuyThien,nSkill28) SetTask(TSK_TamGioiQuyThien,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function ThienVuongDao_28()
	if (GetTask(TSK_HaoHungTram) < nSkill28) then
		if (HaveMagic(HaoHungTram) < nSkill28) then
			AddMagic(HaoHungTram,nSkill28) SetTask(TSK_HaoHungTram,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function ThienVuongChuy_28()
	if (GetTask(TSK_TungHoanhBatPhuong) < nSkill28) then
		if (HaveMagic(TungHoanhBatPhuong) < nSkill28) then
			AddMagic(TungHoanhBatPhuong,nSkill28) SetTask(TSK_TungHoanhBatPhuong,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function ThienVuongThuong_28()
	if (GetTask(TSK_BaVuongTamKim) < nSkill28) then
		if (HaveMagic(BaVuongTamKim) < nSkill28) then
			AddMagic(BaVuongTamKim,nSkill28) SetTask(TSK_BaVuongTamKim,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function DMPhiDao_28()
	if (GetTask(TSK_VoAnhXuyen) < nSkill28) then
		if (HaveMagic(VoAnhXuyen) < nSkill28) then
			AddMagic(VoAnhXuyen,nSkill28) SetTask(TSK_VoAnhXuyen,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function DMTuTien_28()
	if (GetTask(TSK_ThietLienTuSat) < nSkill28) then
		if (HaveMagic(ThietLienTuSat) < nSkill28) then
			AddMagic(ThietLienTuSat,nSkill28) SetTask(TSK_ThietLienTuSat,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function DMTieu_28()
	if (GetTask(TSK_CanKhonNhatTrich) < nSkill28) then
		if (HaveMagic(CanKhonNhatTrich) < nSkill28) then
			AddMagic(CanKhonNhatTrich,nSkill28) SetTask(TSK_CanKhonNhatTrich,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function NguDocChuong_28()
	if (GetTask(TSK_HinhTieuCotLap) < nSkill28) then
		if (HaveMagic(HinhTieuCotLap) < nSkill28) then
			AddMagic(HinhTieuCotLap,nSkill28) SetTask(TSK_HinhTieuCotLap,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function NguDocDao_28()
	if (GetTask(TSK_UHonPheAnh) < nSkill28) then
		if (HaveMagic(UHonPheAnh) < nSkill28) then
			AddMagic(UHonPheAnh,nSkill28) SetTask(TSK_UHonPheAnh,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function NgaMyKiem_28()
	if (GetTask(TSK_KiemHoaVanTinh) < nSkill28) then
		if (HaveMagic(KiemHoaVanTinh) < nSkill28) then
			AddMagic(KiemHoaVanTinh,nSkill28) SetTask(TSK_KiemHoaVanTinh,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function NgaMyChuong_28()
	if (GetTask(TSK_BangVuLacTinh) < nSkill28) then
		if (HaveMagic(BangVuLacTinh) < nSkill28) then
			AddMagic(BangVuLacTinh,nSkill28) SetTask(TSK_BangVuLacTinh,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function ThuyYenDao_28()
	if (GetTask(TSK_BangTuocHoatKy) < nSkill28) then
		if (HaveMagic(BangTuocHoatKy) < nSkill28) then
			AddMagic(BangTuocHoatKy,nSkill28) SetTask(TSK_BangTuocHoatKy,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function ThuyYenNoi_28()
	if (GetTask(TSK_ThuyAnhManTu) < nSkill28) then
		if (HaveMagic(ThuyAnhManTu) < nSkill28) then
			AddMagic(ThuyAnhManTu,nSkill28) SetTask(TSK_ThuyAnhManTu,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function CaiBangQuyen_28()
	if (GetTask(TSK_ThoiThangLucLong) < nSkill28) then
		if (HaveMagic(ThoiThangLucLong) < nSkill28) then
			AddMagic(ThoiThangLucLong,nSkill28) SetTask(TSK_ThoiThangLucLong,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function CaiBangCon_28()
	if (GetTask(TSK_BongHuynhLuocDia) < nSkill28) then
		if (HaveMagic(BongHuynhLuocDia) < nSkill28) then
			AddMagic(BongHuynhLuocDia,nSkill28) SetTask(TSK_BongHuynhLuocDia,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function ThienNhanKich_28()
	if (GetTask(TSK_GiangHaiNoLan) < nSkill28) then
		if (HaveMagic(GiangHaiNoLan) < nSkill28) then
			AddMagic(GiangHaiNoLan,nSkill28) SetTask(TSK_GiangHaiNoLan,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function ThienNhanDao_28()
	if (GetTask(TSK_TatHoaLieuNguyen) < nSkill28) then
		if (HaveMagic(TatHoaLieuNguyen) < nSkill28) then
			AddMagic(TatHoaLieuNguyen,nSkill28) SetTask(TSK_TatHoaLieuNguyen,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function VoDangQuyen_28()
	if (GetTask(TSK_TaoHoaThaiThanh) < nSkill28) then
		if (HaveMagic(TaoHoaThaiThanh) < nSkill28) then
			AddMagic(TaoHoaThaiThanh,nSkill28) SetTask(TSK_TaoHoaThaiThanh,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function VoDangKiem_28()
	if (GetTask(TSK_KiemThuyTinhHa) < nSkill28) then
		if (HaveMagic(KiemThuyTinhHa) < nSkill28) then
			AddMagic(KiemThuyTinhHa,nSkill28) SetTask(TSK_KiemThuyTinhHa,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function ConLonDao_28()
	if (GetTask(TSK_CuuThienCuongPhong) < nSkill28) then
		if (HaveMagic(CuuThienCuongPhong) < nSkill28) then
			AddMagic(CuuThienCuongPhong,nSkill28) SetTask(TSK_CuuThienCuongPhong,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function ConLonKiem_28()
	if (GetTask(TSK_ThienLoiChanNhac) < nSkill28) then
		if (HaveMagic(ThienLoiChanNhac) < nSkill28) then
			AddMagic(ThienLoiChanNhac,nSkill28) SetTask(TSK_ThienLoiChanNhac,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function HoaSonKiem_28()
	if (GetTask(TSK_DocCoCuuKiem) < nSkill28) then
		if (HaveMagic(DocCoCuuKiem) < nSkill28) then
			AddMagic(DocCoCuuKiem,nSkill28) SetTask(TSK_DocCoCuuKiem,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function HoaSonKhi_28()
	if (GetTask(TSK_ThanQuangToanNhieu) < nSkill28) then
		if (HaveMagic(ThanQuangToanNhieu) < nSkill28) then
			AddMagic(ThanQuangToanNhieu,nSkill28) SetTask(TSK_ThanQuangToanNhieu,nSkill28) ConsumeEquiproomItem(1,6,1,4376,-1)
...
function ThieuLamQuyen_29()
	if (GetTask(TSK_DaiLucKimCangChuong) < nSkill29) then
		if (HaveMagic(DaiLucKimCangChuong) < nSkill29) then
			AddMagic(DaiLucKimCangChuong,nSkill29) SetTask(TSK_DaiLucKimCangChuong,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function ThieuLamCon_29()
	if (GetTask(TSK_ViDaHienXu) < nSkill29) then
		if (HaveMagic(ViDaHienXu) < nSkill29) then
			AddMagic(ViDaHienXu,nSkill29) SetTask(TSK_ViDaHienXu,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function ThieuLamDao_29()
	if (GetTask(TSK_TamGioiQuyThien) < nSkill29) then
		if (HaveMagic(TamGioiQuyThien) < nSkill29) then
			AddMagic(TamGioiQuyThien,nSkill29) SetTask(TSK_TamGioiQuyThien,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function ThienVuongDao_29()
	if (GetTask(TSK_HaoHungTram) < nSkill29) then
		if (HaveMagic(HaoHungTram) < nSkill29) then
			AddMagic(HaoHungTram,nSkill29) SetTask(TSK_HaoHungTram,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function ThienVuongChuy_29()
	if (GetTask(TSK_TungHoanhBatPhuong) < nSkill29) then
		if (HaveMagic(TungHoanhBatPhuong) < nSkill29) then
			AddMagic(TungHoanhBatPhuong,nSkill29) SetTask(TSK_TungHoanhBatPhuong,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function ThienVuongThuong_29()
	if (GetTask(TSK_BaVuongTamKim) < nSkill29) then
		if (HaveMagic(BaVuongTamKim) < nSkill29) then
			AddMagic(BaVuongTamKim,nSkill29) SetTask(TSK_BaVuongTamKim,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function DMPhiDao_29()
	if (GetTask(TSK_VoAnhXuyen) < nSkill29) then
		if (HaveMagic(VoAnhXuyen) < nSkill29) then
			AddMagic(VoAnhXuyen,nSkill29) SetTask(TSK_VoAnhXuyen,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function DMTuTien_29()
	if (GetTask(TSK_ThietLienTuSat) < nSkill29) then
		if (HaveMagic(ThietLienTuSat) < nSkill29) then
			AddMagic(ThietLienTuSat,nSkill29) SetTask(TSK_ThietLienTuSat,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function DMTieu_29()
	if (GetTask(TSK_CanKhonNhatTrich) < nSkill29) then
		if (HaveMagic(CanKhonNhatTrich) < nSkill29) then
			AddMagic(CanKhonNhatTrich,nSkill29) SetTask(TSK_CanKhonNhatTrich,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function NguDocChuong_29()
	if (GetTask(TSK_HinhTieuCotLap) < nSkill29) then
		if (HaveMagic(HinhTieuCotLap) < nSkill29) then
			AddMagic(HinhTieuCotLap,nSkill29) SetTask(TSK_HinhTieuCotLap,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function NguDocDao_29()
	if (GetTask(TSK_UHonPheAnh) < nSkill29) then
		if (HaveMagic(UHonPheAnh) < nSkill29) then
			AddMagic(UHonPheAnh,nSkill29) SetTask(TSK_UHonPheAnh,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function NgaMyKiem_29()
	if (GetTask(TSK_KiemHoaVanTinh) < nSkill29) then
		if (HaveMagic(KiemHoaVanTinh) < nSkill29) then
			AddMagic(KiemHoaVanTinh,nSkill29) SetTask(TSK_KiemHoaVanTinh,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function NgaMyChuong_29()
	if (GetTask(TSK_BangVuLacTinh) < nSkill29) then
		if (HaveMagic(BangVuLacTinh) < nSkill29) then
			AddMagic(BangVuLacTinh,nSkill29) SetTask(TSK_BangVuLacTinh,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function ThuyYenDao_29()
	if (GetTask(TSK_BangTuocHoatKy) < nSkill29) then
		if (HaveMagic(BangTuocHoatKy) < nSkill29) then
			AddMagic(BangTuocHoatKy,nSkill29) SetTask(TSK_BangTuocHoatKy,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function ThuyYenNoi_29()
	if (GetTask(TSK_ThuyAnhManTu) < nSkill29) then
		if (HaveMagic(ThuyAnhManTu) < nSkill29) then
			AddMagic(ThuyAnhManTu,nSkill29) SetTask(TSK_ThuyAnhManTu,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function CaiBangQuyen_29()
	if (GetTask(TSK_ThoiThangLucLong) < nSkill29) then
		if (HaveMagic(ThoiThangLucLong) < nSkill29) then
			AddMagic(ThoiThangLucLong,nSkill29) SetTask(TSK_ThoiThangLucLong,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function CaiBangCon_29()
	if (GetTask(TSK_BongHuynhLuocDia) < nSkill29) then
		if (HaveMagic(BongHuynhLuocDia) < nSkill29) then
			AddMagic(BongHuynhLuocDia,nSkill29) SetTask(TSK_BongHuynhLuocDia,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function ThienNhanKich_29()
	if (GetTask(TSK_GiangHaiNoLan) < nSkill29) then
		if (HaveMagic(GiangHaiNoLan) < nSkill29) then
			AddMagic(GiangHaiNoLan,nSkill29) SetTask(TSK_GiangHaiNoLan,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function ThienNhanDao_29()
	if (GetTask(TSK_TatHoaLieuNguyen) < nSkill29) then
		if (HaveMagic(TatHoaLieuNguyen) < nSkill29) then
			AddMagic(TatHoaLieuNguyen,nSkill29) SetTask(TSK_TatHoaLieuNguyen,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function VoDangQuyen_29()
	if (GetTask(TSK_TaoHoaThaiThanh) < nSkill29) then
		if (HaveMagic(TaoHoaThaiThanh) < nSkill29) then
			AddMagic(TaoHoaThaiThanh,nSkill29) SetTask(TSK_TaoHoaThaiThanh,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function VoDangKiem_29()
	if (GetTask(TSK_KiemThuyTinhHa) < nSkill29) then
		if (HaveMagic(KiemThuyTinhHa) < nSkill29) then
			AddMagic(KiemThuyTinhHa,nSkill29) SetTask(TSK_KiemThuyTinhHa,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function ConLonDao_29()
	if (GetTask(TSK_CuuThienCuongPhong) < nSkill29) then
		if (HaveMagic(CuuThienCuongPhong) < nSkill29) then
			AddMagic(CuuThienCuongPhong,nSkill29) SetTask(TSK_CuuThienCuongPhong,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function ConLonKiem_29()
	if (GetTask(TSK_ThienLoiChanNhac) < nSkill29) then
		if (HaveMagic(ThienLoiChanNhac) < nSkill29) then
			AddMagic(ThienLoiChanNhac,nSkill29) SetTask(TSK_ThienLoiChanNhac,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function HoaSonKiem_29()
	if (GetTask(TSK_DocCoCuuKiem) < nSkill29) then
		if (HaveMagic(DocCoCuuKiem) < nSkill29) then
			AddMagic(DocCoCuuKiem,nSkill29) SetTask(TSK_DocCoCuuKiem,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function HoaSonKhi_29()
	if (GetTask(TSK_ThanQuangToanNhieu) < nSkill29) then
		if (HaveMagic(ThanQuangToanNhieu) < nSkill29) then
			AddMagic(ThanQuangToanNhieu,nSkill29) SetTask(TSK_ThanQuangToanNhieu,nSkill29) ConsumeEquiproomItem(1,6,1,4377,-1)
...
function ThieuLamQuyen_30()
	if (GetTask(TSK_DaiLucKimCangChuong) < nSkill30) then
		if (HaveMagic(DaiLucKimCangChuong) < nSkill30) then
			AddMagic(DaiLucKimCangChuong,nSkill30) SetTask(TSK_DaiLucKimCangChuong,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
...
function ThieuLamCon_30()
	if (GetTask(TSK_ViDaHienXu) < nSkill30) then
		if (HaveMagic(ViDaHienXu) < nSkill30) then
			AddMagic(ViDaHienXu,nSkill30) SetTask(TSK_ViDaHienXu,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ViDaHienXu).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThieuLamDao_30()
	if (GetTask(TSK_TamGioiQuyThien) < nSkill30) then
		if (HaveMagic(TamGioiQuyThien) < nSkill30) then
			AddMagic(TamGioiQuyThien,nSkill30) SetTask(TSK_TamGioiQuyThien,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(TamGioiQuyThien).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThienVuongDao_30()
	if (GetTask(TSK_HaoHungTram) < nSkill30) then
		if (HaveMagic(HaoHungTram) < nSkill30) then
			AddMagic(HaoHungTram,nSkill30) SetTask(TSK_HaoHungTram,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(HaoHungTram).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThienVuongChuy_30()
	if (GetTask(TSK_TungHoanhBatPhuong) < nSkill30) then
		if (HaveMagic(TungHoanhBatPhuong) < nSkill30) then
			AddMagic(TungHoanhBatPhuong,nSkill30) SetTask(TSK_TungHoanhBatPhuong,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(TungHoanhBatPhuong).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThienVuongThuong_30()
	if (GetTask(TSK_BaVuongTamKim) < nSkill30) then
		if (HaveMagic(BaVuongTamKim) < nSkill30) then
			AddMagic(BaVuongTamKim,nSkill30) SetTask(TSK_BaVuongTamKim,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(BaVuongTamKim).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function DMPhiDao_30()
	if (GetTask(TSK_VoAnhXuyen) < nSkill30) then
		if (HaveMagic(VoAnhXuyen) < nSkill30) then
			AddMagic(VoAnhXuyen,nSkill30) SetTask(TSK_VoAnhXuyen,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(VoAnhXuyen).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function DMTuTien_30()
	if (GetTask(TSK_ThietLienTuSat) < nSkill30) then
		if (HaveMagic(ThietLienTuSat) < nSkill30) then
			AddMagic(ThietLienTuSat,nSkill30) SetTask(TSK_ThietLienTuSat,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ThietLienTuSat).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function DMTieu_30()
	if (GetTask(TSK_CanKhonNhatTrich) < nSkill30) then
		if (HaveMagic(CanKhonNhatTrich) < nSkill30) then
			AddMagic(CanKhonNhatTrich,nSkill30) SetTask(TSK_CanKhonNhatTrich,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(CanKhonNhatTrich).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function NguDocChuong_30()
	if (GetTask(TSK_HinhTieuCotLap) < nSkill30) then
		if (HaveMagic(HinhTieuCotLap) < nSkill30) then
			AddMagic(HinhTieuCotLap,nSkill30) SetTask(TSK_HinhTieuCotLap,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(HinhTieuCotLap).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function NguDocDao_30()
	if (GetTask(TSK_UHonPheAnh) < nSkill30) then
		if (HaveMagic(UHonPheAnh) < nSkill30) then
			AddMagic(UHonPheAnh,nSkill30) SetTask(TSK_UHonPheAnh,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(UHonPheAnh).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function NgaMyKiem_30()
	if (GetTask(TSK_KiemHoaVanTinh) < nSkill30) then
		if (HaveMagic(KiemHoaVanTinh) < nSkill30) then
			AddMagic(KiemHoaVanTinh,nSkill30) SetTask(TSK_KiemHoaVanTinh,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(KiemHoaVanTinh).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function NgaMyChuong_30()
	if (GetTask(TSK_BangVuLacTinh) < nSkill30) then
		if (HaveMagic(BangVuLacTinh) < nSkill30) then
			AddMagic(BangVuLacTinh,nSkill30) SetTask(TSK_BangVuLacTinh,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(BangVuLacTinh).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThuyYenDao_30()
	if (GetTask(TSK_BangTuocHoatKy) < nSkill30) then
		if (HaveMagic(BangTuocHoatKy) < nSkill30) then
			AddMagic(BangTuocHoatKy,nSkill30) SetTask(TSK_BangTuocHoatKy,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(BangTuocHoatKy).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThuyYenNoi_30()
	if (GetTask(TSK_ThuyAnhManTu) < nSkill30) then
		if (HaveMagic(ThuyAnhManTu) < nSkill30) then
			AddMagic(ThuyAnhManTu,nSkill30) SetTask(TSK_ThuyAnhManTu,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ThuyAnhManTu).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function CaiBangQuyen_30()
	if (GetTask(TSK_ThoiThangLucLong) < nSkill30) then
		if (HaveMagic(ThoiThangLucLong) < nSkill30) then
			AddMagic(ThoiThangLucLong,nSkill30) SetTask(TSK_ThoiThangLucLong,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ThoiThangLucLong).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function CaiBangCon_30()
	if (GetTask(TSK_BongHuynhLuocDia) < nSkill30) then
		if (HaveMagic(BongHuynhLuocDia) < nSkill30) then
			AddMagic(BongHuynhLuocDia,nSkill30) SetTask(TSK_BongHuynhLuocDia,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(BongHuynhLuocDia).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThienNhanKich_30()
	if (GetTask(TSK_GiangHaiNoLan) < nSkill30) then
		if (HaveMagic(GiangHaiNoLan) < nSkill30) then
			AddMagic(GiangHaiNoLan,nSkill30) SetTask(TSK_GiangHaiNoLan,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(GiangHaiNoLan).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ThienNhanDao_30()
	if (GetTask(TSK_TatHoaLieuNguyen) < nSkill30) then
		if (HaveMagic(TatHoaLieuNguyen) < nSkill30) then
			AddMagic(TatHoaLieuNguyen,nSkill30) SetTask(TSK_TatHoaLieuNguyen,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(TatHoaLieuNguyen).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function VoDangQuyen_30()
	if (GetTask(TSK_TaoHoaThaiThanh) < nSkill30) then
		if (HaveMagic(TaoHoaThaiThanh) < nSkill30) then
			AddMagic(TaoHoaThaiThanh,nSkill30) SetTask(TSK_TaoHoaThaiThanh,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(TaoHoaThaiThanh).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function VoDangKiem_30()
	if (GetTask(TSK_KiemThuyTinhHa) < nSkill30) then
		if (HaveMagic(KiemThuyTinhHa) < nSkill30) then
			AddMagic(KiemThuyTinhHa,nSkill30) SetTask(TSK_KiemThuyTinhHa,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(KiemThuyTinhHa).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ConLonDao_30()
	if (GetTask(TSK_CuuThienCuongPhong) < nSkill30) then
		if (HaveMagic(CuuThienCuongPhong) < nSkill30) then
			AddMagic(CuuThienCuongPhong,nSkill30) SetTask(TSK_CuuThienCuongPhong,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(CuuThienCuongPhong).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function ConLonKiem_30()
	if (GetTask(TSK_ThienLoiChanNhac) < nSkill30) then
		if (HaveMagic(ThienLoiChanNhac) < nSkill30) then
			AddMagic(ThienLoiChanNhac,nSkill30) SetTask(TSK_ThienLoiChanNhac,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ThienLoiChanNhac).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function HoaSonKiem_30()
	if (GetTask(TSK_DocCoCuuKiem) < nSkill30) then
		if (HaveMagic(DocCoCuuKiem) < nSkill30) then
			AddMagic(DocCoCuuKiem,nSkill30) SetTask(TSK_DocCoCuuKiem,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(DocCoCuuKiem).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
...
function HoaSonKhi_30()
	if (GetTask(TSK_ThanQuangToanNhieu) < nSkill30) then
		if (HaveMagic(ThanQuangToanNhieu) < nSkill30) then
			AddMagic(ThanQuangToanNhieu,nSkill30) SetTask(TSK_ThanQuangToanNhieu,nSkill30) ConsumeEquiproomItem(1,6,1,4378,-1)
			...
			Msg2Player("Kü N¨ng CÊp 150 <color=yellow>"..GetSkillName(ThanQuangToanNhieu).."<color> Cña Ng­¬i Ch­a §¹t CÊp <color=yellow>"..nSkill29.."<color> H·y Cè G¨ng Tu LuyÖn Thªm")
		end
	else
