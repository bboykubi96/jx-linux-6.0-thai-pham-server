...
---------------------------------------------------------
function main()
dofile("script/item/dachengmiji23_150.lua")
...
function ThieuLamQuyen()
	if HaveMagic(1055) < 23 then
		if HaveMagic(1055) == 22 then
			...
			if (GetTask(5787) == 0) then SetTask(5787,1) end
			if (GetTask(5787) == 1) then SetTask(5787,2) end
			if (GetTask(5787) == 2) then SetTask(5787,3) end	
		else
...
function ThienVuongDao()
	if HaveMagic(1058) < 23 then
		if HaveMagic(1058) == 22 then
			...
			if (GetTask(5787) == 0) then SetTask(5787,1) 
			elseif (GetTask(5787) == 1) then SetTask(5787,2) 
			elseif (GetTask(5787) == 2) then SetTask(5787,3) end
		else
			Talk(1,"","<bclr=violet>"..myplayersex().." Ch­a §¹t 22 CÊp Kü N¨ng 150 Kh«ng ThÓ N©ng CÊp") return 1;
		end
	else
