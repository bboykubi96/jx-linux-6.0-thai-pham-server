...
function main()
	...
	if (tbBirthday0905:IsActDate() == 1) then
		tinsert(tbDialog, 3, "? miÕu s¬n thÇn trªn b¶n ®å ®İch nhiÖm vô /birthday0905_temple");
	end
...
function temple_starttask()
	...
	elseif ( nt_getTask(1202) == 25 or nt_getTask(1202) == 30 ) then
		Describe(DescLink_YiGuan..": Ng­¬i ®· hoµn thµnh nhiÖm vô, thÕ nµo cßn muèn tiÕp tôc tiÕp nhËn ? nhanh lªn mét chót rêi ®i c¸i nµy ®i!",1,"KÕt thóc ®èi tho¹i/no")
