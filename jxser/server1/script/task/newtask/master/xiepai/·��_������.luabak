...
local myTaskValue = GetTask(1003)
	...
	local tbOpp = {
		"Gi¸m ®Şnh tµng b¶o ®å/CheckTreasureMap_Say",
...
function CheckTreasureMap_Say()
	Say("A......§©y lµ Tµng B¶o ®å, gåm tÊt c¶ c¸c ®Şa ®iÓm chøa b¶o vËt tuyÖt thÕ,  ng­êi th­êng xem kh«ng hiÓu ®­îc, nÕu ng­¬i cã 100 v¹n <color=yellow>100 v¹n<color>...Khô! Khô!...",2,
		"§­îc! 100 v¹n  th× 100 v¹n/CheckMoney",
