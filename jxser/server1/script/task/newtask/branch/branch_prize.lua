...
function zhengpai_lel2()
	if (nt_getTask(1050) == 50) then
		...
		Msg2Player("B¹n nhËn ®­îc 2.000 ®iÓm kinh nghiÖm")
		for i=1,5 do
			DelItem(504)
		end
		AddOwnExp(2000)
...
function zhengpai_lel3()
	if (nt_getTask(1051) == 30) then
		...
		Msg2Player("B¹n nhËn ®­îc 5.000 ®iÓm kinh nghiÖm")
		-- if ( GetSex() == 0 ) then
...
--		Msg2Player("ÄãµÃµ½Ò»¿Å¿óÊ¯")
		Msg2Player("B¹n nhËn ®­îc 12.000 ®iÓm kinh nghiÖm")
...
function zhengpai_lel4()
	if (nt_getTask(1052) == 30) then
		...
		Msg2Player("B¹n nhËn ®­îc 10.000 ®iÓm kinh nghiÖm")
		AddOwnExp(10000)
...
function zhongli_lel4()
	...
	elseif (nt_getTask(1056) == 80) then
		...
		Msg2Player("B¹n nhËn ®­îc 26.000 ®iÓm kinh nghiÖm")
		AddOwnExp(26000)
	end
end
