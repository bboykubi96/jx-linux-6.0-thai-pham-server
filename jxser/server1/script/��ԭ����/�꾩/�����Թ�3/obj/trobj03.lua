-- script viet hoa By http://tranhba.com description: biÖn kinh phñ thiÕt th¸p tÇng ba b¶o r­¬ng ngµy nhÉn d¹y 50 cÊp nhiÖm vô 
...
AddNote("Më ra ng­êi thø ba c¬ quan ") 
Msg2Player("Më ra tÇng thø ba dÆm b¶o r­¬ng , më ra ng­êi thø ba c¬ quan ") 
