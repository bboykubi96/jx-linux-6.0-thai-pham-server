...
-- script viet hoa By http://tranhba.com  tr¨m qu¶ thËp cÈm tèng tö 
...
" ng­¬i ®¹t ®­îc 100000 chót kinh nghiÖm trŞ gi¸ #", 
...
AddOwnExp(100000) -- script viet hoa By http://tranhba.com  kinh nghiÖm trŞ gi¸ gia t¨ng 100000 
Msg2Player(msg[2]) 
