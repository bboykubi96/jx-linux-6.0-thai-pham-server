...
nExp = nRemainExp 
Msg2Player(format("§· ®¹t tíi cao nhÊt kinh nghiÖm , lÇn nµy chØ cã thÓ ®¹t ®­îc %d kinh nghiÖm .", nExp)) 
end 
if nExp > 0 then 
...
Talk(1, "", format("Sö dông %s nhiÒu nhÊt cã thÓ ®¹t ®­îc %u kinh nghiÖm ", szItemGroupName, tbXunMaShu0903.tbTask.nMaxExpFromOther * 1e6) ) 
return 1 
end 
