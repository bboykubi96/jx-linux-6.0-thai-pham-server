...
Talk(1,"","Trang bÞ chç trèng ch­a ®ñ , kh«ng thÓ më ra ®¹i bao tiÒn l× x× .") 
Msg2Player("Trang bÞ chç trèng ch­a ®ñ , kh«ng thÓ më ra ®¹i bao tiÒn l× x× .") 
return 1 
end 
local idx = BonusHongbao:randomSelect() 
if(not idx) then 
Msg2Player("Ng­¬i më ra ®¹i bao tiÒn l× x× , kÕt qu¶ g× còng kh«ng lÊy ®­îc . ") 
return 0 
end 
