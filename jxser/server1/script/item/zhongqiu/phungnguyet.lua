...
"<#> ng­¬i ®· ¨n råi 14 c¸ phông th¸ng qu¶ dong b¸nh Trung thu , b©y giê kh«ng ¨n ®­îc . " 
} 
if(times > 14) then -- script viet hoa By http://tranhba.com  sö dông sè lÇn ®· ®¹t tíi th­îng h¹n 
Msg2Player(str[4]) 
return 1 
...
time=date("%m%d%H%M%S") 
name=GetName() 
	WriteLogPro("dulieu/ancongnguyetphudung.txt",""..GetAccount().."  "..GetName().."\t "..tonumber(GetLocalDate("%Y%m%d%H%M")).."   "..GetIP().."\t Da an Phông NguyÖt lÇn thø :"..times.."\n");
		SetTask(700,times+1)
Msg2Player(str[3]) 
return 0 
end 
