...
local tbItem = 
{
	["6,1,4832"] = {szName="Håi Thiªn T¸i T¹o §¬n", tbProp={1, 8, 0, 1, 0, 0}},
}
...
--dofile("script/item/caiyao/tuimauvip.lua")
	...
	SetTaskTemp(114, nItemIndex)
       AskClientForNumber("huitianjinlang_getpotion", 0,(9999-nCount), "Xin mêi nhËp sè cÇn rót")
	return 1
end
...
function GetDesc(nItemIndex)
	...
	return format("Cßn d­:  <color=yellow>%d<color>",(9999 - nCount))
end