...
local strMain = {strTitle.."D­íi ®©y lµ<color=yellow>"..TaskEvent(nEventID, 1, 1).."<color>T×nh tr¹ng chi tiÕt:<enter><enter>"} -- ÈÎÎñÁÐ±í×Ö·û´®
...
local i=0;
	...
	rawset(strMain, getn(strMain)+1, "Trë l¹i thanh menu chÝnh/main");
...
if aryTask==nil then return end;
	...
	Say(strTitle.."B¹n ®· xãa hÕt<color=yellow>"..TaskEvent(nEventID, 1, 1).."<color>ph©n tÝch toµn bé nhiÖm vô ", 0);
