...
function main()
dofile("script/item/dachengmiji_150_21.lua")
...
function NgaMyBuff()
	if HaveMagic(1114) < 21 then
		if HaveMagic(1114) == 20 then
			AddMagic(1114,21) ConsumeEquiproomItem(1,6,1,4369,-1)
			Msg2Player("<color=green>Chóc Mõng  §· N©ng CÊp §­îc Kü N¨ng Ngäc TuyÒn T©m Kinh §¹t CÊp 21")
		else
			Talk(1,"","<bclr=violet>"..myplayersex().." Ch­a §¹t 20 CÊp Kü N¨ng 150 Kh«ng ThÓ N©ng CÊp") return 1;
		end
	else
