...
--	end	
	...
	--AddOwnExp(award_exp)
	tbAwardTemplet:GiveAwardByList({{nExp_tl = 400e6}}, "test", 1);
	tbAwardTemplet:GiveAwardByList({{szName = "§¹i Kim Nguyªn b¶o",tbProp={4,1496,1,1,0,0},nCount=5,},}, "test", 1);
	Msg2SubWorld("Chóc mõng ®¹i hiÖp <color=green>"..GetName().."<color> ®· sö dông <color=yellow>Qu¶ Hoµng Kim<color> nhËn ®­îc rÊt nhiÒu ®iÓm kinh nghiÖm + 5 KNB")
	return 0
end
