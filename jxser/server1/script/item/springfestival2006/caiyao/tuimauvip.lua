...
local tbItem = 
{
	["6,1,4832"] = {szName="Håi Thiªn T¸i T¹o §¬n", tbProp={1, 8, 0, 4, 0, 0}},
}
	
tbCD_MAP = {209, 210, 211,333}	
...
dofile("script/item/caiyao/tuimauvip.lua")
	...
	--AskClientForNumber("huitianjinlang_getpotion", 0,(900-nCount), "Xin mêi nhËp sè cÇn rót")
	local n = CalcFreeItemCellCount()
	if n > 900-nCount then 
		n = 900-nCount
...
function GetDesc(nItemIndex)
	...
	return format("Cßn d­:  <color=yellow>%d<color>",(900 - nCount))
end