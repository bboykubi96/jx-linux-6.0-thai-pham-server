...
Msg2Player("Ng­¬i sö dông mét <color=0xB5FDD7>"..SKILLNAME.."<color> , "..SKILLDESCRIBE); 
local nGroupId = GetTask(TK_GROUPID); 
nGroupId = festival_getgroupid(nGroupId) 
Msg2MSGroup(SF_MISSIONID, "<color=0xB5FDD7>"..GetName().."<color> sö dông mét <color=0xB5FDD7>"..SKILLNAME.."<color>"..SKILLDESCRIBE, nGroupId); 
end; 
