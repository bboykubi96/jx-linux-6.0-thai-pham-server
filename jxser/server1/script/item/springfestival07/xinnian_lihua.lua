-- script viet hoa By http://tranhba.com  n¨m míi lÔ hoa 
...
if (nb == 0) then 
Msg2Player("Ngµy lÔ ph¸o b«ng cã thÓ ë 7 ®¹i thµnh thÞ , 8 c¸ tay míi th«n cÊp mét 4 c¸ phong c¶nh khu sö dông "); 
return 1; 
end; 
SetTask(1593, nw1); 
SetTask(1594, nx1); 
SetTask(1595, ny1); 
Msg2Player("Ngµi ®· ®iÓm mét ngµy lÔ ph¸o b«ng !"); 
CastSkill(TB_XINNIANLIHUA_SKILL[random(1,2)],1); 
TM_SetTimer(5 * 18,TIMER_XINNIANLIHUA,60,0); -- script viet hoa By http://tranhba.com  h¹ tuyÕn biÕn mÊt 
else 
Msg2Player("Ngµi ®· ®iÓm ®Ó ngµy lÔ ph¸o b«ng , xin ®îi ph¸o b«ng ®èt xong sau míi cã thÓ tiÕp tôc !"); 
return 1; 
end; 
end; 
