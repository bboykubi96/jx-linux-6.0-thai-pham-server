-- script viet hoa By http://tranhba.com  may m¾n mÇm mãng sö dông sau cã thÓ call ra mét may m¾n c©y gi¸ng sinh 
...
bosslvl = 1 
i = random (1,5) - 1 
AddNpc(bossid,bosslvl,mapindex,posx,posy,1,GetName().." ®Ých may m¾n c©y gi¸ng sinh ",1) 
-- script viet hoa By http://tranhba.com 		CallNpc(i,603 + i,10,GetName().."µÄÐÒÔËÊ¥µ®Ê÷",0,1)
Msg2Player("Ng­¬i trång mét gèc c©y may m¾n c©y gi¸ng sinh , nhanh lªn diªu b¶o bèi ®i ") 
return 0 
else 
