-- script viet hoa By http://tranhba.com  hoµng kim mÇm mãng sö dông sau cã thÓ call ra mét hoµng kim c©y gi¸ng sinh 
...
bosslvl = 1 
i = random (1,5) - 1 
AddNpc(bossid,bosslvl,mapindex,posx,posy,1,GetName().." ®Ých hoµng kim c©y gi¸ng sinh ",1) 
-- script viet hoa By http://tranhba.com 		CallNpc(i,bossid + i,bosslvl,GetName().."µÄ»Æ½ðÊ¥µ®Ê÷",0,1)
Msg2Player("Ng­¬i trång mét gèc c©y hoµng kim c©y gi¸ng sinh , nhanh lªn diªu b¶o bèi ®i ") 
return 0 
else 
