...
-- script viet hoa By http://tranhba.com  # thóy khãi ®ao ph¸p # 
-- script viet hoa By http://tranhba.com  häc ®­îc kü n¨ng b¨ng tung v« ¶nh 
...
AddMagic(336,1) -- script viet hoa By http://tranhba.com  häc ®­îc kü n¨ng 
Msg2Player("Häc ®­îc kü n¨ng “ b¨ng tung v« ¶nh ” . ") 
return 0 
end 
end
