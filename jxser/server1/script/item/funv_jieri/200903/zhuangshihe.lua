...
local tbItem = 
{ 
{szName=" miÖng hång con ", tbProp={6, 1, 1960, 1, 0, 0}, nRate = 10, nExpiredTime = tbFunv0903.nComposeEndDate}, 
...
{szName=" s¬ tö ", tbProp={6, 1, 1963, 1, 0, 0}, nRate = 30, nExpiredTime = tbFunv0903.nComposeEndDate}, 
} 
...
Talk(1,"", format("Trang bÞ chç trèng ch­a ®ñ %d v« Ých , xin/mêi lÇn n÷a an bµi .", 1)) 
return 1 
end 
