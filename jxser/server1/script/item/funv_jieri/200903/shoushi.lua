...
if bRet ~= 1 then 
Talk(1, "", szFailMsg.." kh«ng phï hîp ®iÒu kiÖn sö dông nªn vËt phÈm .") 
return 1 
end 

if tbFunv0903.tbTask:CheckExpFromOther() ~= 1 then 
Talk(1, "", format(" ë nªn ho¹t ®éng vËt phÈm trung , mçi ng­êi nhiÒu nhÊt chØ cã thÓ ®¹t ®­îc %u kinh nghiÖm trÞ gi¸ .", tbFunv0903.tbTask.nMaxExpFromOther)) 
return 1 
else 
...
local tbItem = {szName=" hoa hång t¹p ", tbProp={6, 1, 1958, 1, 0, 0}, nExpiredTime = tbFunv0903.nItemExpiredTime} 
