...
tbclassname.TITLE = " nghªnh xu©n ®¹i ." 
tbclassname.tbdate = {} 
...
{G=6,D=1,P=1654,szname=" nhu th­íc ",prob=29.10}, 
{G=6,D=1,P=1655,szname=" h¹t ®Ëu ",prob=19.40}, 
...
Say("Nghªnh xu©n ®¹i ®· qua kú , kh«ng thÓ më ra ",0) 
return 0 
end 
...
local szstr = format("Chóc mõng ng­¬i ®¹t ®­îc 1 c¸ <color=yellow>%s<color>",nitem.szname) 
Msg2Player(szstr) 
