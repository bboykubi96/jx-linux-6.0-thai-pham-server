...
-- script viet hoa By http://tranhba.com  mËt tiÔn thËp cÈm tèng tö 
...
" ng­¬i ®¹t ®­îc 5000 chót kinh nghiÖm trŞ gi¸ #", 
...
AddOwnExp(5000) -- script viet hoa By http://tranhba.com  kinh nghiÖm trŞ gi¸ gia t¨ng 5000 
Msg2Player(msg[2]) 
