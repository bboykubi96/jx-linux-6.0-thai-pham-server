...
Msg2Player("Ng­¬i kh«ng thÓ ë n¬i nµy ®Þa ph­¬ng sö dông v©n kú binh phï #") 
return 1; 
end 

if (GetCurCamp() ~= 1) then 
Msg2Player("ChØ cã thñ ph­¬ng nhÊt ph­¬ng míi cã thÓ sö dông v©n kú binh phï #") 
return 1 
end; 
...
Msg2MSAll(MISSIONID, GetName().." sai ph¸i liÔu mét tªn cê tung bay vâ sÜ , gia nhËp chiÕn ®Êu #"); 
WriteLog(GetLoop()..GetName().." t¨ng lªn mét yaoqi"..ToolIndex) 
bAdd = 1 
return 0 
end; 
end; 
...
if (bAdd == 0) then 
Msg2Player("Tr­íc m¾t ph¸i tíi ®Ých trî gióp qu©n sè l­îng ®· cÊu , t¹m thêi kh«ng cÇn n÷a ph¸i ") 
return 1 
end; 
