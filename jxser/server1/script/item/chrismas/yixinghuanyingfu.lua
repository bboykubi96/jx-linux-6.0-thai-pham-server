...
Say("Ng­¬i sÏ ®èi c¸i nµo ®èi thñ sö dông ®¹o cô <color=0xB5FDD7> dêi h×nh ®æi ¶nh phï <color> ? ", getn(tabPlayer), tabPlayer); 
end; 
...
SetPos(x, y); 
Msg2Player("<#> ng­¬i ®èi víi <color=0xB5FDD7>"..szName.."<color> sö dông mét tê <color=0xB5FDD7> dêi h×nh ®æi ¶nh phï <color> , cïng vÞ trÝ h¾n trao ®æi . "); 

PlayerIndex = pidx 
SetPos(x1, y1); 
Msg2Player("<#><color=0xB5FDD7>"..OldName.."<color> ®èi víi ng­¬i sö dông mét tê <color=0xB5FDD7> dêi h×nh ®æi ¶nh phï <color> , cïng ng­¬i vÞ trÝ trao ®æi . "); 
PlayerIndex = OldPlayer; 
end; 
