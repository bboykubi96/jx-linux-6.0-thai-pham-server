-- script viet hoa By http://tranhba.com zero 20070713 ngäc bµi cho gäi 
...
Msg2Player("Kh«ng thÓ ë chç nµy sö dông nªn vËt phÈm .") 
return 1 
end 
...
if(nDate ~= GetByte(TaskValue,3) ) then -- script viet hoa By http://tranhba.com  kh«ng ph¶i lµ h«m nay 
if( CallBoss(5) == 0) then 
TaskValue=SetByte(TaskValue,3,nDate); -- script viet hoa By http://tranhba.com  thiÕt trİ ngäc bµi nhËt kú thø 1 ch÷ tiÕt 
...
Say("H«m nay ®· sö dông mét ng©n bµi liÔu , chê ngµy mai míi cã thÓ sö dông !",0); 
return 1; 
end 
