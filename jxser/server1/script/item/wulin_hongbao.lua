...
Msg2Player("Chóc mõng , ng­¬i thu ®­îc "..name) 
Say("Chóc mõng ng­¬i thu ®­îc <color=yellow>"..name.."<color>#", 0) 
WriteLog(date("%y-%m-%d,%H:%M").."Account==["..GetAccount().."] RoleName=="..GetName().." , tõ ®¹i héi vâ l©m bao tiÒn l× x× trung lÊy ®­îc "..name) 
end 