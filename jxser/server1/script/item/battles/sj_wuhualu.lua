...
Msg2Player("<#> ng­¬i thu ®­îc <color=0xB5FDD7> kÐo dµi 30 gi©y ®Ých l­îng m¸u th­îng h¹n gia t¨ng #"..(level*100).."<#> ®iÓm cïng kÐo dµi 30 gi©y ®Ých néi lùc th­îng h¹n gia t¨ng #"..(level*100).."<#> ®iÓm ") 
end 
