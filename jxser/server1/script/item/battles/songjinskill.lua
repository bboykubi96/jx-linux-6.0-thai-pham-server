...
-- script viet hoa By http://tranhba.com  tèng kim ®Æc thï kü n¨ng 
-- script viet hoa By http://tranhba.com  by Bel 
-- script viet hoa By http://tranhba.com  2008.03.06 
...
[466] = {nLevel_Low = 1, nLevel_High = 4, nTime = 60, szTips = "%s gi¶m bít giÕt sóng : %d%%"}, 
[467] = {nLevel_Low = 1, nLevel_High = 4, nTime = 60, szTips = "%s gi¶m bít tróng ®éc : %d%%"}, 
[468] = {nLevel_Low = 1, nLevel_High = 4, nTime = 60, szTips = "%s gi¶m bít ®éng t¸c chËm : %d%%"}, 
[469] = {nLevel_Low = 1, nLevel_High = 4, nTime = 60, szTips = "%s gi¶m bít chãi m¾t : %d%%"}, 
...
[476] = {nLevel_Low = 1, nLevel_High = 7, nTime = 60, szTips = "%s kh¸ng löa : t¨ng %d%%"}, 
...
[479] = {nLevel_Low = 10, nLevel_High = 20, nTime = 60, szTips = "%s b×nh th­êng néi c«ng giÕt sóng : t¨ng %d ®iÓm "}, 
[480] = {nLevel_Low = 1, nLevel_High = 5, nTime = 60, szTips = "%s ®éc giÕt néi c«ng : t¨ng %d ®iÓm "}, 
[481] = {nLevel_Low = 10, nLevel_High = 20, nTime = 60, szTips = "%s b¨ng giÕt néi c«ng : t¨ng %d ®iÓm "}, 
[482] = {nLevel_Low = 10, nLevel_High = 20, nTime = 60, szTips = "%s löa giÕt néi c«ng : t¨ng %d ®iÓm "}, 
[483] = {nLevel_Low = 10, nLevel_High = 20, nTime = 60, szTips = "%s l«i giÕt néi c«ng : t¨ng %d ®iÓm "}, 
[485] = {nLevel_Low = 1, nLevel_High = 5, nTime = 60, szTips = "%s ®éc giÕt ngo¹i c«ng : t¨ng %d ®iÓm "}, 
[486] = {nLevel_Low = 1, nLevel_High = 4, nTime = 60, szTips = "%s b¨ng giÕt ngo¹i c«ng : t¨ng %d ®iÓm "}, 
[487] = {nLevel_Low = 5, nLevel_High = 10, nTime = 60, szTips = "%s giÕt sóng ngo¹i c«ng : t¨ng %d%%"}, 
[488] = {nLevel_Low = 10, nLevel_High = 20, nTime = 60, szTips = " liªn tôc %s sinh m¹ng ®¹t th­îng h¹n t¨ng %d ®iÓm "}, 
[489] = {nLevel_Low = 10, nLevel_High = 20, nTime = 60, szTips = " liªn tôc %s néi c«ng ®¹t th­îng h¹n t¨ng %d ®iÓm "}, 
[490] = {nLevel_Low = 10, nLevel_High = 20, nTime = 60, szTips = " liªn tôc %s sinh m¹ng ®¹t th­îng h¹n t¨ng : %d ®iÓm cïng víi liªn tôc %s néi c«ng ®¹t th­îng h¹n t¨ng : %d ®iÓm "}, 
[493] = {nLevel_Low = 1, nLevel_High = 3, nTime = 60, szTips = "%s dêi ®i tèc ®é # t¨ng %d%%"}, 
[495] = {nLevel_Low = 10, nLevel_High = 20, nTime = 60, szTips = "%s trÝ m¹ng tû sè : t¨ng %d%%"}, 
[496] = {nLevel_Low = 1, nLevel_High = 2, nTime = 60, szTips = "%s vâ c«ng ra chiªu : t¨ng %d%%"}, 
[498] = {nLevel_Low = 10, nLevel_High = 30, nTime = 60, szTips = "%s löa giÕt ngo¹i c«ng : t¨ng %d ®iÓm "}, 
[499] = {nLevel_Low = 10, nLevel_High = 30, nTime = 60, szTips = "%s l«i giÕt ngo¹i c«ng : t¨ng %d ®iÓm "}, 
}; 
...
function add463() 
sjskill_addskill(463, 2, 10, 0.5, {"Nöa gi©y ", 500}); -- script viet hoa By http://tranhba.com  nöa gi©y lµ 12 tr¸nh ? 
end 
