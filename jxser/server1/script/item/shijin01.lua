...
-- script viet hoa By http://tranhba.com  thËp cÈm tèng tö 
...
" ng­¬i ®¹t ®­îc 1000 chót kinh nghiÖm trŞ gi¸ #", 
...
AddOwnExp(1000) -- script viet hoa By http://tranhba.com  kinh nghiÖm trŞ gi¸ gia t¨ng 1000 
Msg2Player(msg[2]) 
