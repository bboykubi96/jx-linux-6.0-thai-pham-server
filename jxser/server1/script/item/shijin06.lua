...
-- script viet hoa By http://tranhba.com  khuÊt nguyªn thËp cÈm tèng tö 
...
-- script viet hoa By http://tranhba.com ÇüÔ­Ê²½õôÕ×Ó£½Ë®¾§Ê²½õôÕ×Ó+ÈÎÒâôÕ×ÓÔ­ÁÏ1(Ôö¼Ó100,000,000µã¾­Ñé,³É¹¦ÂÊ3£¥)
...
AddOwnExp(200000000) -- script viet hoa By http://tranhba.com  kinh nghiÖm trŞ gi¸ gia t¨ng 200000000 
time=GetItemGenTime(sel) 
name=GetName() 
WriteLog("Nhµ ch¬i "..name.." ë "..time.." ¨n hÕt mét khuÊt nguyªn tèng tö ") 
Msg2Player(msg[2]) 
