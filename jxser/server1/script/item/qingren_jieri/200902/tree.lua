...
-- script viet hoa By http://tranhba.com  t­íi n­íc 
...
-- script viet hoa By http://tranhba.com  dÉn t­ëng 
...
-- script viet hoa By http://tranhba.com  ®Þnh lóc khÝ 
...
-- script viet hoa By http://tranhba.com  h×nh th¸i B -- script viet hoa By http://tranhba.com > b¾t ®Çu t­íi n­íc 
...
AddNpcSkillState(nNpcIdx, 662,1, 1, VALENTINE2009_TIME_WATER_END - VALENTINE2009_TIME_WATER_START); -- script viet hoa By http://tranhba.com  xuÊt hiÖn nhiÖm vô c¶m th¸n sè 
return 
end 

-- script viet hoa By http://tranhba.com  b¾t ®Çu t­íi n­íc -- script viet hoa By http://tranhba.com > kÕt thóc t­íi n­íc 
if nStep == VALENTINE2009_NPC_STEP_WATER_START then 

AddNpcSkillState(nNpcIdx, 662,1, 1, 0); -- script viet hoa By http://tranhba.com  kÕt thóc nhiÖm vô c¶m th¸n sè 
...
-- script viet hoa By http://tranhba.com  kÕt thóc t­íi n­íc -- script viet hoa By http://tranhba.com > h×nh th¸i C 
...
AddNpcSkillState(nNewNpcIdx, 662,1, 1, VALENTINE2009_TIME_DISAPPEAR - VALENTINE2009_TIME_GROW_D); -- script viet hoa By http://tranhba.com  xuÊt hiÖn nhiÖm vô c¶m th¸n sè 
return 
end 

-- script viet hoa By http://tranhba.com  h×nh th¸i D -- script viet hoa By http://tranhba.com > tö vong 
if nStep == VALENTINE2009_NPC_STEP_D then 
AddNpcSkillState(nNpcIdx, 662,1, 1, 0); -- script viet hoa By http://tranhba.com  kÕt thóc nhiÖm vô c¶m th¸n sè 
DelNpc(nNpcIdx) 
return 
...
-- script viet hoa By http://tranhba.com  biÕn th©n 
...
-- script viet hoa By http://tranhba.com  cã ph¶i lµ hay kh«ng th× ra lµ c¸i ®ã nam hµi 
...
-- script viet hoa By http://tranhba.com  cã ph¶i lµ hay kh«ng th× ra lµ c« g¸i kia 
...
-- script viet hoa By http://tranhba.com  t­íi n­íc nhiÖm vô 
function valentine2009_WaterTree(nNpcIdx) 

-- script viet hoa By http://tranhba.com  trªn ng­êi kh«ng cã n­íc 
...
-- script viet hoa By http://tranhba.com  kh«ng cã ë ®©y ho¹t ®éng nhËt kú ( khÊu trõ n­íc ) 
...
-- script viet hoa By http://tranhba.com  cho n­íc # khÊu trõ n­íc # 
...
SetNpcParam(nNpcIdx, VALENTINE2009_NPC_HAS_WATER, 1); -- script viet hoa By http://tranhba.com  ®· t­íi qu¸ n­íc 
AddNpcSkillState(nNpcIdx, 662,1, 1, 0); -- script viet hoa By http://tranhba.com  kÕt thóc nhiÖm vô c¶m th¸n sè 
