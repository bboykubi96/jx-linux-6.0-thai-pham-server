...
-- script viet hoa By http://tranhba.com  # nhiÕp hån # nguyÒn rña # 
-- script viet hoa By http://tranhba.com  häc ®­îc kü n¨ng nhiÕp hån lo¹n t©m 
...
Msg2Player("Ng­¬i cÇm # nhiÕp hån # nguyÒn rña # nghiªn cøu nöa ngµy , kÕt qu¶ c¸i g× còng kh«ng cã lÜnh ngé ®Õn . ") 
return 1 
elseif(GetLever < 80) then -- script viet hoa By http://tranhba.com  lµ ngµy nhÉn nh­ng ch­a tíi 80 cÊp 
Msg2Player("Ng­¬i cÇm # nhiÕp hån # nguyÒn rña # ®iÒu nghiªn liÔu nöa ngµy , kÕt qu¶ lÜnh ngé rÊt İt , kh«ng hiÖu qu¶ g× . ") 
return 1 
elseif(skill ~= -1) then -- script viet hoa By http://tranhba.com  ®· häc qua nªn kü n¨ng 
Msg2Player("Ng­¬i ®· ®em # nhiÕp hån # nguyÒn rña # ®iÒu nghiªn thÊu triÖt , tõ trong còng n÷a häc kh«ng tíi bÊt kú vËt g× . ") 
return 1 
else 
AddMagic(391,0) 
