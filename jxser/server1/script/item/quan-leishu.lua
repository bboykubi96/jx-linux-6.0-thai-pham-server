...
-- script viet hoa By http://tranhba.com # ngù l«i thuËt # 
-- script viet hoa By http://tranhba.com  häc ®­îc d©y d­a tù quyÕt kü n¨ng 
...
Msg2Player("Ng­¬i cÇm # ngù l«i thuËt # nghiªn cøu nöa ngµy , kÕt qu¶ c¸i g× còng kh«ng cã lÜnh ngé ®Õn . ") 
return 1 
elseif(GetLever < 80) then -- script viet hoa By http://tranhba.com  lµ C«n L«n nh­ng ch­a tíi 80 cÊp 
Msg2Player("Ng­¬i cÇm # ngù l«i thuËt # ®iÒu nghiªn liÔu nöa ngµy , kÕt qu¶ lÜnh ngé rÊt İt , kh«ng hiÖu qu¶ g× . ") 
return 1 
elseif(skill ~= -1) then -- script viet hoa By http://tranhba.com  ®· häc qua nªn kü n¨ng 
Msg2Player("Ng­¬i ®· ®em # ngù l«i thuËt # ®iÒu nghiªn thÊu triÖt , tõ trong còng n÷a häc kh«ng tíi bÊt kú vËt g× . ") 
return 1 
else 
AddMagic(375,1) 
