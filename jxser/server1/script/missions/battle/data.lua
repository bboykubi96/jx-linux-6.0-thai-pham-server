...
KILLNPC = {3, 703}, 
BEKILLED = {4, 704}, 
MAXSERIESKILL = {13, 713}, -- script viet hoa By http://tranhba.com  nhµ ch¬i toµn bé chiÕn cuéc lín nhÊt chÐm liªn tôc ®Õm 
SERIESKILL = {14, 714}, -- script viet hoa By http://tranhba.com  nhµ ch¬i tr­íc mÆt ®Ých chÐm liªn tôc ®Õm 
CURRANK = {27, 727}, 
BATTLECAMP = {43, 743}, 
	-- script viet hoa By http://tranhba.com BATTLEPOINT = {47, 747},	-- script viet hoa By http://tranhba.com ¼ÇÂ¼Íæ¼Ò±¾Õ½ÒÛµÄ×Ü»ý·Ö£¬×Ü»ý·ÖÊÇÍæ¼ÒËù²Î¼ÓµÄ¸÷³¡Õ½¾ÖµÄ»ý·Ö×ÜºÍ, E(PL_TOTALPOINT1 + PL_TOTALPOINT2+ ...)
} 
GAME_DATA = 
{ 
...
CAMP_SONG = 1 
CAMP_KIM = 2 
CAMP_NAME = {[CAMP_SONG] = " tèng ph­¬ng ", [CAMP_KIM] = " kim ph­¬ng "} 
TITLE = {"<color=white> binh lÝnh <color>", "<color=0xa0ff> gi¸o óy <color>", "<color=0xff> thèng lÜnh <color>", "<color=yellow> phã t­íng <color>", "<bclr=red> §¹i t­íng <bclr><color>"} 
TITLE_EFFECT = 
{ 
...
-- script viet hoa By http://tranhba.com self:ClearUIData(szName) 
