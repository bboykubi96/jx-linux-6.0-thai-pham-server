...
{szName = " mπc c´ng (2 Æi”m )", nNpcId = 1893, nRank = 2, nRate = 19}, 
{szName = " ngµy thuÀn (4 Æi”m )", nNpcId = 1894, nRank = 3, nRate = 14}, 
{szName = " th≠Óng hi“n (7 Æi”m )", nNpcId = 1895, nRank = 4, nRate = 10}, 
{szName = " bay nhπc (10 Æi”m )", nNpcId = 1896, nRank = 5, nRate = 9}, 
{szName = " hinh trÛc (20 Æi”m )", nNpcId = 1897, nRank = 6, nRate = 7}, 
{szName = " n≠Ìc tr∂i qua ( 30 Æi”m )", nNpcId = 1898, nRank = 7, nRate = 5}, 
{szName = " s¨n loan (40 Æi”m )", nNpcId = 1899, nRank = 8, nRate = 5}, 

{szName = " b„ng d∏ng (50 Æi”m )", nNpcId = 1900, nRank = 9, nRate = 4}, 
{szName = " th≠¨ng lan (60 Æi”m )", nNpcId = 1901, nRank = 10, nRate = 4}, 

{szName = " khi’u v´ ›ch (100 Æi”m )", nNpcId = 1902, nRank = 11, nRate = 4}, 
...
-- script viet hoa By http://tranhba.com tbTemp = {} 

-- script viet hoa By http://tranhba.com function clear_npc(nMapId) 
-- script viet hoa By http://tranhba.com  tbTemp[nMapId] = 0 
...
SetNpcTimer(nNpcIndex, 18) 
			-- script viet hoa By http://tranhba.com tbTemp[nMapId] = tbTemp[nMapId] + 1
end 
end 
