...
ClearMapNpc(self.nMapId) 
	...
	-- script viet hoa By http://tranhba.com DynamicExecute("\\script\\missions\\qianchonglou\\npc\\monster.lua", "clear_npc", self.nMapId)
...
Msg2Map(self.nMapId, format("%s ®¹t ®­îc %d t­ëng th­ëng ", self.pChallenger.szName, nPoint)) 
end 
...
Msg2Map(self.nMapId,"Chóc mõng c¸c h¹ ®· ®¹t ®­îc ®Æc biÖt giËn dö , xin/mêi lùa chän môc tiªu .") 
end 
end 
