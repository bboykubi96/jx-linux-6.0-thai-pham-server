...
function BattleWorld:StartSignup()
	...
	AddLocalCountNews("ThÊt thµnh ®¹i chiÕn b¾t ®Çu b¸o danh, xin mêi ch­ vÞ <color=red>Bang Chñ<color> h·y nhanh chãng b¸o danh t¹i xa phu c«ng thµnh (T­¬ng D¬ng 197/214), bang chiÕm thµnh kh«ng cÇn b¸o danh.", 5)
end

function BattleWorld:CloseSignup()
	self.m_State = STATE_CLOSESIGNUP
	AddLocalCountNews("ThÊt thµnh ®¹i chiÕn ®· kÕt thóc b¸o danh 20h00 chuÈn bÞ 20h30 khai cuéc 21h30 kÕt thóc 21h45 nhËn th­ëng", 3)
end
