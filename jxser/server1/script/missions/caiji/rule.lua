...
{ 
"CALLNPC", 
-- script viet hoa By http://tranhba.com "TRANSFER", 
"MATE", 
"PK" 
} 
...
Msg2Player(format(" %s gi©y sau chÝnh thøc b¾t ®Çu ", floor(nFrame/18))) 
end 
...
local tb = {} 
tinsert(tb,"§øng hµng thø b¶n ") 
for i = 1, 10 do 
if not tbPlayer[i] then 
break 
end 
tinsert(tb, format("§øng hµng %d: <color=yellow>%s<color> - <color=yellow>%d<color> ®iÓm ", i,tbPlayer[i].szName, tbPlayer[i].nPoint)) 
end 
return tb 
end 
