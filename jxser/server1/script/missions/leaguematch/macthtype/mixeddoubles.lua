...
WLLS_DATA = {
	...
	npc_mylg = function()
		...
		if (n_job == 1 and n_mytype == n_next) then
			...
			"C¸c b­íc thµnh lËp chiÕn ®éi: trong kho¶ng <color=red>thêi gian nghØ vµ thêi gian thi ®Êu<color>, ®Òu cã thÓ tæ ®éi víi ng­êi ch¬i kh¸c, <color=red>kh¸c giíi tÝnh<color>, lùa chän ®ång ý cho ®ång ®éi gia nhËp chiÕn ®éi cña m×nh. <enter>"..
