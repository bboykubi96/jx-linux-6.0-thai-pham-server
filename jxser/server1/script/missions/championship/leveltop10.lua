...
local strtalk = " chóc mõng ®¹i héi vâ l©m 10 ®¹i vâ l©m t©n tó cao thñ "..tabname[1]..", "..tabname[2]..", "..tabname[3]..", "..tabname[4]..", "..tabname[5]..", "..tabname[6]..", "..tabname[7]..", "..tabname[8]..", "..tabname[9]..", "..tabname[10] 
