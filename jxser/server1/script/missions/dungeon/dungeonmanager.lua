...
local szTitle = "<npc> ng­¬i ®· më ra mét chç kh¸c ph­¬ng ®Ých phã b¶n , cÇn th«ng qua n¬i ®ã sao ?" 
local tbOpt = 
{ 
{"Mang ta ®i ", NewWorld, {tbDungeonData.tbEnterPos.nMapId, tbDungeonData.tbEnterPos.nX, tbDungeonData.tbEnterPos.nY}}, 
{"Hñy bá "} 
} 
CreateNewSayEx(szTitle, tbOpt) 
else 
Talk(1,"",format("Khëi ®éng [<color=red>%s<color>] thÊt b¹i , cã thÓ nªn phã b¶n ®· ®ñ ng­êi , xin/mêi chê thªm chót n÷a .", strDungeon)); 
end 
...
Talk(1,"",format("Khëi ®éng [%s] thÊt b¹i , cã thÓ nªn phã b¶n ®· ®ñ ng­êi , xin/mêi chê thªm chót n÷a .", strDungeon)); 
...
if (bSuccess ~= 1) then 
Talk(1,"","Më ra phã b¶n thÊt b¹i , cã thÓ phã b¶n ®· ®Çy , xin hËu thö l¹i ."); 
...
Talk(1,"",format("§¹i hiÖp ®· më ra 1 [<color=red>%s<color>], më ra míi tr­íc , xin ®em cùu ®Ých ®ãng .", strDungeon)); 
return 0; 
end 
end 
...
doFunByPlayer(nNewMemberIdx, PutMessage, format("§¹i hiÖp ®· tham gia [%s] ë [%s]", tbDungeon.strOwner, tbDungeon.strDungeon)); 
end 
...
-- script viet hoa By http://tranhba.com  ®em nhµ ch¬i truyÒn ra phã b¶n 
self:LeaveDungeon(tbDungeon.nDungeonId, tbDungeon.tbMember[i].nIndex); 
doFunByPlayer(tbDungeon.tbMember[i].nIndex, Talk, 1,"",format("§¹i hiÖp ®· bÞ ®Èy ra , bëi v× [%s] ?[%s].", tbDungeon.strOwner, tbDungeon.strDungeon)); 
end 
tremove(tbDungeon.tbMember, i); 
-- script viet hoa By http://tranhba.com  nÕu nh­ thµnh viªn v× 0, muèn t¾t phã b¶n 
...
if (nOwnerIdx > 0) then 
doFunByPlayer(nOwnerIdx, PutMessage, format("[%s] xin gia nhËp [%s]", strPlayerName, tbDungeon.strDungeon)); 
end 
