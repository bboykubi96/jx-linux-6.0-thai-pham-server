...
tbTONGWAR_NPC = { 
	{ 393, 1597, 3139, "³µ·ò",		"\\script\\missions\\tongwar\\npc\\chefu.lua" },
	{ 625, 1590, 3132, "´¢ÎïÏä",	"\\script\\missions\\tongwar\\npc\\openbox.lua" },
	{ 389, 1580, 3151, "Ò©µêÀÏ°å",		"\\script\\missions\\tongwar\\npc\\doctor.lua" },
-- script viet hoa By http://tranhba.com 	{389, 1589, 3148, "trap", "\\script\\missions\\tongwar\\trap\\tongwar_trap.lua"}
...
-- script viet hoa By http://tranhba.com THDNB10 # ®iÒu chØnh thêi gian add npc sø gi¶ - Modified by DinhHQ - 20111019 
if (nDate >= 20120528 and nDate <= 20120603) then 
local sidx = SubWorldID2Idx(2); 
if (sidx >= 0) then 
SubWorld = sidx; 
local npcidx = AddNpc(53, 1, sidx, 2608*32,3496*32, 1,"§Ö nhÊt thiªn h¹ gióp sø gi¶ "); 
if (npcidx > 0) then 
