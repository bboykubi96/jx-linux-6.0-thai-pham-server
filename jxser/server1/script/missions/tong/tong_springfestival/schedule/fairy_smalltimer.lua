...
Msg2MSGroup(SF_MISSIONID, format("CÇn sö dông <color=yellow> ph¸o tr­îng <color>? ?color=yellow> thö g¾p <color><color=yellow> th¨ng thiªn ph¸o <color> theo ®uæi bé %s!", SF_ANIMALNAME), i); 
end; 

    for i = SF_SMALLMAPCOUNT + 1, nCount do
Msg2MSGroup(SF_MISSIONID, format("Tr­íc m¾t ng­¬i lµ %s, cÇn b¾t <color=yellow>%s<color> míi cã thÓ dÉn t­ëng !", SF_ANIMALNAME, SF_MOUSENAME), i); 
end; 
end; 
