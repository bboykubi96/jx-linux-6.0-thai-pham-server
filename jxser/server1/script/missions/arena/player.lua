...
if nDiffRank > 0 then 
Msg2Player(format("Ng­¬i s©n ®Êu kü n¨ng t¨ng lªn %d", nDiffRank)) 
elseif nDiffRank < 0 then 
Msg2Player(format("Ng­¬i s©n ®Êu kü n¨ng rít xuèng %d", -nDiffRank)) 
end 
...
Msg2Player(format("Ng­¬i lÊy ®­îc s©n ®Êu phÇn th­ëng lµ %d huy ch­¬ng ", nDiffCredits)) 
end 
...
Msg2Player(format("Ng­¬i lÊy ®­îc nh÷ng kh¸c mçi tuÇn s©n ®Êu phÇn th­ëng lµ %d huy ch­¬ng ", nDiffCredits)) 
end 
