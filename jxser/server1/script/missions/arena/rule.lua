...
local tbNpcList = 
{ 
	{szName = "´¢ÎïÏä", nPosX = 50112, nPosY = 102848, nNpcId = 625, szScriptPath = "\\script\\battles\\openbox.lua"},
	{szName = "Ò©ÉÌ", nPosX = 50496, nPosY = 102528, nNpcId = 203, szScriptPath = "\\script\\missions\\arena\\npc\\yaodian.lua"}
...
-- script viet hoa By http://tranhba.com  b×nh th­êng thi hµnh sÏ kh«ng tíi ®©y 
...
Msg2Map(self.nMapId,"Hai bªn còng tö trËn .") 
...
self:SetResult(pMemberA, pMemberB, "DRAW") 
Msg2Map(self.nMapId,"Song ph­¬ng thÓ lùc bÊt ph©n th¾ng phô ") 
...
Msg2Map(self.nMapId, format(" %d gi©y sau chÝnh thøc b¾t ®Çu ", %READY_TIME)) 
...
Msg2Map(self.nMapId, format("ChuÈn bÞ thêi gian cßn cã %d gi©y ", self.nCountDown)) 
return 18 
