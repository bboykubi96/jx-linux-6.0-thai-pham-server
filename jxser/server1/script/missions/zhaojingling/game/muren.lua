...
[6]={szName=" ngÊt xØu bÉy rËp ",tbProp={6,1,2795,1,0,0},nRate = 5.0,}, 
[7]={szName=" thay ®æi chËm bÉy rËp ",tbProp={6,1,2796,1,0,0},nRate = 5.0,}, 
[8]={szName=" thiªn l«i ngäc ",tbProp={6,1,2797,1,0,0},nRate = 5.0,}, 
[9]={szName=" giã rÐt ngäc ",tbProp={6,1,2798,1,0,0},nRate = 5.0,}, 
[10]={szName=" l¸ ch¾n ®Þa phï ",tbProp={6,1,2799,1,0,0},nRate = 5.0,}, 
} 
...
tbAwardTemplet:GiveAwardByList(%tbAward,"T×m ®­îc méc nh©n , ®¹t ®­îc t­ëng th­ëng ") 
DelNpc(nNpcIndex) 
end 
end 
