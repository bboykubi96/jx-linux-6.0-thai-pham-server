-- script viet hoa By http://tranhba.com  quµ gi∏ng sinh ÆËi thoπi ch©n vËn # 
...
{ {6,1,986,1,1,1,1},0.003,"DÍi h◊nh ÆÊi ∂nh phÔ " }, 
...
{ 150000,0.01}, 
{ 300000,0.005}, 
{ {6,1,402,1,1,1,1},0.001,"Th«n b› Æπi bao ti“n l◊ x◊ "}, 
} 
...
Msg2Player("Ng≠¨i Æ∑ ch‰n trung "..nCount.." gi∏ng sinh l‘ tÛi "); 
end; 
...
AddOwnExp(nExp); 
Msg2Player("Ng≠¨i l y Æ≠Óc <color=0xB5FDD7>"..nExp.." kinh nghi÷m .") 
end 
break 
end 
end 
