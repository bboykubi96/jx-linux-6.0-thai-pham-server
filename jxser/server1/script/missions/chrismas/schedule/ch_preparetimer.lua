...
if (nRemain > 0) then 
Msg2MSAll(CH_PREPAREMISSIONID,"Cßn "..nRemain.." t¸ch ra míi tranh tµi !"); 
end; 
end; 
end; 
...
SetTask(TK_COUNT_ONETIME, 0); -- script viet hoa By http://tranhba.com  ®em mét cuéc so tµi c¸ ®Õm thanh 0# 
SetTask(TK_RANK, 0); -- script viet hoa By http://tranhba.com  ®em ®øng hµng thanh 0 
SetTask(TK_GROUPID, nGroupId); -- script viet hoa By http://tranhba.com  ghi chÐp nhµ ch¬i ®Ých groupid 
