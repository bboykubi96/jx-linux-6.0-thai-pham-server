Include("\\script\\activitysys\\config\\1037\\variables.lua")
tbConfig = {}
tbConfig[1] = --Ò»¸öÏ¸½Ú
{
	nId = 1,
	...
	tbActition = 
	{
		...
		{"SetDialogTitle",	{"<npc> Xin chµo ®¹i hiÖp! Th«n lµng cã <color=green>1 c©y §a thÇn kú<color> ®· gióp Ých rÊt nhiÒu cho ng­êi trong th«n.<enter>HiÖn cã nhiÒu tªn <color=green>GiÆc Cá<color> ®Õn quÊy ph¸. §¹i hiÖp h·y nhËn cña ta <color=green>1 Thïng Gç<color> sau ®ã h·y ®Õn vÞ trÝ hå n­íc (199/201) ®Ó lÊy ®Çy n­íc. Sau ®ã sö dông <color=green>1 Thïng N­íc ®Çy vµ 1 Hé Tiªu LÖnh<color> gióp cho tiÓu ®Ö hé tèng vÒ lµng th× cã thÓ nhËn ®­îc phÇn th­ëng phong phó, mçi ®¹i hiÖp mçi ngµy cã thÓ tiÕp nhËn nhiÖm vô <color=red>3 lÇn,<color> trong hµnh tr×nh hé tèng, ®¹i hiÖp cÇn ph¶i b¶o vÖ sù an toµn cña <color=green>Xe Ngùa<color>, nÕu <color=green>Xe Ngùa<color> bÞ chÕt, th× sÏ r¬i ra <color=green>1 Hçn Nguyªn Linh Lé<color> vµ nhiÖm vô sÏ thÊt b¹i"} },	},
}
tbConfig[2] = --Ò»¸öÏ¸½Ú
{
	nId = 2,
	...
	tbActition = 
	{
		{"ThisActivity:GiveTaskNowLTT",	{nil} },
	},
}
tbConfig[3] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"ThisActivity:StartLoaderThonLangLTT",	{nil} },
	},
}
tbConfig[4] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		...
		{"NpcFunLib:AddDialogNpc",	{"C©y §a LTT",1452,{{174,1677,3181}}} },
		{"NpcFunLib:AddDialogNpc",	{"Chó Cuéi LTT",1448,{{174,1756,3075}}} },
	},
}
tbConfig[5] = --Ò»¸öÏ¸½Ú
{
...
tbConfig[7] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{szName="Hé Thuû LÖnh 2021",tbProp={6,1,5053,1,0,0},nExpiredTime=10080},1,EVENT_LOG_TITLE,"Mua Hé Tiªu LÖnh"} },
	},
}
tbConfig[8] = 
{
...
tbConfig[9] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{tbProp={6,1,5051,1,0,0},nExpiredTime=1440,},1,"NhËn tõ Chó cuéi"} },	},
}
tbConfig[10] = --Ò»¸öÏ¸½Ú
{
	nId = 10,
