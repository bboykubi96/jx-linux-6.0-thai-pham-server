...
tbConfig[1] = --Tèng Kim 1000 §iÓm
{
  ...
  {"PlayerFunLib:GetItem",	{{nExpiredTime=20220329,tbProp={6,1,30276,1,0,0},},20,"[Event_Quèc TÕ Phô N÷] [tTongKim1000]"} },
...
tbConfig[2] = --Tèng Kim 3000 §iÓm
{
	...
	tbActition = 
	{
              {"PlayerFunLib:GetItem",	{{nExpiredTime=20220329,tbProp={6,1,30276,1,0,0},},20,"[Event_Quèc TÕ Phô N÷] [tTongKim3000]"} },
...
tbConfig[3] =
{
	...
	tbActition = 
	{
              {"PlayerFunLib:GetItem",	{{nExpiredTime=20220329,tbProp={6,1,30276,1,0,0},},20,"[Event_Quèc TÕ Phô N÷] [tVuotAi17]"} },
...
tbConfig[4] =
{
	...
	tbActition = 
	{
              {"PlayerFunLib:GetItem",	{{nExpiredTime=20220329,tbProp={6,1,30276,1,0,0},},20,"[Event_Quèc TÕ Phô N÷] [tVuotAi28]"} },
...
tbConfig[5] = --Thñy TÆc §Çu LÜnh
{
	...
	tbActition = 
	{
              {"PlayerFunLib:GetItem",	{{nExpiredTime=20220329,tbProp={6,1,30276,1,0,0},},20,"[Event_Quèc TÕ Phô N÷] [tTieuDietThuyTacDauLinh]"} },
...
tbConfig[6] = --Thñy TÆc §¹i §Çu LÜnh
{
	...
	tbActition = 
	{          
              {"PlayerFunLib:GetItem",	{{nExpiredTime=20220329,tbProp={6,1,30276,1,0,0},},20,"[Event_Quèc TÕ Phô N÷] [tTieuDietThuyTacDaiDauLinh]"} },           
...
tbConfig[7] = --Viªm §Õ
{
	...
	tbActition = 
	{
               {"PlayerFunLib:GetItem",	{{nExpiredTime=20220329,tbProp={6,1,30276,1,0,0},},20,"[Event_Quèc TÕ Phô N÷] [tVuotAiViemDe10]"} },
...
tbConfig[8] = --Tin Su
{
	...
	tbActition = 
	{        
              {"PlayerFunLib:GetItem",	{{nExpiredTime=20220329,tbProp={6,1,30276,1,0,0},},10,"[Event_Quèc TÕ Phô N÷] [tTinSu10]"} },  
...
tbConfig[9] = --V­LMC
{
	...
	tbActition = 
	{          
               {"PlayerFunLib:GetItem",	{{nExpiredTime=20220329,tbProp={6,1,30276,1,0,0},},40,"[Event_Quèc TÕ Phô N÷] [tVLMC]"} },
...
tbConfig[10] = --Boss ThÕ Giíi
{
	...
	tbActition = 
	{
                {"PlayerFunLib:GetItem",	{{nExpiredTime=20220329,tbProp={6,1,30276,1,0,0},},40,"[Event_Quèc TÕ Phô N÷] [tTieuDietBossTheGioi]"} },  
...
tbConfig[11] = --Boss S¸t Thñ
{
	...
	tbActition = 
	{
      {"PlayerFunLib:GetItem",	{{nExpiredTime=20220329,tbProp={6,1,30276,1,0,0},},20,"[Event_Quèc TÕ Phô N÷] [tTieuDietBossS¸tThñ]"} },
...
tbConfig[12] = --B¶n §å §¸nh Qu¸i Rí Nguyªn LiÖu
{
	...
	tbActition = 
	{
              {"NpcFunLib:DropSingleItem",	{{nExpiredTime=20220329,tbProp={6,1,30276,1,0,0},},1,"7"} },  
...
tbConfig[13] = --§èi tho¹i §¹i ThÇn Tµi
{
	...
	tbActition = 
	{
	      {"AddDialogOpt",{"Lµm B¸nh GiÇy",14} },
	      {"AddDialogOpt",	{"Lµm B¸nh Ch­ng",15} },
...
tbConfig[14] = 
{
	...
	szName = "Lµm B¸nh GiÇy",
	nStartDate = nil,
	nEndDate  = nil,
	tbMessageParam = {"Lµm B¸nh GiÇy",1,1,1,0.02},
	tbCondition = 
	{
		...
		{"AddOneMaterial",	{"Cèi §©m B¸nh",{tbProp={6,1,30281,1,0,0},},2} },
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=20220329,tbProp={6,1,30284,1,0,0},},1,"[Event_Quèc TÕ Phô N÷] [Bã Hoa Tam S¾c]"} },
	},
}
tbConfig[15] = 
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=20220329,tbProp={6,1,30283,1,0,0},},1,"[Event_Quèc TÕ Phô N÷] [Bã Hoa Tø S¾c]"} },
	},
}
...
tbConfig[20] = 
{
	...
	tbCondition = 
	{
		...
		{"AddOneMaterial",	{"5 Xu = 1 QuÇn Gi¸ng Sinh",{tbProp={4,417,1,1,0,0},},5} },
	},
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=20220329,tbProp={6,1,3073,1,0,0},},1,"[Event_Quèc TÕ Phô N÷] [Hoa Hång §á]"} },
	},
}
tbConfig[21] = 
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{nExpiredTime=20211231,tbProp={6,1,6729,1,0,0},},1,"[Event_Quèc TÕ Phô N÷] [Kim M· LÖnh]"} },
	},
}