Include("\\script\\activitysys\\config\\1036\\variables.lua")
tbConfig = {}
tbConfig[1] = --Ò»¸öÏ¸½Ú
{
	nId = 1,
...
tbConfig[4] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		...
		{"NpcFunLib:AddDialogNpc",	{"C©y §a VLT",1452,{{153,1650,3148}}} },
		{"NpcFunLib:AddDialogNpc",	{"Chó Cuéi VLT",1448,{{153,1734,3072}}} },
	},
}
tbConfig[5] = --Ò»¸öÏ¸½Ú
{
...
tbConfig[10] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		...
		{"AddDialogOpt",	{"Ta muèn hé tèng ",11} },
