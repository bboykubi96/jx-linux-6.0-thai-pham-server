...
function main()
dofile("script/global/g7vn/item/hopquadocla.lua")
...
if ranchung==1 then
	local ranvk=random(1,3)
		if ranvk<=2 then
			AddItem(0, 0,random(0,5), random(1,10),random(0,4), 50, 10) 
		else
			AddItem( 0, 1,random(0,2), random(1,10),random(0,4), 50, 10) 
		end
elseif ranchung==2 then
			AddItem( 0, 2,random(0,13), random(1,10),random(0,4), 50, 10) 
elseif ranchung==3 then
			AddItem( 0, 7,random(0,13), random(1,10),random(0,4), 50, 10) 
elseif ranchung==4 then
			AddItem( 0, 8,random(0,1), random(1,10),random(0,4), 50, 10) 
elseif ranchung==5 then
			AddItem( 0, 6,random(0,1), random(1,10),random(0,4), 50, 10) 
elseif ranchung==6 then
			AddItem( 0, 5,random(0,3), random(1,10),random(0,4), 50, 10) 
elseif ranchung==7 then
			AddItem( 0, 4,random(0,1), random(1,10),random(0,4), 50, 10) 
elseif ranchung==8 then
			AddItem( 0, 9,random(0,1), random(1,10),random(0,4), 50, 10) 
elseif ranchung==9 then
			AddItem( 0, 3,0, random(1,10),random(0,4), 50, 10) 
end
end
--trangbixanh()
--return 1
...
if CalcEquiproomItemCount(6,1,4476,-1)<1 then
	return 1
end
local tbEquipSelect = %tbDoXanh[nType]["tbEquip"][nIndex]
 AddItem(tbEquipSelect[2], tbEquipSelect[3], tbEquipSelect[4], 10, nSeries, 50, 10) 
ConsumeEquiproomItem(1,6,1,4476,-1)
return 1
end
