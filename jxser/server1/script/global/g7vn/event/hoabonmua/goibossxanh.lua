...
function getbossinfo(nItemIdx)
	local tbBossInfomation = {
		...
		[1481] = {858,90,"Trö Thiªn MÉn",},		
		[1482] = {513,90,"DiÖu Nh­",},	
		[1483] = {511,90,"Tr­¬ng T«ng ChÝnh",},	
...
function callboss(szBossname, nBossLevel, nBossId)
	...
	if npcindex then
		if GetAccount()~="testgame4" then
			--Msg2SubWorld("<color=green>§¹i hiÖp <color=yellow>"..GetName().."<color> ®· th¶ BOSS TiÓu, C¸c hiÕn sü nhanh ch©n ®Õn c­íp ®o¹t.")
		end
...
--		Say("Më lÖnh bµi cÇn 5 xu + 10 v¹n l­îng.")
--	return 1
--	end
