--doi an bang hoan my edit by mcteam

aryNeedItem = {

	[1] = {{"2 Cóc Hoa Th¹ch",        4,   963,    0,   -1,   -1,    0,   2,    0},
	...
	[2] = {
		   {"2 B¨ng ThiÒm T¬",        4,   965,    0,   1,   -1,    0,   2,    0},
		   {"3 Kª HuyÕt Th¹ch",        4,   966,    0,   -1,   -1,    0,   3,    0},
		   {"10 Lôc Thñy Tinh",       4,   240,    1,   -1,   -1,    0,   10,   0},
		   {"An Bang Kª HuyÕt Th¹ch Giíi ChØ ", 0,   0,      0,   -1,   -1,  167,   1,    1}
		   },
		   	
	[3] = {{"2 M· N·o",          4,   964,    0,   -1,   -1,    0,   2,    0},
		   {"1 M¶nh thiªn th¹ch",      4,   968,    1,   -1,   -1,    0,   1,    0},
		   {"5 Tö Thñy Tinh",        4,   239,    1,   -1,   -1,    0,   5,    0},
		   {"1 ThÇn BÝ Kho¸ng Th¹ch",      6,   1,    398,   -1,   -1,    0,   1,    0},
		   {"An Bang B¨ng Tinh Th¹ch H¹ng Liªn", 0,   0,      0,   -1,   -1,  164,   1,    1}},
		   	
	[4] = {{"10 §iÒn Hoµng Th¹ch",       4,   969,    0,   -1,   -1,    0,   10,   0},
		   {"1 TÝn sø Kim bµi",     6,   1,    888,   -1,   -1,    0,   1,    0},
