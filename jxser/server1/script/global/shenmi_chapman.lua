...
function buy_silk()
	str=
	{
		"<#> Kh¸ch quan x¸c ®Þnh mua <color=red>B¨ng Tµm V« Cùc T¬<color> chø? <color=red>20 TiÒn §ång<color> ®æi ®­îc <color=red>1 B¨ng Tµm V« Cùc T¬<color>.",
		"<#> Sö dông/sure10",
		"<#> Hñy bá /no",
	};
...
function buy_stone()
	str=
	{
		"<#> Kh¸ch quan x¸c ®Þnh mua <color=red>Nam Minh Chi Tinh<color> chø? <color=red>20 TiÒn ®ång<color> ®æi ®­îc <color=red>1 Nam Minh Chi Tinh<color>.",
		"<#> Sö dông/sure11",
		"<#> Hñy bá /no",
	};
	Say(str[1],2,str[2],str[3])
...
function deal_brokenequip()
	...
	Say("B¹n cã <color=red><trang bÞ tæn h¹i><color>kh«ng? Muèn söa nh­ thÕ nµo?", 1, "Ta muèn sö dông TiÒn ®ång ®Ó kh«i phôc l¹i/restore_brokenequip")	
end
...
function restore_brokenequip()
	GiveItemUI( "<trang bÞ tæn h¹i> giao diÖn phôc håi", "Xin mêi bá <trang bÞ ®· h­ háng> vµo « bªn d­íi. PhÝ cÇn söa (xu): trang bÞ phæ th«ng cÇn "..xutbphothong.." xu, tÝm cÇn "..xutbtim.." xu, hoµng kim cÇn "..xutbhoangkim.." xu, b¹ch kim cÇn "..xutbbachkim.." xu (söa b¹ch kim +6 trë lªn cßn cÇn thªm thiÕt huyÕt ®¬n). Chó ý: tr­íc khi tiÕn hµnh söa trang bÞ, h·y kiÓm tra hµnh trang cßn ®ñ « trèng.", "on_restore_be", "no", 1);	
end
