...
function buy_silk()
	str=
	{
		"<#> Kh¸ch quan x¸c ®Þnh mua <color=red>B¨ng Tµm V« Cùc T¬<color> chø? <color=red>10 TiÒn §ång<color> ®æi ®­îc <color=red>1 B¨ng Tµm V« Cùc T¬<color>.",
		"<#> Sö dông/sure10",
		"<#> Hñy bá /no",
	};
...
function buy_stone()
	str=
	{
		"<#> Kh¸ch quan x¸c ®Þnh mua <color=red>Nam Minh Chi Tinh<color> chø? <color=red>10 TiÒn ®ång<color> ®æi ®­îc <color=red>1 Nam Minh Chi Tinh<color>.",
		"<#> Sö dông/sure11",
		"<#> Hñy bá /no",
	};
	Say(str[1],2,str[2],str[3])
