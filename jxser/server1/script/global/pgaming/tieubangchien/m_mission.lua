Include("\\script\\global\\pgaming\\tieubangchien\\lib\\inc.lua")
Include("\\script\\global\\pgaming\\tieubangchien\\lib\\tieubangchien_inc_memory.lua")
Include("\\script\\global\\pgaming\\tieubangchien\\inc.lua")
Include("\\script\\global\\pgaming\\tieubangchien\\addnpc.lua")
Include("\\script\\global\\pgaming\\tieubangchien\\addtrap.lua")
...
function m_TieuBangChien:m_InitMission()
	...
	pg.Msg2AllWorld(pg.C(1, "Tiªu Bang ChiÕn")..pg.C(9, " ®ang b­íc vµo giai ®o¹n chuÈn bÞ, c¸c bang chñ h·y dÉn d¾t huynh ®Ö tiÕn vµo b¶n ®å chuÈn bÞ tiÕp nhËn nhiÖm vô, thêi gian chuÈn bÞ "..GetMissionV(self.m.i_PreparingTime).." phót"))
end

function m_TieuBangChien:m_RunMission()
	self:AddNpc(self.Add.SatThu)
	
	pg.Msg2AllWorld(pg.C(1, "Tiªu Bang ChiÕn")..pg.C(9, " chÝnh thøc khëi ®éng, c¸c bang héi ®· cã thÓ ®¨ng ký hé tèng Tiªu Xa, h·y nhí r»ng 'Tiªu tÆc cã mÆt ë kh¾p n¬i!'"))
end
