...
local _GetAward = function(nNpcIndex, dwNpcId)
	...
	if CalcFreeItemCellCount() < 1 then
		Talk(1,"","H∑y chıa 1 chÊ trËng r≠¨ng hµnh trang")
		return
	end 
	...
	ConsumeEquiproomItem(1,6,1,4331,-1)
	Talk(1,"","ß÷ tˆ bﬁ th≠¨ng: C∏m ¨n, t´i Æ∑ c∂m th y ÆÏ h¨n nhi“u, khi s˜ dÙng loπi thuËc nµy.")
