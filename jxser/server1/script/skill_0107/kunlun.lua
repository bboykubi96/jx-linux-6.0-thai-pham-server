...
SKILLS={
	...
	leidong_jiutian={ --À×¶¯¾ÅÌì
		...
		lightingdamage_v={
			[1]={{1,80},{15,260},{20,1200}},
			[3]={{1,80},{15,260},{20,1200}}
		},
	...
	aoxue_xiaofeng={ --°ÁÑ©Ð¥·ç
		physicsenhance_p={{{1,5},{15,100},{20,350}}},
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		lightingdamage_v={
...
--		},
	...
	kunlun120={ --À¥ÂØ120¼¶¼¼ÄÜ
		autorescueskill={{{1,721*256 + 1},{20,721*256 + 20},{21,721*256 + 21}},{{1,-1},{20,-1}},{{1,20*18*256 + 15},{15,20*18*256 + 60},{20,20*18*256 + 95},{21,20*18*256 + 95}}},
		skill_desc=
			function(level)
