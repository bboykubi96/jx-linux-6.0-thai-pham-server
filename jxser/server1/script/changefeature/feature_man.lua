...
function tbFeatureNpc:Dialog()
	...
	if ThayDoiNgoaiHinhTB == 0 then
		Say("TÝnh n¨ng thay ®æi ngo¹i h×nh trang bÞ t¹m thêi ch­a më")
		return
	end
	...
	local tbOpt = 
	{
		...
		--{"Thay ®æi ngo¹i h×nh trang bÞ ­ng ý nhÊt cho trang bÞ(150xu)", self.InjectToItem, {self}},
