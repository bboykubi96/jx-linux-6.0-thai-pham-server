...
SKILLS={
	...
	zuidie_kuangwu={ --×íµú¿ñÎè
		allres_yan_p={{{1,1},{40,1},{41,10},{61,30}},{{1,18*120},{30,18*180}}},
		...
		returnres_p={{{1,10},{40,50},{41,50}},{{1,-1},{20,-1}}},--Ôö¼Ó¶Ô·´µ¯ÉËº¦µÄ¿¹ÐÔ£¬Ã¿¼¶1%£¬ÉÏÏÞ40%
	...
	huaxian_weiyi={ --»¯ÏÕÎªÒÄ
		meleedamagereturn_p={{{1,40},{20,40}},{{1,-1},{20,-1}}},
...
--		},
	...
	zhanggaibang150={ --ÕÆØ¤°ï150
		...
		firedamage_v={
			[1]={{1,24},{15,583},{20,1197},{23,2184},{27,8069}},
			[3]={{1,24},{15,583},{20,1197},{23,2184},{27,8069}}
		},
...
--		skill_showevent={{{1,0},{15,0},{15,4},{20,4}}},
	...
	zhanggaibang150_2={ --ÕÆØ¤°ï150µÚ2Ê½
		...
		firedamage_v={
			[1]={{1,20},{20,360},{23,468},{26,522}},
			[3]={{1,20},{20,360},{23,468},{26,522}}
		},
--		skill_eventskilllevel={{{1,1},{20,20}}},
--		skill_collideevent={
--			[1]={{1,0},{15,0},{15,1},{20,1}},
...
--		skill_showevent={{{1,0},{15,0},{15,4},{20,4}}},
	...
	gungaibang150={ --¹÷Ø¤°ï150
		...
		physicsenhance_p={{{1,10},{15,80},{20,348},{23,520},{25,891}}},
		firedamage_v={
			[1]={{1,60},{15,213},{20,541},{23,893},{26,1268}},
			[3]={{1,60},{15,281},{20,772},{23,1392},{26,1994}}
		},
