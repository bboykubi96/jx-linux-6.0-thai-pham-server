...
SKILLS={
	...
	huabu_liushou={ --»¬²»ÁôÊÖ
		...
		fastwalkrun_p={{{1,9},{20,78}},{{1,18*120},{20,18*180}}},
	...
	xiaoyao_gong={ --åÐÒ£¹¦
		...
		deadlystrikeenhance_p={{{1,1},{30,20}},{{1,-1},{2,-1}}},
	},
	feilong_zaitian={ --·ÉÁúÔÚÌì
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		firedamage_v={
			[1]={{1,10},{15,300},{20,1650}},
			[3]={{1,10},{15,300},{20,1800}}
		},
		addskilldamage1={
			[1]={{1,1073},{2,1073}},
			[3]={{1,1},{20,25}}
		...
		missle_speed_v={{{1,20},{20,29},{21,29}}},
...
--		skill_showevent={{{1,0},{15,0},{15,4},{20,4}}},
	...
	tianxia_wugou={ --ÌìÏÂÎÞ¹·
		...
		physicsenhance_p={{{1,12},{15,100},{20,550}}},
		firedamage_v={
			[1]={{1,70},{15,150},{20,352}},
			[3]={{1,70},{15,200},{20,392}}
		},
		addskilldamage1={
			[1]={{1,1074},{2,1074}},
			[3]={{1,1},{20,25}}
