...
SKILLS={
	--Ø¤°ï
	gaibang_bangfa={ --C¸i Bang Bæng ph¸p
	...
	dagou_zhen={ --´ò¹·Õó
		...
		deadlystrikeenhance_p={{{1,1},{20,20,Conic}},{{1,-1},{2,-1}}},
		--skill_cost_v={{{1,24},{20,50}}}
	},
	...
	zuidie_kuangwu={ --×íµú¿ñÎè
		...
		lifemax_p={{{1,21},{30,60},{36,70}},{{1,-1},{30,-1}}},--¼ÓÇ¿ÉúÃü×î´óÖµ£¨Ñô£©
...
--		},
	...
	zhanggaibang150={ --ÕÆØ¤°ï150
		...
		firedamage_v={
			[1]={{1,24},{15,720},{20,1100},{23,1500},{26,1900}},
			[3]={{1,24},{15,720},{20,1100},{23,1500},{26,1900}}
		},
...
--		skill_showevent={{{1,0},{15,0},{15,4},{20,4}}},
	...
	tianxia_wugou={ --thien ha vo cau 9x cai ang
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		skill_misslenum_v={{{1,1},{20,3},{21,3}}},
		physicsenhance_p={{{1,12},{15,156},{20,286}}},
		firedamage_v={
	...
	gungaibang150={ --¹÷Ø¤°ï150
		...
		physicsenhance_p={{{1,10},{15,80},{20,345},{23,567},{26,678}}},
		firedamage_v={
			[1]={{1,60},{15,120},{20,280},{23,362},{26,428}},
