...
SKILLS={
	...
	emei_jianfa={ --¶ëáÒ½£·¨
		addphysicsdamage_p={{{1,15},{20,315}},{{1,-1},{2,-1}},{{1,0},{2,0}}},
		deadlystrikeenhance_p={{{1,6},{20,56}},{{1,-1},{2,-1}}}
	},
	emei_zhangfa={ --¶ëáÒÕÆ·¨
	...
	fofa_wubian={ --·ð·¨ÎÞ±ß
		...
		coldenhance_p={{{1,8},{30,37},{35,50}},{{1,-1},{2,-1}}},
	},
	foxin_ciyou={ --·ðÐÄ´ÈÓÓ
	...
	sane_jixue={ --Èý¶ëö«Ñ©
		physicsenhance_p={{{1,10},{15,100},{20,277}}},
	...
	fengshuang_suiying={ --·çËªËéÓ°
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		colddamage_v={
			[1]={{1,20},{15,350},{20,1000}},
			[3]={{1,30},{15,400},{20,1500}}
		},
		skill_eventskilllevel={{{1,1},{20,20}}},
		skill_cost_v={{{1,30},{20,65}}},
		skill_startevent={
	...
	jinding_foguang={ --½ð¶¥·ð¹â
		colddamage_v={
			[1]={{1,10},{20,485},{21,500}},
			[3]={{1,10},{20,485},{21,500}},
		},
		seriesdamage_p={{{1,20},{20,60},{21,62}}},
