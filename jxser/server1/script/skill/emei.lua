...
SKILLS={
	...
	pudu_zhongsheng={ --ÆÕ¶ÉÖÚÉú
		lifereplenish_v={{{1,1},{20,30}},{{1,18*8},{2,18*8}}},
		manareplenish_v={{{1,1},{20,20}},{{1,18*8},{2,18*8}}},
		allres_yan_p={{{1,1},{20,20}},{{1,18*8},{2,18*8}}},
		fasthitrecover_yan_v={{{1,1},{20,10},{21,10}},{{1,18*8},{2,18*8}}},	--Phuc Hoi Duong
	},
	sane_jixue={ --Èý¶ëö«Ñ©
	...
	jianemei150={ --½£¶ëÃ¼150
		physicsenhance_p={{{1,12},{15,120},{20,1280},{23,1368},{26,1467}}},
	...
	jianemei150_2={ --½£¶ëÃ¼150µÚ2Ê½
		physicsenhance_p={{{1,31},{20,170},{23,203},{26,225}}},
	...
	zhangemei150={ --ÕÆ¶ëÃ¼150	±ùÓêçó¾§
		seriesdamage_p={{{1,40},{15,40},{20,80},{21,82}}},
		--coldenhance_p={{{1,1},{15,1},{20,1},{21,1}}},
		colddamage_v={
			[1]={{1,180},{15,2700},{20,3200},{23,3350},{26,3500}},		--Ã¿¼¶Ôö¼Ó±ùÉË10µã 20160801
			[3]={{1,180},{15,2700},{20,3200},{23,3350},{26,3500}}
	...
	zhangemei150_2={ --ÕÆ¶ëÃ¼150µÚ2Ê½
		colddamage_v={
			[1]={{1,25},{20,1410},{21,1445}},
			[3]={{1,25},{20,1410},{21,1445}},
		},
		seriesdamage_p={{{1,20},{20,60},{21,62}}},
		--coldenhance_p={{{1,5},{15,5},{20,5},{21,5}}},
		missle_speed_v={{{1,24},{20,28},{21,28}}},
		skill_misslenum_v={{{1,1},{10,1},{20,3},{21,3}}},
	},
	emei120={ --¶ëáÒ120¼¶¼¼ÄÜ
	...
	fuzhuemei150={ --¸¨Öú150
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		colddamage_v={
			[1]={{1,20},{15,1200},{20,1400},{23,1640},{26,1760}},
			[3]={{1,30},{15,1200},{20,1500},{23,1860},{26,2040}}
		},
		skill_eventskilllevel={{{1,1},{20,20}}},
