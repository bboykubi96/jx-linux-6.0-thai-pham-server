...
--	},
	duoming_lianhuan={ --¶áÃüÁ¬»·ÈýÏÉ½£
		physicsenhance_p={{{1,10},{15,156},{20,300},{26,300},{32,300},{33,300}}},
...
--		skill_cost_v={{{1,30},{20,35}}}
	...
	duoming_start={ --Ö÷¶¯¸¨Öú¶áÃüÁ¬»·ÈýÏÉ½£
		autoreplyskill={{{1,(1*65536 + 1363)*256 + 1},{20,(1*65536 + 1363)*256 + 20},{21,(1*65536 + 1363)*256 + 21}},{{1,10*60*18},{20,10*60*18}},{{1,15*18*256 + 1},{20,15*18*256 + 100},{31,15*18*256 + 100},{32,15*18*256 + 100}}},
...
--		skill_cost_v={{{1,30},{20,35}}}
	...
	jiujian_start={ --Ö÷¶¯¸¨Öú¾Å½£ºÏÒ»
		autoattackskill={{{1,1368*256 + 1},{20,1368*256 + 20},{21,1368*256 + 21}},{{1,10*60*18},{20,10*60*18}},{{1,15*18*256 + 1},{20,15*18*256 + 50},{31,15*18*256 + 50},{32,15*18*256 + 50}}},
		--manareplenish_v={{{1,-10000},{20,-10000}},{{1,10*60*18},{2,10*60*18}}},
		--manareplenish_p={{{1,-200},{20,-200}},{{1,10*60*18},{2,10*60*18}}},
	...
	haina_baichuan={ --º£ÄÉ°Ù´¨
		...
		fastwalkrun_p={{{1,3},{20,45}},{{1,-1},{20,-1}}},
	},
	...
	longxuan_jianqi1={ --ÁúÐý½£Æø1
		sorbdamage_p={{{1,1},{15,15},{32,20}},{{1,18},{2,18}}},
	...
	moyun_jianqi1={ --Ä¦ÔÆ½£Æø1
		...
		skill_desc=
			function(level)
				...
				local nMag = floor(Link(level,SKILLS.longxuan2.colddamage_v[3]))
				local nPois = format("%.2f", (floor(Link(level,SKILLS.longxuan2.frozen_action[2])*100/18 )/100))
				return format("KhÝ tr­êng bïng næ t¹o thµnh<enter><color=orange>%d<color> ®iÓm s¸t th­¬ng thuéc tÝnh b¨ng,<enter>®ång thêi lµm kÎ ®Þch ®øng yªn trong <color=orange>%.2f<color> gi©y,\n", nMag, nPois)
			end,
		addskilldamage1={
				[1]={{1,1382},{2,1382}},
				[3]={{1,1},{20,60},{31,70}}
	...
	shenguang_xuanrao={ --Ä¦ÔÆ½£Æø
		...
		skill_eventskilllevel={{{1,1},{20,20}}},
		skill_showevent={{{1,1},{10,1},{20,1}}},
		skill_cost_v={{{1,20},{20,100},{26,150},{31,200},{32,250}}},
		skill_desc=
			function(level)
	...
	new_wuji={ --ÐÂÎÞ¼«½£Æø£¬ÉÏÃæµÄÎÞ¼«½£Æø×÷·Ï
		...
		--lifereplenish_v={{{1,1},{15,4},{25,15},{26,15}},{{1,18},{2,18}}},
		--manareplenish_v={{{1,1},{15,4},{25,15},{26,15}},{{1,18},{2,18}}},
		allres_p={{{1,1},{30,37}},{{1,18*120},{30,18*180}}},
		skill_eventskilllevel={{{1,1},{20,20}}},
		skill_showevent={{{1,1},{10,1},{20,1}}},
		skill_cost_v={{{1,20},{20,60},{26,80},{31,95},{32,120}}},
		skill_desc=
			function(level)
	...
	pishi_poyu={ --ÅüÊ¯ÆÆÓñ
		...
		colddamage_v={
			[1]={{1,36},{15,480},{20,800},{23,1064},{26,1296}},
			[3]={{1,46},{15,624},{20,1000},{23,1283},{26,1444}}
		},
