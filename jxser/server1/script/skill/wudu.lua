...
SKILLS={
	...
	binglan_xuanjing={ --±ùÀ¼Ðþ¾§
		...
		coldresmax_p={{{1,-1},{25,-10},{26,-10}},{{1,18*20},{20,18*90}}},
	...
	jiutian_kuanglei={ --¾ÅÌì¿ñÀ×
		...
		lightingresmax_p={{{1,-1},{25,-10},{26,-10}},{{1,18*20},{20,18*90}}},
		skill_cost_v={{{1,10},{20,60}}}
	},
	youming_kulou={ --ÓÄÚ¤÷¼÷Ã
	...
	chiyan_shitian={ --³àÑ×Ê´Ìì
		...
		fireresmax_p={{{1,-1},{25,-10},{26,-10}},{{1,18*20},{20,18*90}}},
		skill_cost_v={{{1,10},{20,60}}}
	},
	chuanxin_duci={ --´©ÐÄ¶¾´Ì
		--poisonres_p={{{1,-29},{20,-49}},{{1,18*20},{20,18*90}}},
		poisonresmax_p={{{1,-1},{25,-10},{26,-10}},{{1,18*20},{20,18*90}}},
		skill_cost_v={{{1,10},{20,60}}}
	},
	wangu_shixin={ --Íò¹ÆÊ´ÐÄ
		--poisontimereduce_p={{{1,-100},{20,-200}},{{1,18*45},{20,18*120}}},
		poisontimereduce_p={{{1,-100},{20,-400},{21,-420}},{{1,18*45},{20,18*120}}},
		skill_cost_v={{{1,40},{20,40}}}
	},
	...
	wudu_qijing={ --Îå¶¾Ææ¾­
		...
		poisonenhance_p={{{1,1},{30,38},{42,41},{50,43}},{{1,-1},{2,-1}}},--ÐÂÔöÊôÐÔ¶¾·¢¼ä¸ô¼õÉÙ
	...
	zhangwudu150={ --ÕÆÎå¶¾150
		...
		--poisondamage_v={{{1,20},{15,50},{20,121}},{{1,60},{20,60}},{{1,10},{20,10}}},
		poisondamage_v={{{1,25},{15,100},{20,253},{23,416},{25,952}},{{1,60},{20,60}},{{1,10},{20,10}}},
		--poisondamage_v={{{1,30},{15,175},{20,315},{23,550},{26,763}},{{1,60},{20,60}},{{1,10},{20,10}}},
		skill_attackradius={{{1,448},{20,512},{50,512}}},
...
--		},
	...
	daowudu150={ --µ¶Îå¶¾150
		...
		physicsenhance_p={{{1,23},{15,149},{20,269},{23,371},{25,738}}},
		--poisondamage_v={{{1,20},{15,30},{20,60}},{{1,60},{20,60}},{{1,10},{20,10}}},
		poisondamage_v={{{1,24},{15,72},{20,165},{23,265},{25,627}},{{1,60},{20,60}},{{1,10},{20,10}}},
...
--		},
	...
	duanjin_fugu={ --¶Ï½î¸¯¹Ç
		allres_yan_p={{{1,-1},{20,-15}},{{1,18*20},{20,18*90}}},		--Bua Khang Tat Ca	
		allresmax_p={{{1,-1},{20,-25},{23,-25}},{{1,18*20},{20,18*90}}},
