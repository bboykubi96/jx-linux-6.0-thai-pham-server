...
SKILLS={
	...
	binglan_xuanjing={ --±ùÀ¼Ðþ¾§
		coldres_p={{{1,-9},{20,-40}},{{1,18*20},{20,18*90}}},
	...
	jiutian_kuanglei={ --¾ÅÌì¿ñÀ×
		lightingres_p={{{1,-9},{20,-40}},{{1,18*20},{20,18*90}}},
	...
	chiyan_shitian={ --³àÑ×Ê´Ìì
		fireres_p={{{1,-9},{20,-40}},{{1,18*20},{20,18*90}}},
		--fireresmax_p={{{1,-1},{25,-15},{26,-15}},{{1,18*20},{20,18*90}}},
		skill_cost_v={{{1,10},{20,60}}}
	},
	chuanxin_duci={ --´©ÐÄ¶¾´Ì
		poisonres_p={{{1,-29},{20,-40}},{{1,18*20},{20,18*90}}},
		--poisonresmax_p={{{1,-1},{25,-15},{26,-15}},{{1,18*20},{20,18*90}}},
		skill_cost_v={{{1,10},{20,60}}}
	},
	wangu_shixin={ --Íò¹ÆÊ´ÐÄ
		poisontimereduce_p={{{1,-100},{20,-220}},{{1,18*45},{20,18*120}}},
		skill_cost_v={{{1,40},{20,40}}}
	},
	...
	wudu_qijing={ --Îå¶¾Ææ¾­
		...
		addpoisondamage_v={{{1,5},{30,55}},{{1,-1},{20,-1}},{{1,11},{2,11}}},
		--addpoisondamage_v={{{1,5},{30,100}},{{1,-1},{20,-1}},{{1,11},{2,11}}},
		poisonenhance_p={{{1,12},{30,50},{33,53},{35,55},{38,58}},{{1,-1},{2,-1}}},
		deadlystrikeenhance_p={{{1,4},{30,45}},{{1,-1},{2,-1}}},
		--lifemax_yan_p={{{1,21},{35,20},{36,20}},{{1,-1},{30,-1}}},
		--lifemax_p={{{1,21},{35,20},{36,20}},{{1,-1},{30,-1}}},
		--castspeed_v={{{1,1},{15,8},{30,11}},{{1,-1},{2,-1}}},
		--	attackspeed_v={{{1,1},{15,15},{30,30}},{{1,-1},{2,-1}}},
		--	fastwalkrun_p={{{1,1},{30,30}},{{1,18*120},{20,18*180}}},
	...
	baidu_chuanxin={ --°Ù¶¾´©ÐÄ
		...
		seriesdamage_p={{{1,5},{20,30}}},
		poisondamage_v={{{1,20},{20,121}},{{1,60},{20,60}},{{1,10},{20,10}}},
		addskilldamage1={
			[1]={{1,383},{2,383}},
			[3]={{1,1},{20,70}}
		},
	...
	yinfeng_shigu={ --Òõ·çÊ´¹Ç
		...
		poisondamage_v={{{1,20},{15,40},{20,160}},{{1,60},{20,60}},{{1,10},{20,10}}},
		--poisondamage_v={{{1,20},{15,80},{20,181}},{{1,60},{20,60}},{{1,10},{20,10}}},
		skill_attackradius={{{1,480},{20,480},{40,480}}},
	...
	xuanyin_zhan={ --ÐþÒõÕ¶
		...
		physicsenhance_p={{{1,15},{15,150},{20,273}}},
