...
SKILLS={
	...
	wudu_qijing={ --Îå¶¾Ææ¾­
		...
		poisonenhance_p={{{1,1},{30,30},{31,30}},{{1,-1},{2,-1}}},--ÐÂÔöÊôÐÔ¶¾·¢¼ä¸ô¼õÉÙ
	...
	zhangwudu150={ --ÕÆÎå¶¾150
		...
		--poisondamage_v={{{1,20},{15,50},{20,121}},{{1,60},{20,60}},{{1,10},{20,10}}},
		poisondamage_v={{{1,25},{15,100},{20,180},{23,253},{26,322}},{{1,60},{20,60}},{{1,10},{20,10}}},
	...
	xuanyin_zhan={ --ÐþÒõÕ¶
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		physicsenhance_p={{{1,15},{15,80},{20,273}}},
		--poisondamage_v={{{1,20},{15,30},{20,60}},{{1,60},{20,60}},{{1,10},{20,10}}},
		poisondamage_v={{{1,20},{15,40},{20,80}},{{1,60},{20,60}},{{1,10},{20,10}}},
...
--		},
	...
	daowudu150={ --µ¶Îå¶¾150
		...
		--poisondamage_v={{{1,20},{15,30},{20,60}},{{1,60},{20,60}},{{1,10},{20,10}}},
		poisondamage_v={{{1,24},{15,72},{20,90},{23,120},{26,150}},{{1,60},{20,60}},{{1,10},{20,10}}},
