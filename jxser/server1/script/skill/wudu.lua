...
SKILLS={
	...
	wudu_qijing={ --Îå¶¾Ææ¾­
		addpoisonmagic_v={{{1,5},{30,200}},{{1,-1},{20,-1}},{{1,11},{2,11}}},
		addpoisondamage_v={{{1,5},{30,100}},{{1,-1},{20,-1}},{{1,11},{2,11}}},
		--addpoisondamage_v={{{1,5},{30,100}},{{1,-1},{20,-1}},{{1,11},{2,11}}},
		poisonenhance_p={{{1,12},{30,30},{33,33},{35,41},{38,44}},{{1,-1},{2,-1}}},
	...
	yinfeng_shigu={ --Òõ·çÊ´¹Ç
		...
		poisondamage_v={{{1,20},{15,40},{20,180}},{{1,60},{20,60}},{{1,10},{20,10}}},
