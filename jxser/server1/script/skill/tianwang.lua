...
SKILLS={
	...
	tianwang_zhanyi={ --天王战意
		...
		anti_hitrecover={{{1,1},{30,14},{60,14}},{{1,-1},{2,-1}}},
	},
	pofeng_zhan={ --泼风斩
	...
	jinzhong_zhao={ --金钟罩
		...
		fastwalkrun_p={{{1,10},{20,30}},{{1,18},{2,18}}}--降低一半移动速度
	},
	chenglong_jue={ --乘龙诀
	...
	daotianwang150={ --Thien Vuong Dao
		physicsenhance_p={{{1,45},{15,180},{20,562},{23,984},{26,2549}}},
	...
	qiangtianwang150={ --THien Vuong Thuong - Ba Vuong Tam Kim
		--physicsenhance_p={{{1,60},{15,240},{20,460},{23,724},{26,1285}}},
		physicsenhance_p={{{1,65},{15,348},{20,662},{23,977},{26,2035}}},
		seriesdamage_p={{{1,40},{15,40},{20,100},{21,102}}},
	...
	chuitianwang150={ --Thuong Vuong Chuy - Tung Hoanh bat
		physicsenhance_p={{{1,30},{15,210},{20,580},{23,954},{26,2056}}},
		seriesdamage_p={{{1,40},{15,40},{20,100},{21,102}}},
		ignoredefense_p={{{1,12},{20,90},{21,94},{22,98},{23,99},{24,99}}},
		colddamage_v={
			[1]={{1,1},{20,57},{23,72},{26,81}},
			[3]={{1,10},{20,295},{23,384},{26,432}}
		},
