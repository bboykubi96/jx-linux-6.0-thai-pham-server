...
SKILLS={
	...
	rulai_qianye={ --如来千叶
		...
		deadlystrikeenhance_p={{{1,5},{30,20}},{{1,18*120},{30,18*360}}},
	...
	damo_dujiang={ --达摩渡江
		physicsenhance_p={{{1,65},{15,345},{20,675}}},
	...
	hengsao_qianjun={ --横扫千军
		physicsenhance_p={{{1,10},{15,150},{20,393}}},
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
	...
	wuxiang_zhan={ --无相斩
		physicsenhance_p={{{1,45},{15,150},{20,410}}},
