...
SKILLS={
	...
	luohan_zhen={ --ÂÞººÕó
		...
		meleedamagereturn_p={{{1,1},{20,20},{25,20},{26,20}},{{1,18},{2,18}}},
		rangedamagereturn_p={{{1,1},{20,20},{25,20},{26,20}},{{1,18},{2,18}}},
		adddefense_v={{{1,40},{20,100}},{{1,18},{2,18}}},
	},
	...
	yijin_jing={ --Ò×½î¾­
		...
		allres_yan_p={{{1,1},{20,10},{21,10}},{{1,-1},{2,-1}}},				--Khang Tat Ca Duong
		meleedamagereturn_p={{{1,1},{20,20},{25,20},{26,20}},{{1,-1},{2,-1}}},
		rangedamagereturn_p={{{1,1},{20,20},{25,20},{26,20}},{{1,-1},{2,-1}}},
		lifemax_yan_p={{{1,21},{35,100},{36,100}},{{1,-1},{30,-1}}},
		lifemax_p={{{1,3},{20,60},{21,60}},{{1,18*120},{20,18*360},{21,18*360}}},
	},
	...
	quanshaolin150={ --È­ÉÙÁÖ150
		physicsenhance_p={{{1,32},{15,205},{20,389},{23,1470},{26,2835}}},
		seriesdamage_p={{{1,40},{15,40},{20,80},{21,82}}},
		ignoredefense_p={{{1,9},{20,90},{21,94},{22,98},{23,99},{24,99},}},
		skill_cost_v={{{1,18},{20,42},{23,49}}},
		colddamage_v={
			[1]={{1,12},{20,194},{23,251},{26,279}},
			[3]={{1,12},{20,194},{23,251},{26,279}}
		},
	...
	wuxiang_zhan={ --ÎÞÏàÕ¶
		...
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		missle_speed_v={{{1,28},{20,32}}},
		skill_attackradius={{{1,448},{20,512},{23,512}}},
		colddamage_v={
			[1]={{1,10},{20,111}},
			[3]={{1,10},{20,111}}
		},
	...
	daoshaolin150={ --µ¶ÉÙÁÖ150
		physicsenhance_p={{{1,55},{15,160},{20,404},{23,1078},{26,2022}}},
		seriesdamage_p={{{1,40},{15,40},{20,80},{21,82}}},
		colddamage_v={
			[1]={{1,12},{20,142},{23,182},{26,203}},
			[3]={{1,12},{20,142},{23,182},{26,203}}
		},
		skill_eventskilllevel={{{1,1},{20,20}}},
		skill_startevent={
