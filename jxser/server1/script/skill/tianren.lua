...
SKILLS={
	...
	tianren_maofa={ --ÌìÈÌÃ¬·¨
		...
		attackratingenhance_p={{{1,35},{20,1088}},{{1,-1},{2,-1}}},
	...
	tianmo_jieti={ --ÌìÄ§½âÌå
		returnres_p={{{1,1},{20,10},{40,20}},{{1,-1},{20,-1}}},--Ôö¼Ó¶Ô·´µ¯ÉËº¦µÄ¿¹ÐÔ£¬Ã¿¼¶1%£¬ÉÏÏÞ40%
		adddefense_v={{{1,75},{30,850}},{{1,18*120},{30,18*360}}},
		attackratingenhance_p={{{1,65},{30,2400}},{{1,18*120},{30,18*360}}},
...
--		skill_showevent={{{1,0},{10,0},{10,1},{20,1}}},
	...
	zhanren150={ --thien nhan kich
		physicsenhance_p={{{1,55},{20,648},{23,830},{26,1139}}},
		seriesdamage_p={{{1,40},{15,40},{20,100},{21,102}}},
		deadlystrike_p={{{1,6},{20,80},{23,113},{26,135}}},
		firedamage_v={
			[1]={{1,10},{15,139},{20,840},{23,1591},{26,1964}},
			[3]={{1,10},{15,139},{20,840},{23,1591},{26,1964}}
		},
	...
	moren150={--Tat Hoa Lieu nguyen -150
		seriesdamage_p={{{1,40},{15,40},{20,100},{21,102}}},
		firedamage_v={
			[1]={{1,80},{20,875},{23,1173},{26,3938}}, --3738
			[3]={{1,80},{20,858},{23,1173},{26,3738}}
		},
		fatallystrike_p={{{1,10},{20,27}}},
