...
--		skill_cost_v={{{1,24},{20,100}}}
	...
	binggu_xuexin={ --冰骨雪心
		...
		coldenhance_p={{{1,10},{30,100}},{{1,-1},{2,-1}}},--每级增加1%造迟缓时间
		lifemax_p=
		{
			{
				{1,21},{35,20},{36,20}
	...
	bingzong_wuying={ --冰踪无影
		physicsenhance_p={{{1,15},{15,100},{20,346}}},
	...
	daocuiyan150={ --刀翠烟150
		physicsenhance_p={{{1,90},{15,460},{20,760},{23,960},{26,1140}}},
		seriesdamage_p={{{1,40},{15,40},{20,80},{21,82}}},
		colddamage_v={
			[1]={{1,60},{15,550},{20,800},{23,1200},{26,1410}},
			[3]={{1,300},{15,700},{20,1200},{23,2201},{26,2474}}
		},
