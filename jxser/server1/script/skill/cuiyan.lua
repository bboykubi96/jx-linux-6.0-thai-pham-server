...
-- bingxin_xianzi : b¨ng t©m tiªn tö
...
SKILLS={
	...
	xueying={ --Ñ©Ó°
		attackspeed_v={{{1,12},{20,65},{23,81},{25,90},{28,99},{42,111},{43,119},{44,122}},{{1,18*120},{20,18*180}}},
...
--		skill_cost_v={{{1,24},{20,100}}}
	...
	binggu_xuexin={ --±ù¹ÇÑ©ÐÄ
		...
		coldenhance_p={{{1,8},{30,30}},{{1,-1},{2,-1}}}
	},
	bingzong_wuying={ --±ù×ÙÎÞÓ°
		physicsenhance_p={{{1,15},{15,100},{20,970}}},
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		colddamage_v={
			[1]={{1,10},{15,140},{20,523}},
			[3]={{1,50},{15,200},{20,556}}
		},
	...
	bingxin_xianzi={ -- b¨ng t©m tiªn tö
		...
		colddamage_v={
			[1]={{1,15},{15,240},{20,2200}},
			[3]={{1,15},{15,240},{20,2200}}
		},
		missle_speed_v={{{1,28},{20,32},{21,32}}},
		skill_attackradius={{{1,512},{20,512},{21,512}}},
		skill_cost_v={{{1,45},{20,75}}},
		coldenhance_p={{{1,8},{30,160}},{{1,-1},{2,-1}}},
		skill_eventskilllevel={{{1,1},{20,20}}},
		skill_flyevent={
			[1]={{1,0},{10,0},{10,1},{20,1}},
			[2]={{1,3},{2,3}},
