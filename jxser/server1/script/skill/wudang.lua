...
SKILLS={
	...
	taiji_shengong={ --Ì«¼«Éñ¹¦
		...
		addlightingmagic_v={{{1,20},{20,275}},{{1,-1},{2,-1}}},
	...
	tiandi_wuji={ --ÌìµØÎÞ¼«
		...
		skill_attackradius={{{1,512},{20,512},{20,512}}},
		missle_lifetime_v={{{1,8},{20,20},{21,20}}},
		stun_p={{{1,10},{20,15},{25,15},{26,15}},{{1,1},{20,6},{21,6}}},
...
--		skill_showevent={{{1,0},{5,0},{5,2},{20,2}}},
	...
	renjian_heyi={ --ÈË½£ºÏÒ»
		physicsenhance_p={{{1,8},{15,80},{20,300}}},
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		lightingdamage_v={
			[1]={{1,12},{20,35}},
