...
SKILLS={
	...
	qingxing_zhen={ --ÆßÐÇÕó
		attackratingenhance_p={{{1,24},{20,575}},{{1,18},{2,18}}},
	...
	taiji_shengong={ --Ì«¼«Éñ¹¦
		...
		manamax_yan_p={{{1,50},{35,250},{36,250}},{{1,-1},{2,-1}}},--¼ÓÇ¿ÄÚÁ¦×î´óÖµ£¨Ñô£© LLX
...
--		skill_showevent={{{1,0},{5,0},{5,2},{20,2}}},
	...
	qiwudang150={ --vo dang quyen
		seriesdamage_p={{{1,40},{15,40},{20,80},{21,86}}},
		lightingdamage_v={
			[1]={{1,6},{20,10},{23,163}},
			[3]={{1,6},{15,327},{20,480},{23,758},{26,2089}} --2089
		},
		skill_attackradius={{{1,448},{20,512},{20,512}}},
		missle_lifetime_v={{{1,20},{20,30},{21,30}}},
		stun_p={{{1,10},{20,30},{23,25},{26,25}},{{1,1},{20,6},{21,6}}},
	...
	jianwudang150={ --vo dang kiem
		physicsenhance_p={{{1,12},{15,115},{20,450},{23,771},{26,1408}}},
		seriesdamage_p={{{1,40},{15,40},{20,100},{21,102}}},
		lightingdamage_v={
			[1]={{1,15},{20,51},{23,72},{26,78}},
			[3]={{1,15},{15,176},{20,597},{23,882},{26,1138}}
		},
