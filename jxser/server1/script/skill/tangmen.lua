...
SKILLS={
	...
	physicsenhance_p={{{1,20},{15,150},{20,300},{23,476},{26,584}}},
	...
	nutang150={ --Thiet Lien Tu Sat -150  Tu Tien
		anti_hitrecover={{{1,1},{20,5}},{{1,-1},{30,-1}}},
		-- seriesdamage_p={{{1,40},{15,40},{20,100},{21,102}}},
		seriesdamage_p={{{1,40},{15,40},{20,100},{21,152}}},
		physicsenhance_p={{{1,18},{15,157},{20,450},{23,894},{26,1248}}},
	...
	nutang150_2={ --弩唐门150第2式
		seriesdamage_p={{{1,40},{15,40},{20,100},{21,102}}},
		physicsenhance_p={{{1,18},{15,90},{20,152},{23,214},{26,348}}},
	...
	biaotang150={ --Can Khon Nhat Trich-150- phi tieu
		seriesdamage_p={{{1,40},{15,40},{20,100},{21,102}}},
		physicsenhance_p={{{1,12},{15,120},{20,331},{23,587},{26,1082}}},
	...
	biaotang150_2={ --镖唐150第2
		seriesdamage_p={{{1,40},{15,40},{20,100},{21,102}}},
		physicsenhance_p={{{1,12},{15,117},{20,445}}},
	...
	biaotang150_3={ --镖唐150第3
		seriesdamage_p={{{1,40},{15,40},{20,100},{21,102}}},
		physicsenhance_p={{{1,12},{15,130},{20,500}}},
		deadlystrike_p={{{1,12},{20,45}}},
		poisondamage_v={{{1,1},{20,36}},{{1,60},{20,60}},{{1,10},{20,10}}},
		missle_speed_v={{{1,32},{20,32},{21,32}}},
		skill_attackradius={{{1,448},{20,512},{21,512}}},
