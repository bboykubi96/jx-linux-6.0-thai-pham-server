...
SKILLS={
	...
	xinyan={ --ÐÄÑÛ
		...
		deadlystrikeenhance_p={{{1,8},{30,38}},{{1,-1},{2,-1}}},
	...
	shehun_yueying={ --Éã»êÔÂÓ°
		physicsenhance_p={{{1,25},{15,150},{20,450}}},
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		poisondamage_v={{{1,5},{20,40}},{{1,60},{20,60}},{{1,10},{20,10}}},  --poisondamage_v={{{1,5},{20,70}},{{1,60},{20,60}},{{1,10},{20,10}}},
	...
	feidaotang150={ --·Éµ¶ÌÆ150
		physicsenhance_p={{{1,30},{15,180},{20,390},{23,576},{26,684}}},
	...
	baoyu_lihua={ --±©ÓêÀæ»¨
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		physicsenhance_p={{{1,15},{15,200},{20,480}}},
	...
	zhuixing_zhudian={ --×·ÐÇÖðµç
		seriesdamage_p={{{1,20},{20,60},{21,62}}},
		poisondamage_v={{{1,5},{20,5}},{{1,5},{20,5}},{{1,5},{20,5}}}, --poisondamage_v={{{1,1},{20,50}},{{1,50},{20,50}},{{1,10},{20,10}}},
	},
	nutang150={ --åóÌÆÃÅ150
		seriesdamage_p={{{1,40},{15,40},{20,80},{21,82}}},
	...
	jiugong_feixing={ --¾Å¹¬·ÉÐÇ
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		physicsenhance_p={{{1,10},{15,100},{20,434}}},
