...
--¾üÐè¹Ù
function main(sel)
Say("HËu doanh do ta phô tr¸ch! Ng­¬i cã cÇn gióp ®ì g× kh«ng?",4,"Mua d­îc phÈm/salemedicine","Mua d­îc nhanh/buymaunhanh","T×m hiÓu quy t¾c Tèng Kim ®¹i chiÕn/help_sjbattle","Kh«ng cÇn ®©u! C¶m ¬n!/cancel")
end;
