...
Talk(4,""," l·o nh©n gia , ®©y lµ ng­¬i c©u ®Õn ®Ých l«ng xanh con rïa sao ?","§óng vËy , h«m nay thËt may m¾n , ®©y còng kh«ng ph¶i lµ dÔ dµng ®ông ph¶i chuyÖn cña t×nh ®©y !","T¹i h¹ ®ang muèn dïng nã lµm thuèc cøu ng­êi ®©y , ng­¬i cã thÓ ®em nã cho ta kh«ng ?","H«m nay mang ®Ých måi c©u gièng nh­ kh«ng ®ñ , ng­¬i nÕu lµ cho ta t×m mÊy c¸i con giun ta liÒn ®em nã cho ng­¬i !") 
...
AddEventItem(94) 
Talk(2,""," l·o nh©n gia , ng­¬i ®­a cho ta ®Ých l«ng xanh con rïa ta vøt bá !","A # ng­¬i thÕ nµo vËn tèt nh­ vËy ®©y # ta míi võa c©u ®Õn mét con , ng­¬i nhanh lªn cÇm ®i cøu ng­êi !") 
else 
...
SetTask(14,0) 
Talk(1,"","TiÓu tö , xem ng­¬i khÝ s¾c kh«ng ph¶i lµ rÊt tèt , hay lµ tr­íc nghØ ng¬i mét chót , cã c¸i g× tõ tõ nãi . ") 
else 
