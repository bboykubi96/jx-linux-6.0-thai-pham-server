...
Talk(1,"","Nghe nãi cã mét vÞ kh«ng biÕt tõ ®©u c¸ ng«i ®Òn tíi s­ th¸i , ph¸p lùc v« biªn , ng­¬i ®i hái mét chót ®i .") 
SetTask(1256, 2); 
return 
else 
Talk(1,"","Ta thÕ nµo khæ nh­ vËy , c¸i bÖnh nµy ®· c­íp ®i thª tö ta ®Ých mÖnh . ch¼ng lÏ ta TriÖu gia thËt muèn g¶y h­¬ng háa .") 
return 
end 
return 
...
AskClientForNumber("matma",1,50000,"<#> ®­a vµo thÝch con sè ") 
end; 
function matma(ma) 
if (ma==9955) then 
