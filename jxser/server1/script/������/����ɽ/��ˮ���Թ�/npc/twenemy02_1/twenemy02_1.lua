-- script viet hoa By http://tranhba.com description: vò l¨ng s¬n b¹ch n­íc ®éng ®Þch nh©n 1# Thiªn v­¬ng 20 cÊp nhiÖm vô 
...
SetTaskTemp(10,UTask_twtmp20) 
		if (UTask_twtmp20 == 7) then		-- script viet hoa By http://tranhba.com  bin: 100 + 010
