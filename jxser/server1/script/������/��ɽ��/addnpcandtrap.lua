...
{ 
-- script viet hoa By http://tranhba.com npcid mapid nx ny script name 
	{199-2, tbaddJinShanDao_NpcAndTrap.nMapId, 44160/32, 89728/32, "\\script\\½­ÄÏÇø\\½ðÉ½µº\\npc\\npc_tiejiang.lua","Ìú½³"},
	{627-2, tbaddJinShanDao_NpcAndTrap.nMapId, 44864/32, 90496/32, "\\script\\½­ÄÏÇø\\½ðÉ½µº\\obj\\box.lua","´¢ÎïÏä"},
