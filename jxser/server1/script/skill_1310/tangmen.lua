...
SKILLS={
	...
	xinyan={ --ÐÄÑÛ
		...
		addpoisondamage_v={{{1,1},{30,12}},{{1,-1},{2,-1}},{{1,10},{2,10}}},
		addphysicsdamage_p={{{1,15},{20,130}},{{1,-1},{2,-1}},{{1,7},{2,7}}},
		--poisonenhance_p={{{1,3},{30,33}},{{1,-1},{2,-1}}},
		deadlystrikeenhance_p={{{1,8},{30,26}},{{1,-1},{2,-1}}},
		attackspeed_v={{{1,29},{30,106},{33,125},{34,116},{35,160},{38,162},{39,165},{40,162}},{{1,-1},{2,-1}}},
	...
	baoyu_lihua={ --±©ÓêÀæ»¨
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,69}}},
		physicsenhance_p={{{1,15},{15,200},{20,654}}},
	...
	zhuixing_zhudian={ --×·ÐÇÖðµç
		seriesdamage_p={{{1,20},{20,60},{21,62}}},
		poisondamage_v={{{1,1},{20,40}},{{1,40},{20,40}},{{1,10},{20,10}}},
	},
	nutang150={ --åóÌÆÃÅ150
		seriesdamage_p={{{1,40},{15,40},{20,80},{21,82}}},
