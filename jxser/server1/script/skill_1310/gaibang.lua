...
SKILLS={
	...
	zuidie_kuangwu={ --×íµú¿ñÎè
		...
		addfiremagic_v={{{1,10},{30,310}},{{1,18*120},{30,18*180}}},
		addfiredamage_v={{{1,10},{30,260}},{{1,18*120},{30,18*180}}},
	...
	feilong_zaitian={ --·ÉÁúÔÚÌì
		...
		firedamage_v={
			[1]={{1,10},{15,300},{20,1750}},
			[3]={{1,10},{15,300},{20,1750}}
		},
		addskilldamage1={
			[1]={{1,1073},{2,1073}},
			[3]={{1,1},{20,25}}
...
--		skill_showevent={{{1,0},{15,0},{15,4},{20,4}}},
	...
	tianxia_wugou={ --ÌìÏÂÎÞ¹·
		...
		firedamage_v={
			[1]={{1,70},{15,150},{20,1032}},
			[3]={{1,70},{15,200},{20,1232}}
		},
		addskilldamage1={
			[1]={{1,1074},{2,1074}},
			[3]={{1,1},{20,25}}
