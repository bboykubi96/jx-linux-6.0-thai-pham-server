...
SKILLS={
	...
	tianmo_jieti={ --ÌìÄ§½âÌå
		...
		attackratingenhance_p={{{1,65},{30,660}},{{1,18*120},{30,18*360}}},
		fasthitrecover_v={{{1,5},{20,40}},{{1,18*120},{20,18*360}}},
		fasthitrecover_yan_v={{{1,5},{20,49},{21,49}},{{1,18*120},{20,18*360}}},
		addfiremagic_v={{{1,20},{30,380}},{{1,18*120},{30,18*360}}},
		addfiredamage_v={{{1,20},{30,380}},{{1,18*120},{30,18*360}}},
		fireenhance_p={{{1,31},{30,110}},{{1,18*120},{30,18*360}}},
...
--		skill_showevent={{{1,0},{10,0},{10,1},{20,1}}},
	...
	tianwai_liuxing={ --ÌìÍâÁ÷ÐÇ
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		firedamage_v={
			[1]={{1,11},{15,200},{20,762}},
			[3]={{1,11},{15,200},{20,762}}
		},
