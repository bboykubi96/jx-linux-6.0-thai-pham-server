...
SKILLS={
	...
	wudu_qijing={ --Îå¶¾Ææ¾­
		...
		castspeed_v={{{1,1},{15,15},{30,30}},{{1,-1},{2,-1}}},
		attackspeed_v={{{1,1},{15,15},{30,30}},{{1,-1},{2,-1}}},
		fastwalkrun_p={{{1,9},{30,60}},{{1,18*120},{20,18*180}}},
	...
	yinfeng_shigu={ --Òõ·çÊ´¹Ç
		...
		poisondamage_v={{{1,20},{15,40},{20,100}},{{1,60},{20,60}},{{1,10},{20,10}}},
		--poisondamage_v={{{1,20},{15,80},{20,181}},{{1,60},{20,60}},{{1,10},{20,10}}},
		skill_attackradius={{{1,448},{20,512},{40,512}}},
