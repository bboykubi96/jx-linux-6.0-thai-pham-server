...
["3955"]="Ngò Hµnh Ên",
["3993"]="Xuyªn Y Ph¸ Gi¸p",
["6060"]="Ngò Hµnh Ên(§· Gia H¹n)",
["6067"]="Xuyªn Y Ph¸ Gi¸p(§· Gia H¹n)",
}
...
--	else 
--	tbAwardTemplet:GiveAwardByList({{szName = strItemName,tbProp={0,6067},nQuality=1,nCount=1,nExpiredTime=(nTimeLeftCount+30)*24*60},}, "test", 1);
--	end
...
dofile("script/vng_event/item/giahanphu/giahanphu6.lua")
	local nCheckMap = DynamicExecuteByPlayer(PlayerIndex, "\\script\\vng_feature\\checkinmap.lua", "PlayerFunLib:VnCheckInCity")
	if not nCheckMap then
		return 1
	end
