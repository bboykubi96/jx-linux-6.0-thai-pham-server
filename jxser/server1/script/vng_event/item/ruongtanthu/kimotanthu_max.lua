...
function main(nItemIdx)
	...
	elseif n_param >= 1 and n_param <= 11 then
		tbVNGetGoldEquip:ShowEquipBranchDialog(21,tb)
	elseif n_param >= 12 and n_param <= 22 then
		tbVNGetGoldEquip:GetGoldEquip(21, random(1,27), tb)
	end	
	return 1
end
...
function GetDesc(nItem)	
	...
	local tbItemName = 
	{
		...
		[12] = "Kim ¤ H¹ng Liªn - NgÉu nhiªn hÖ ph¸i",
		[13] = "Kim ¤ Ph¸t Qu¸n - NgÉu nhiªn hÖ ph¸i",		
		[14] = "Kim ¤ Th­îng Giíi ChØ - NgÉu nhiªn hÖ ph¸i",
		[15] = "Kim ¤ Hé UyÓn - NgÉu nhiªn hÖ ph¸i",
		[16] = "Kim ¤ Yªu §¸i - NgÉu nhiªn hÖ ph¸i",
		[17] = "Kim ¤ Kim Kh¶i - NgÉu nhiªn hÖ ph¸i)",
		[18] = "Kim ¤ KhÝ Giíi - NgÉu nhiªn hÖ ph¸i",
		[19] = "Kim ¤ Hµi - NgÉu nhiªn hÖ ph¸i",
		[20] = "Kim ¤ Ngäc Béi - NgÉu nhiªn hÖ ph¸i",
		[21] = "Kim ¤ H¹ Giíi ChØ - NgÉu nhiªn hÖ ph¸i",
		[22] = "Bé trang bÞ Kim ¤ - NgÉu nhiªn hÖ ph¸i",
	}
