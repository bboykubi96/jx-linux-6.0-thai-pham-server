-- script viet hoa By http://tranhba.com ==== Say hµm sè ®Ých t¨ng c­êng ====-- script viet hoa By http://tranhba.com  
...
-- script viet hoa By http://tranhba.com  ph©n tê biÓu hiÖn ®èi tho¹i 
...
local tb_newoptions = {} 
if (n_from > 1) then 
		tb_newoptions[getn(tb_newoptions)+1] = "ÉÏÒ»Ò³/#__saypage("..(n_from-n_perpage)..","..n_total..","..n_perpage..",\""..str_function.."\",\""..str_parameter.."\")"
end 
if (n_to < n_total) then 
		tb_newoptions[getn(tb_newoptions)+1] = "ÏÂÒ»Ò³/#__saypage("..(n_from+n_perpage)..","..n_total..","..n_perpage..",\""..str_function.."\",\""..str_parameter.."\")"
end 
...
-- script viet hoa By http://tranhba.com  th«ng dông kÕt thóc ®èi tho¹i v« Ých hµm sè 
function OnCancel() 
end 

-- script viet hoa By http://tranhba.com  tÝnh to¸n v¨n vèn chiÒu dµi , <color...>#<enter> ngän ký kh«ng l©u l¾m ®é 
...
-- script viet hoa By http://tranhba.com  trë vÒ ®Þnh tr­êng tù phï chuçi 
...
-- script viet hoa By http://tranhba.com  return str_org 
return PopString() 
end 

-- script viet hoa By http://tranhba.com  trë vÒ ®Þnh tr­êng v¨n vèn , <color...>#<enter> ngän ký kh«ng l©u l¾m ®é 
...
-- script viet hoa By http://tranhba.com  më ra ph©n tê biÓu hiÖn ®Ých ®èi tho¹i 
...
-- script viet hoa By http://tranhba.com  x©y dùng biÓu c¸ch 
