...
if size== 0 then return nil end -- script viet hoa By http://tranhba.com  nhµ ch¬i kh«ng cã ë ®©y trong ®éi ngò 
...
local size = callPlayerFunction(playerIndex, GetTeamSize) 
if size == 0 then 
-- script viet hoa By http://tranhba.com  nhµ ch¬i kh«ng cã ë ®©y trong ®éi ngò 
return 
end 
for i = 1, size do 
local plyIdx = callPlayerFunction(playerIndex, GetTeamMember, i) 
...
TASK_OFFLINEADVTIME = 2791 -- script viet hoa By http://tranhba.com  mÖt mái kÕ c¸ch tuyÕn thêi gian # phót # 
TASK_OFFLINELOWTIME = 2792 -- script viet hoa By http://tranhba.com  mÖt mái kÕ c¸ch tuyÕn dÉn t­ëng thêi gian # phót # 
...
-- script viet hoa By http://tranhba.com  cã hay kh«ng chuyÓn sinh 
...
-- script viet hoa By http://tranhba.com  cho ®iÖp gia kinh nghiÖm 
function Player:StackExp(exp) 
return CallPlayerFunction(self.m_PlayerIndex, StackExp, exp) 
end 

-- script viet hoa By http://tranhba.com  lÊy ®­îc tr­íc mÆt kinh nghiÖm 
...
-- script viet hoa By http://tranhba.com  tÝnh to¸n nhµ ch¬i vËt phÈm lan chØ ®Þnh lo¹i h×nh vËt phÈm ®Ých sè l­îng # tÝnh to¸n nh­ng ®iÖp ®Ó vËt phÈm ®Ých ®iÖp gia sè l­îng # 
