-- script viet hoa By http://tranhba.com  trÙ cÈt IO hµm sË 
local _read_ = function() 
local nPakIdx = 0 
if usepack then 
nPakIdx = usepack(0) 
end 
write("-- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com \n") 
write("Debug>>>: ") 
local szBuff = read() 
if usepack then 
usepack(nPakIdx) 
...
-- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -debug t≠¨ng quan hµm sË -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com -- script viet hoa By http://tranhba.com  
...
local ProcCmd = function(nBaseLevel, hook) 
	local tbVarLocal = %GetLocalVariable(nBaseLevel + 1) -- script viet hoa By http://tranhba.com ªÒµ√∂œµ„À˘‘⁄≤„æ÷≤ø±‰¡ø
...
local nBreakLevel = 2 -- script viet hoa By http://tranhba.com  chÿ Æoπn Æi”m chÁ Î t«ng 
